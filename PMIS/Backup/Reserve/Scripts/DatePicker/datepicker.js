...
{
    var languageInfo = "bg", //navigator.language ? navigator.language.toLowerCase().replace(/-[a-z]+$/, "") : navigator.userLanguage ? navigator.userLanguage.toLowerCase().replace(/-[a-z]+$/, "") : "en",
            datePickers = {},
            uniqueId = 0,
            weeksInYearCache = {},
            localeImport = false,
    ...
    function datePicker(options)
    {
        ...
        this.format = "d-dt-n-dt-Y"; // || options.format; 
        ...
        this.show = function(autoFocus)
        {
            ...
            addEvent(document, "keydown", this.onkeydown); //added by Zhoro 14/07/09 - enable using of keys (for exmple ESC->exit, Enter->select highlighted data, Space->focus today and so on)
        };
        this.hide = function()
        {
        ...
        this.fade = function()
        {
            ...
            {
                o.fadeTimer = window.setTimeout(o.fade, 10);
            } else
            {
    ...
    datePicker.prototype.truePosition = function(element)
    {
        ...
        //Custom modification to fix the issue when it is in light-box and there is a scroll bar on the page
        if (document.getElementById(this.getElem().id) &&
            document.getElementById(this.getElem().id).getAttribute("inLightBox") == "true") 
        {
            posReal[0] = 0;
            posReal[1] = 0;
        }
    ...
    var printFormattedDate = function(date, fmt, useImportedLocale)
    {
        ...
        var parts = fmt.split("-"),
                    ...
                    flags = {
                        ...
                        "ds": "-",
                        "cc": ",",
                        "d": d, //pad(d), //if the day is < 10, 2 digits with leading zero will print
