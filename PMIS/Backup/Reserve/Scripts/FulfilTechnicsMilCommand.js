...
{
    var url = "FulfilTechnicsMilCommand.aspx?AjaxMethod=JSSavePunkt";
...
{
    var url = "FulfilTechnicsMilCommand.aspx?AjaxMethod=JSGetViewFulfilmentLightBox";
    var params = "";
...
function DeleteVehicle(fulfilTechnicsRequestID, militaryDepartmentID)
{
    ...
    function ConfirmYes()
    {
        var url = "FulfilTechnicsMilCommand.aspx?AjaxMethod=JSDeleteVehicle";
        var params = "";
...
function DeleteTrailer(fulfilTechnicsRequestID, militaryDepartmentID)
{
    ...
    function ConfirmYes()
    {
        var url = "FulfilTechnicsMilCommand.aspx?AjaxMethod=JSDeleteTrailer";
        var params = "";
        params += "FulfilTechnicsRequestID=" + fulfilTechnicsRequestID;
        params += "&MilitaryDepartmentID=" + militaryDepartmentID;
...
function DeleteMobileLiftingEquip(fulfilTechnicsRequestID, militaryDepartmentID)
{
    ...
    function ConfirmYes()
    {
        var url = "FulfilTechnicsMilCommand.aspx?AjaxMethod=JSDeleteMobileLiftingEquip";
        var params = "";
        params += "FulfilTechnicsRequestID=" + fulfilTechnicsRequestID;
        params += "&MilitaryDepartmentID=" + militaryDepartmentID;
...
function DeleteTractor(fulfilTechnicsRequestID, militaryDepartmentID)
{
    ...
    function ConfirmYes()
    {
        var url = "FulfilTechnicsMilCommand.aspx?AjaxMethod=JSDeleteTractor";
        var params = "";
        params += "FulfilTechnicsRequestID=" + fulfilTechnicsRequestID;
        params += "&MilitaryDepartmentID=" + militaryDepartmentID;
...
function DeleteEngEquip(fulfilTechnicsRequestID, militaryDepartmentID)
{
    ...
    function ConfirmYes()
    {
        var url = "FulfilTechnicsMilCommand.aspx?AjaxMethod=JSDeleteEngEquip";
        var params = "";
        params += "FulfilTechnicsRequestID=" + fulfilTechnicsRequestID;
        params += "&MilitaryDepartmentID=" + militaryDepartmentID;
...
function DeleteRailwayEquip(fulfilTechnicsRequestID, militaryDepartmentID)
{
    ...
    function ConfirmYes()
    {
        var url = "FulfilTechnicsMilCommand.aspx?AjaxMethod=JSDeleteRailwayEquip";
        var params = "";
        params += "FulfilTechnicsRequestID=" + fulfilTechnicsRequestID;
        params += "&MilitaryDepartmentID=" + militaryDepartmentID;
...
function DeleteAviationEquip(fulfilTechnicsRequestID, militaryDepartmentID)
{
    ...
    function ConfirmYes()
    {
        var url = "FulfilTechnicsMilCommand.aspx?AjaxMethod=JSDeleteAviationEquip";
        var params = "";
        params += "FulfilTechnicsRequestID=" + fulfilTechnicsRequestID;
        params += "&MilitaryDepartmentID=" + militaryDepartmentID;
...
function DeleteVessel(fulfilTechnicsRequestID, militaryDepartmentID)
{
    ...
    function ConfirmYes()
    {
        var url = "FulfilTechnicsMilCommand.aspx?AjaxMethod=JSDeleteVessel";
        var params = "";
        params += "FulfilTechnicsRequestID=" + fulfilTechnicsRequestID;
        params += "&MilitaryDepartmentID=" + militaryDepartmentID;
...
function DeleteFuelContainer(fulfilTechnicsRequestID, militaryDepartmentID)
{
    ...
    function ConfirmYes()
    {
        var url = "FulfilTechnicsMilCommand.aspx?AjaxMethod=JSDeleteFuelContainer";
        var params = "";
        params += "FulfilTechnicsRequestID=" + fulfilTechnicsRequestID;
        params += "&MilitaryDepartmentID=" + militaryDepartmentID;
