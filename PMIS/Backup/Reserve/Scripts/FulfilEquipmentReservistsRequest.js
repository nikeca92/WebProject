...
{
    var url = "FulfilEquipmentReservistsRequest.aspx?AjaxMethod=JSSavePunkt";
...
{
    var url = "FulfilEquipmentReservistsRequest.aspx?AjaxMethod=JSGetViewFulfilmentLightBox";
    var params = "";
...
function DeleteReservist(fillReservistsRequestID, militaryDepartmentID)
{
    ...
    function ConfirmYes()
    {
        var url = "FulfilEquipmentReservistsRequest.aspx?AjaxMethod=JSDeleteReservist";
        var params = "";
