...
{
    public partial class PrintAllVessels : RESPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (GetUIItemAccessLevel("RES_TECHNICS") == UIAccessLevel.Hidden ||
                this.GetUIItemAccessLevel("RES_TECHNICS_VESSELS") != UIAccessLevel.Hidden)
            {
        ...
        private string GenerateAllRecordsHtml()
        {
            ...
            List<VesselManageBlock> vesselManageBlocks = VesselUtil.GetAllVesselManageBlocks(filter, 0, CurrentUser);
            ...
            foreach (VesselManageBlock vesselManageBlock in vesselManageBlocks)
            {
                html.Append(@"
                          <tr>
                            <td align='center'>" + counter + @"</td>
                            <td align='left'>" + vesselManageBlock.NormativeTechnicsCode + @"</td>
                            <td align='left'>" + vesselManageBlock.VesselName + @"</td>
                            <td align='left'>" + vesselManageBlock.InventoryNumber + @"</td>
                            <td align='left'>" + vesselManageBlock.TechnicsCategory + @"</td>
                            <td align='left'>" + vesselManageBlock.VesselKind + @"</td>
                            <td align='left'>" + vesselManageBlock.VesselType + @"</td>
                            <td align='left'>" + vesselManageBlock.MilitaryDepartment + @"</td>
                            <td align='left'>" + vesselManageBlock.MilitaryReportStatus + @"</td>
                            <td align='left'>" + vesselManageBlock.Ownership + @"</td>
                            <td align='left'>" + vesselManageBlock.Address + @"</td>
                          </tr>");
                counter++;
            }
        ...
        protected void btnGenerateExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.Clear();
            Response.AppendHeader("content-disposition", "attachment; filename=Vessels.xls");
                ...
                foreach (VesselManageBlock vesselManageBlock in vesselManageBlocks)
                {
                    html.Append(@"
                              <tr>
                                ...
                                <td align='left' style='border: 1px solid black;'>" + vesselManageBlock.NormativeTechnicsCode + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + vesselManageBlock.VesselName + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + vesselManageBlock.InventoryNumber + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + vesselManageBlock.TechnicsCategory + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + vesselManageBlock.VesselKind + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + vesselManageBlock.VesselType + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + vesselManageBlock.MilitaryDepartment + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + vesselManageBlock.MilitaryReportStatus + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + vesselManageBlock.Ownership + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + vesselManageBlock.Address + @"</td>
                              </tr>");
                    counter++;
                }
