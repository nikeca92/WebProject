...
{
    public partial class PrintReportAllRailwayEquips : RESPage
    {
        ...
        private string GenerateAllRecordsHtml()
        {
            ...
            List<ReportRailwayEquipManageBlock> reportRailwayEquipManageBlocks = ReportRailwayEquipUtil.GetAllReportRailwayEquipManageBlocks(filter, 0, CurrentUser);
            ...
            (!isRailwayEuipKindHidden ? "<th style='width: 140px;'>Вид</th>" : "") +
            (!isRailwayEuipTypeHidden ? "<th style='width: 140px;'>Тип</th>" : "") +
            (!isRailwayEuipCountHidden ? "<th style='width: 140px;'>Брой</th>" : "") +
            ...
            (!isNormativeTechnicsHidden ? "<td align='left'>" + reportRailwayEquipManageBlock.NormativeTechnicsCode + @"</td>" : "") +
            (!isInventoryNumberHidden ? "<td align='left'>" + reportRailwayEquipManageBlock.InventoryNumber + @"</td>" : "") +
            (!isTechnicsCategoryHidden ? "<td align='left'>" + reportRailwayEquipManageBlock.TechnicsCategory + @"</td>" : "") +
            (!isRailwayEuipKindHidden ? "<td align='left'>" + reportRailwayEquipManageBlock.RailwayEquipKind + @"</td>" : "") +
            (!isRailwayEuipTypeHidden ? "<td align='left'>" + reportRailwayEquipManageBlock.RailwayEquipType + @"</td>" : "") +
            (!isRailwayEuipCountHidden ? "<td align='left'>" + reportRailwayEquipManageBlock.ItemsCount + @"</td>" : "") +
            (!isMilDepartmentHidden ? "<td align='left'>" + reportRailwayEquipManageBlock.MilitaryDepartment + @"</td>" : "") +
            (!isMilRepStatusHidden ? "<td align='left'>" + reportRailwayEquipManageBlock.MilitaryReportStatus + @"</td>" : "") +
            (!isOwnershipHidden ? "<td align='left'>" + reportRailwayEquipManageBlock.Ownership + @"</td>" : "") +
            (!isAddressHidden ? "<td align='left'>" + reportRailwayEquipManageBlock.Address + @"</td>" : "") + @"
                          </tr>");
                counter++;
            }
        ...
        protected void btnGenerateExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.Clear();
            Response.AppendHeader("content-disposition", "attachment; filename=ReportAllRailwayEquips.xls");
        ...
        private string GenerateAllRecordsForExport()
        {
            ...
            if (!isTechnicsCategoryHidden)
                visibleColumnsCount++;
            if (!isRailwayEuipKindHidden)
                visibleColumnsCount++;
            if (!isRailwayEuipTypeHidden)
                visibleColumnsCount++;
            if (!isRailwayEuipCountHidden)
                visibleColumnsCount++;
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                (!isRailwayEuipKindHidden ? "<th style='width: 150px; border-bottom: 1px solid white; border-left: 1px solid white; background-color: black; color: #FFFFFF;'>Вид</th>" : "") +
                                (!isRailwayEuipTypeHidden ? "<th style='width: 150px; border-bottom: 1px solid white; border-left: 1px solid white; background-color: black; color: #FFFFFF;'>Тип</th>" : "") +
                                (!isRailwayEuipCountHidden ? "<th style='width: 150px; border-bottom: 1px solid white; border-left: 1px solid white; background-color: black; color: #FFFFFF;'>Брой</th>" : "") +
                ...
                foreach (ReportRailwayEquipManageBlock reportRailwayEquipManageBlock in reportRailwayEquipManageBlocks)
                {
                    html.Append(@"
                            <tr>
                                ...
                                (!isNormativeTechnicsHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportRailwayEquipManageBlock.NormativeTechnicsCode + "</td>") : "") + 
                                (!isInventoryNumberHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportRailwayEquipManageBlock.InventoryNumber + @"</td>") : "") + 
                                (!isTechnicsCategoryHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportRailwayEquipManageBlock.TechnicsCategory + @"</td>") : "") + 
                                (!isRailwayEuipKindHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportRailwayEquipManageBlock.RailwayEquipKind + @"</td>") : "") + 
                                (!isRailwayEuipTypeHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportRailwayEquipManageBlock.RailwayEquipType + @"</td>") : "") + 
                                (!isRailwayEuipCountHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportRailwayEquipManageBlock.ItemsCount + @"</td>") : "") +
                                (!isMilDepartmentHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportRailwayEquipManageBlock.MilitaryDepartment + "</td>") : "") +
                                (!isMilRepStatusHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportRailwayEquipManageBlock.MilitaryReportStatus + "</td>") : "") +
                                (!isOwnershipHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportRailwayEquipManageBlock.Ownership + "</td>") : "") +
                                (!isAddressHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportRailwayEquipManageBlock.Address + "</td>") : "") + @"
                              </tr>");
                    counter++;
                }
