...
{
    public partial class PrintAllTractors : RESPage
    {
        ...
        private string GenerateAllRecordsHtml()
        {
            ...
            List<TractorManageBlock> tractorManageBlocks = TractorUtil.GetAllTractorManageBlocks(filter, 0, CurrentUser);
            ...
            if (tractorManageBlocks.Count() > 0)
            {
                html.Append(@"
            ...
            foreach (TractorManageBlock tractorManageBlock in tractorManageBlocks)
            {
                html.Append(@"
                          <tr>
                            <td align='center'>" + counter + @"</td>
                            <td align='left'>" + tractorManageBlock.NormativeTechnicsCode + @"</td>
                            <td align='left'>" + tractorManageBlock.RegNumber + @"</td>
                            <td align='left'>" + tractorManageBlock.InventoryNumber + @"</td>
                            <td align='left'>" + tractorManageBlock.TechnicsCategory + @"</td>
                            <td align='left'>" + tractorManageBlock.TractorKind + @"</td>
                            <td align='left'>" + tractorManageBlock.TractorMakeName + @"</td>
                            <td align='left'>" + tractorManageBlock.TractorModelName + @"</td>
                            <td align='left'>" + tractorManageBlock.MilitaryDepartment + @"</td>
                            <td align='left'>" + tractorManageBlock.MilitaryReportStatus + @"</td>
                            <td align='left'>" + tractorManageBlock.Ownership + @"</td>
                            <td align='left'>" + tractorManageBlock.Address + @"</td>
                          </tr>");
                counter++;
            }
        ...
        protected void btnGenerateExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.Clear();
            Response.AppendHeader("content-disposition", "attachment; filename=Tractors.xls");
                ...
                foreach (TractorManageBlock tractorManageBlock in tractorManageBlocks)
                {
                    html.Append(@"
                            <tr>
                                ...
                                <td align='left' style='border: 1px solid black;'>" + tractorManageBlock.NormativeTechnicsCode + @"</td> 
                                <td align='left' style='border: 1px solid black;'>" + tractorManageBlock.RegNumber + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + tractorManageBlock.InventoryNumber + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + tractorManageBlock.TechnicsCategory + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + tractorManageBlock.TractorKind + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + tractorManageBlock.TractorMakeName + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + tractorManageBlock.TractorModelName + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + tractorManageBlock.MilitaryDepartment + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + tractorManageBlock.MilitaryReportStatus + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + tractorManageBlock.Ownership + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + tractorManageBlock.Address + @"</td>
                              </tr>");
                    counter++;
                }
