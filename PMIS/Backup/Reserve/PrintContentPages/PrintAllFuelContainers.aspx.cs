...
{
    public partial class PrintAllFuelContainers : RESPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (GetUIItemAccessLevel("RES_TECHNICS") == UIAccessLevel.Hidden ||
                this.GetUIItemAccessLevel("RES_TECHNICS_FUEL_CONTAINERS") != UIAccessLevel.Hidden)
            {
        ...
        private string GenerateAllRecordsHtml()
        {
            ...
            List<FuelContainerManageBlock> fuelContainerManageBlocks = FuelContainerUtil.GetAllFuelContainerManageBlocks(filter, 0, CurrentUser);
            ...
            foreach (FuelContainerManageBlock fuelContainerManageBlock in fuelContainerManageBlocks)
            {
                html.Append(@"
                          <tr>
                            ...
                            <td align='left'>" + fuelContainerManageBlock.NormativeTechnicsCode + @"</td>
                            <td align='left'>" + fuelContainerManageBlock.InventoryNumber + @"</td>
                            <td align='left'>" + fuelContainerManageBlock.TechnicsCategory + @"</td>
                            <td align='left'>" + fuelContainerManageBlock.FuelContainerKind + @"</td>
                            <td align='left'>" + fuelContainerManageBlock.FuelContainerType + @"</td>
                            <td align='left'>" + fuelContainerManageBlock.ItemsCount + @"</td>
                            <td align='left'>" + fuelContainerManageBlock.MilitaryDepartment + @"</td>
                            <td align='left'>" + fuelContainerManageBlock.MilitaryReportStatus + @"</td>
                            <td align='left'>" + fuelContainerManageBlock.Ownership + @"</td>
                            <td align='left'>" + fuelContainerManageBlock.Address + @"</td>
                          </tr>");
                counter++;
            }
        ...
        protected void btnGenerateExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.Clear();
            Response.AppendHeader("content-disposition", "attachment; filename=FuelContainers.xls");
                ...
                foreach (FuelContainerManageBlock fuelContainerManageBlock in fuelContainerManageBlocks)
                {
                    html.Append(@"
                            <tr>
                                ...
                                <td align='left' style='border: 1px solid black;'>" + fuelContainerManageBlock.NormativeTechnicsCode + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + fuelContainerManageBlock.InventoryNumber + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + fuelContainerManageBlock.TechnicsCategory + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + fuelContainerManageBlock.FuelContainerKind + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + fuelContainerManageBlock.FuelContainerType + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + fuelContainerManageBlock.ItemsCount + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + fuelContainerManageBlock.MilitaryDepartment + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + fuelContainerManageBlock.MilitaryReportStatus + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + fuelContainerManageBlock.Ownership + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + fuelContainerManageBlock.Address + @"</td>
                              </tr>");
                    counter++;
                }
