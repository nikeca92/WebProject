...
{
    public partial class PrintReportListReservistsWithAppointments : RESPage
    {
        ...
        string equipWithResRequestsStatusId = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
                ...
                this.GetUIItemAccessLevel("RES_REPORTS_LISTRESWITHAPPOINTMENTS") != UIAccessLevel.Hidden)
            {
                ...
                if (!String.IsNullOrEmpty(Request.Params["EquipWithResRequestsStatusId"]))
                {
                    equipWithResRequestsStatusId = Request.Params["EquipWithResRequestsStatusId"];
                }
        ...
        {
            bool isReqNumberHidden = GetUIItemAccessLevel("RES_REPORTS_LISTRESWITHAPPOINTMENTS_REQUEST_REQNUMBER") == UIAccessLevel.Hidden;
            bool isReqDateHidden = GetUIItemAccessLevel("RES_REPORTS_LISTRESWITHAPPOINTMENTS_REQUEST_REQDATE") == UIAccessLevel.Hidden;
            bool isMilUnitHidden = GetUIItemAccessLevel("RES_REPORTS_LISTRESWITHAPPOINTMENTS_REQUEST_MILUNIT") == UIAccessLevel.Hidden;
            ...
            bool isReqStatusHidden = GetUIItemAccessLevel("RES_REPORTS_LISTRESWITHAPPOINTMENTS_REQUEST_REQSTATUS") == UIAccessLevel.Hidden;

            ReportListReservistsWithAppointmentsFilter filter = new ReportListReservistsWithAppointmentsFilter()
            {
                ...
                EquipWithResRequestsStatuses = equipWithResRequestsStatusId,
            ...
            List<ReportListReservistsWithAppointmentsBlock> reportListReservistsWithAppointmentsBlocks = ReportListReservistsWithAppointmentsBlockUtil.GetReportListReservistsWithAppointmentsBlockList(filter, 0, CurrentUser);
            ...
            int equipWithResReqStId = 0;
            if (int.TryParse(equipWithResRequestsStatusId, out equipWithResReqStId))
            {
                equipWithResRequestsStatus = EquipWithResRequestsStatusUtil.GetEquipWithResRequestsStatus(equipWithResReqStId, CurrentUser);
            }
            ...
            if (reportListReservistsWithAppointmentsBlocks.Count() > 0)
            {
                html.Append(@"
            ...
            foreach (ReportListReservistsWithAppointmentsBlock reportListReservistsWithAppointmentsBlock in reportListReservistsWithAppointmentsBlocks)
            {
                html.Append(@"<tr>
                            <td align='center'>" + counter + @"</td>" +
            (!isReqNumberHidden ? "<td align='left'>" + reportListReservistsWithAppointmentsBlock.RequestNumber + @"</td>" : "") +
            (!isReqDateHidden ? "<td align='left'>" + reportListReservistsWithAppointmentsBlock.RequestDate + @"</td>" : "") +
            (!isMilUnitHidden ? "<td align='left'>" + reportListReservistsWithAppointmentsBlock.MilitaryUnit + @"</td>" : "") +
            (!isAdministrationHidden ? "<td align='left'>" + reportListReservistsWithAppointmentsBlock.Administration + @"</td>" : "") +
            (!isReqStatusHidden ? "<td align='left'>" + reportListReservistsWithAppointmentsBlock.RequestStatus + @"</td>" : "") + @"
                          </tr>");
                counter++;
            }
        ...
        protected void btnGenerateExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.Clear();
            Response.AppendHeader("content-disposition", "attachment; filename=ReportListReservistsWithAppointments.xls");
                ...
                foreach (ReportListReservistsWithAppointmentsBlock reportListReservistsWithAppointmentsBlock in reportListReservistsWithAppointmentsBlocks)
                {
                    html.Append(@"
                            <tr>
                                ...
                                (!isReqNumberHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportListReservistsWithAppointmentsBlock.RequestNumber + @"</td>") : "") +
                                (!isReqDateHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportListReservistsWithAppointmentsBlock.RequestDate + @"</td>") : "") +
                                (!isMilUnitHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportListReservistsWithAppointmentsBlock.MilitaryUnit + @"</td>") : "") +
                                (!isAdministrationHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportListReservistsWithAppointmentsBlock.Administration + @"</td>") : "") +
                                (!isReqStatusHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportListReservistsWithAppointmentsBlock.RequestStatus + @"</td>") : "") + @"
                              </tr>");
                    counter++;
                }
