...
{
    public partial class PrintCheckMobileAppointment : RESPage
    {
        ...
        private string GenerateAllRecordsHtml()
        {
            ...
            {
                html.Append(@"<tr><td colspan='4' align='center'><br/><br/>От избраните резервисти няма такива със състояние ""С МН от задължителния резерв""</td></tr>");
            }
        ...
        protected void btnGenerateExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.Clear();
            Response.AppendHeader("content-disposition", "attachment; filename=MN.xls");
        ...
        private string GenerateAllRecordsForExport()
        {
            ...
            html.Append(@"<html xmlns='http://www.w3.org/1999/xhtml' xml:lang='en'>
                            ...
                            <body>
                                <table>
                                    ...
                                    <tr><td align='center' colspan='7' style='font-weight: bold; font-size: 1.3em;'>Групово снемане от отчет - Проверка за МН</td></tr>
                                    <tr><td colspan='7'>&nbsp;</td></tr>
                                    <tr>
            ...
            {
                html.Append(@"<table><tr><td colspan='7' align='center'><br/><br/>От избраните резервисти няма такива със състояние ""С МН от задължителния резерв""</td></tr></table>");
            }
