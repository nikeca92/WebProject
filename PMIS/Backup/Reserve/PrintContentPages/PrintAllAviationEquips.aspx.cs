...
{
    public partial class PrintAllAviationEquips : RESPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (GetUIItemAccessLevel("RES_TECHNICS") == UIAccessLevel.Hidden ||
                this.GetUIItemAccessLevel("RES_TECHNICS_AVIATION_EQUIP") != UIAccessLevel.Hidden)
            {
        ...
        private string GenerateAllRecordsHtml()
        {
            ...
            List<AviationEquipManageBlock> aviationAirManageBlocks = AviationEquipUtil.GetAllAviationEquipManageBlocks(filter, 0, CurrentUser);
            ...
            if (aviationAirManageBlocks.Count() > 0)
            {
                html.Append(@"
            ...
            foreach (AviationEquipManageBlock aviationAirManageBlock in aviationAirManageBlocks)
            {
                html.Append(@"
                          <tr>
                            <td align='center'>" + counter + @"</td>
                            <td align='left'>" + aviationAirManageBlock.NormativeTechnicsCode + @"</td>  
                            <td align='left'>" + aviationAirManageBlock.AirInvNumber + @"</td>
                            <td align='left'>" + aviationAirManageBlock.TechnicsCategory + @"</td>
                            <td align='left'>" + aviationAirManageBlock.AviationAirKind + @"</td>
                            <td align='left'>" + aviationAirManageBlock.AviationAirType + @"</td>
                            <td align='left'>" + aviationAirManageBlock.AviationAirModelName + @"</td>
                            <td align='left'>" + aviationAirManageBlock.MilitaryDepartment + @"</td>
                            <td align='left'>" + aviationAirManageBlock.MilitaryReportStatus + @"</td>
                            <td align='left'>" + aviationAirManageBlock.Ownership + @"</td>
                            <td align='left'>" + aviationAirManageBlock.Address + @"</td>
                          </tr>");
                counter++;
            }
        ...
        protected void btnGenerateExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.Clear();
            Response.AppendHeader("content-disposition", "attachment; filename=AviationEquips.xls");
                ...
                foreach (AviationEquipManageBlock aviationAirManageBlock in aviationAirManageBlocks)
                {
                    html.Append(@"
                            <tr>
                                ...
                                <td align='left' style='border: 1px solid black;'>" + aviationAirManageBlock.NormativeTechnicsCode + @"</td> 
                                <td align='left' style='border: 1px solid black;'>" + aviationAirManageBlock.AirInvNumber + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + aviationAirManageBlock.TechnicsCategory + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + aviationAirManageBlock.AviationAirKind + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + aviationAirManageBlock.AviationAirType + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + aviationAirManageBlock.AviationAirModelName + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + aviationAirManageBlock.MilitaryDepartment + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + aviationAirManageBlock.MilitaryReportStatus + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + aviationAirManageBlock.Ownership + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + aviationAirManageBlock.Address + @"</td>
                              </tr>");
                    counter++;
                }
