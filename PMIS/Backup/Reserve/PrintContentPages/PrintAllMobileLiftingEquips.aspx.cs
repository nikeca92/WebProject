...
{
    public partial class PrintAllMobileLiftingEquips : RESPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (GetUIItemAccessLevel("RES_TECHNICS") == UIAccessLevel.Hidden ||
                this.GetUIItemAccessLevel("RES_TECHNICS_MOB_LIFT_EQUIP") != UIAccessLevel.Hidden)
            {
        ...
        private string GenerateAllRecordsHtml()
        {
            ...
            List<MobileLiftingEquipManageBlock> mobileLiftingEquipManageBlocks = MobileLiftingEquipUtil.GetAllMobileLiftingEquipManageBlocks(filter, 0, CurrentUser);
            ...
            foreach (MobileLiftingEquipManageBlock mobileLiftingEquipManageBlock in mobileLiftingEquipManageBlocks)
            {
                html.Append(@"
                          <tr>
                            <td align='center'>" + counter + @"</td>
                            <td align='left'>" + mobileLiftingEquipManageBlock.NormativeTechnicsCode + @"</td>
                            <td align='left'>" + mobileLiftingEquipManageBlock.RegNumber + @"</td>
                            <td align='left'>" + mobileLiftingEquipManageBlock.InventoryNumber + @"</td>
                            <td align='left'>" + mobileLiftingEquipManageBlock.TechnicsCategory + @"</td>
                            <td align='left'>" + mobileLiftingEquipManageBlock.MobileLiftingEquipKind + @"</td>
                            <td align='left'>" + mobileLiftingEquipManageBlock.MobileLiftingEquipType + @"</td>
                            <td align='left'>" + mobileLiftingEquipManageBlock.MilitaryDepartment + @"</td>
                            <td align='left'>" + mobileLiftingEquipManageBlock.MilitaryReportStatus + @"</td>
                            <td align='left'>" + mobileLiftingEquipManageBlock.Ownership + @"</td>
                            <td align='left'>" + mobileLiftingEquipManageBlock.Address + @"</td>
                          </tr>");
                counter++;
            }
        ...
        protected void btnGenerateExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.Clear();
            Response.AppendHeader("content-disposition", "attachment; filename=MobileLiftingEquips.xls");
                ...
                foreach (MobileLiftingEquipManageBlock mobileLiftingEquipManageBlock in mobileLiftingEquipManageBlocks)
                {
                    html.Append(@"
                            <tr>
                                ...
                                <td align='left' style='border: 1px solid black;'>" + mobileLiftingEquipManageBlock.NormativeTechnicsCode + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + mobileLiftingEquipManageBlock.RegNumber + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + mobileLiftingEquipManageBlock.InventoryNumber + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + mobileLiftingEquipManageBlock.TechnicsCategory + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + mobileLiftingEquipManageBlock.MobileLiftingEquipKind + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + mobileLiftingEquipManageBlock.MobileLiftingEquipType + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + mobileLiftingEquipManageBlock.MilitaryDepartment + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + mobileLiftingEquipManageBlock.MilitaryReportStatus + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + mobileLiftingEquipManageBlock.Ownership + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + mobileLiftingEquipManageBlock.Address + @"</td>
                              </tr>");
                    counter++;
                }
