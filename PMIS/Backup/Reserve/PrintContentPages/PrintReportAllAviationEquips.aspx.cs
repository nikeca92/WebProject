...
{
    public partial class PrintReportAllAviationEquips : RESPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
                ...
                this.GetUIItemAccessLevel("RES_REPORTS_AVIATION_EQUIP") != UIAccessLevel.Hidden)
            {
                ...
                {
                    aviationAirKindId = Request.Params["AviationAirKindId"];
                }

                if (!String.IsNullOrEmpty(Request.Params["AviationAirTypeId"]))
                {
                    aviationAirTypeId = Request.Params["AviationAirTypeId"];
                }

                //if (!String.IsNullOrEmpty(Request.Params["AviationAirModelId"]))
                //{
                //    aviationAirModelId = Request.Params["AviationAirModelId"];
                //}

                if (!String.IsNullOrEmpty(Request.Params["AviationAirModelName"]))
                {
                    aviationAirModelName = Request.Params["AviationAirModelName"];
                }
        ...
        {
            bool isNormativeTechnicsHidden = GetUIItemAccessLevel("RES_REPORTS_AVIATION_EQUIP_NORMATIVETECHNICS") == UIAccessLevel.Hidden;
            bool isAirInvNumberHidden = GetUIItemAccessLevel("RES_REPORTS_AVIATION_EQUIP_AIRINVNUMBER") == UIAccessLevel.Hidden;
            bool isTechnicsCategoryHidden = GetUIItemAccessLevel("RES_REPORTS_AVIATION_EQUIP_TECHNICSCATEGORY") == UIAccessLevel.Hidden;
            bool isAviationAirKindHidden = GetUIItemAccessLevel("RES_REPORTS_AVIATION_EQUIP_AVIATIONAIRKIND") == UIAccessLevel.Hidden;
            bool isAviationAirTypeHidden = GetUIItemAccessLevel("RES_REPORTS_AVIATION_EQUIP_AVIATIONAIRTYPE") == UIAccessLevel.Hidden;
            bool isAviationAirModelHidden = GetUIItemAccessLevel("RES_REPORTS_AVIATION_EQUIP_AVIATIONAIRMODEL") == UIAccessLevel.Hidden;
            bool isMilDepartmentHidden = GetUIItemAccessLevel("RES_REPORTS_AVIATION_EQUIP_MILDEPARTMENT") == UIAccessLevel.Hidden;
            bool isMilRepStatusHidden = GetUIItemAccessLevel("RES_REPORTS_AVIATION_EQUIP_MILREPSTATUS") == UIAccessLevel.Hidden;
            bool isOwnershipHidden = GetUIItemAccessLevel("RES_REPORTS_AVIATION_EQUIP_OWNERSHIP") == UIAccessLevel.Hidden;
            bool isAddressHidden = GetUIItemAccessLevel("RES_REPORTS_AVIATION_EQUIP_ADDRESS") == UIAccessLevel.Hidden;


            ReportAviationEquipManageFilter filter = new ReportAviationEquipManageFilter()
            {
                TechnicsCategoryId = technicsCategoryId,
                AviationAirKindId = aviationAirKindId,
                AviationAirTypeId = aviationAirTypeId,

                //AviationAirModelId = aviationAirModelId,
            ...
            List<ReportAviationEquipManageBlock> reportAviationAirManageBlocks = ReportAviationEquipUtil.GetAllReportAviationEquipManageBlocks(filter, 0, CurrentUser);
            ...
            GTableItem aviationAirKind = null;
            int aviationKindId = 0;
            if (int.TryParse(aviationAirKindId, out aviationKindId))
            {
                aviationAirKind = GTableItemUtil.GetTableItem("AviationAirKind", aviationKindId, ModuleUtil.RES(), CurrentUser);
            }

            GTableItem aviationAirType = null;
            int aviationTypeId = 0;
            if (int.TryParse(aviationAirTypeId, out aviationTypeId))
            {
                aviationAirType = GTableItemUtil.GetTableItem("AviationAirType", aviationTypeId, ModuleUtil.RES(), CurrentUser);
            }

            //GTableItem aviationAirModel = null;
            //int aviationModelId = 0;
            //if (int.TryParse(aviationAirModelId, out aviationModelId))
            //{
            //    aviationAirModel = GTableItemUtil.GetTableItem("AviationAirModel", aviationModelId, ModuleUtil.RES(), CurrentUser);
            //}
            ...
            html.Append(@"<table style='padding: 5px; width: 1024px;'>
                             ...
                             <tr>
                                ...
                                <td align='left' style='width: 205px;'>
                                    <span class='ValueLabel'>" + (aviationAirKind != null ? aviationAirKind.TableValue : All) + @"</span>
                                </td>
                                <td align='right' style='width: 130px;'>
                                    <span class='Label'>Тип:&nbsp;</span>
                                </td>
                                <td align='left' style='width: 205px;'>
                                    <span class='ValueLabel'>" + (aviationAirType != null ? aviationAirType.TableValue : All) + @"</span>
                                </td>
                             </tr>
                             <tr>
                                <td align='right' style='width: 165px;'>
                                ...
                                <td colspan='3' align='left' style='width: 175px;'>
                                    <span class='ValueLabel'>" + aviationAirModelName + @"</span>
                                </td>
                             </tr>
                              <tr>
                                <td align='right' style='width: 165px;'>
            ...
            if (reportAviationAirManageBlocks.Count() > 0)
            {
                html.Append(@"
            ...
            (!isAirInvNumberHidden ? "<th style='width: 100px;'>Инвентарен номер</th>" : "") +
            (!isTechnicsCategoryHidden ? "<th style='width: 150px;'>Категория</th>" : "") +
            (!isAviationAirKindHidden ? "<th style='width: 140px;'>Вид</th>" : "") +
            (!isAviationAirTypeHidden ? "<th style='width: 140px;'>Тип</th>" : "") +
            (!isAviationAirModelHidden ? "<th style='width: 140px;'>Модел</th>" : "") +
            ...
            foreach (ReportAviationEquipManageBlock reportAviationAirManageBlock in reportAviationAirManageBlocks)
            {
                html.Append(@"
                          <tr>
                            <td align='center'>" + counter + @"</td>" +
            (!isNormativeTechnicsHidden ? "<td align='left'>" + reportAviationAirManageBlock.NormativeTechnicsCode + @"</td>" : "") +
            (!isAirInvNumberHidden ? "<td align='left'>" + reportAviationAirManageBlock.AirInvNumber + @"</td>" : "") +
            (!isTechnicsCategoryHidden ? "<td align='left'>" + reportAviationAirManageBlock.TechnicsCategory + @"</td>" : "") +
            (!isAviationAirKindHidden ? "<td align='left'>" + reportAviationAirManageBlock.AviationAirKind + @"</td>" : "") +
            (!isAviationAirTypeHidden ? "<td align='left'>" + reportAviationAirManageBlock.AviationAirType + @"</td>" : "") +
            (!isAviationAirModelHidden ? "<td align='left'>" + reportAviationAirManageBlock.AviationAirModel + @"</td>" : "") +
            (!isMilDepartmentHidden ? "<td align='left'>" + reportAviationAirManageBlock.MilitaryDepartment + @"</td>" : "") +
            (!isMilRepStatusHidden ? "<td align='left'>" + reportAviationAirManageBlock.MilitaryReportStatus + @"</td>" : "") +
            (!isOwnershipHidden ? "<td align='left'>" + reportAviationAirManageBlock.Ownership + @"</td>" : "") +
            (!isAddressHidden ? "<td align='left'>" + reportAviationAirManageBlock.Address + @"</td>" : "") + @"
                          </tr>");
                counter++;
            }
        ...
        protected void btnGenerateExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.Clear();
            Response.AppendHeader("content-disposition", "attachment; filename=ReportAllAviationEquips.xls");
        ...
        private string GenerateAllRecordsForExport()
        {
            ...
            if (!isNormativeTechnicsHidden)
                visibleColumnsCount++;
            if (!isAirInvNumberHidden)
                visibleColumnsCount++;
            if (!isTechnicsCategoryHidden)
                visibleColumnsCount++;
            if (!isAviationAirKindHidden)
                visibleColumnsCount++;
            if (!isAviationAirTypeHidden)
                visibleColumnsCount++;
            if (!isAviationAirModelHidden)
                visibleColumnsCount++;
                            ...
                            <body>
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td align='left' colspan='2'> 
                                            <span style='font-weight: bold;'>" + (aviationAirKind != null ? aviationAirKind.TableValue : All) + @"</span>
                                        </td>
                                        <td align='right' colspan='1'>
                                            <span style='font-weight: normal;'>Тип:&nbsp;</span>
                                        </td>
                                        <td align='left' colspan='2'>
                                            <span style='font-weight: bold;'>" + (aviationAirType != null ? aviationAirType.TableValue : All) + @"</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align='right' colspan='" + headerLeftColspan + @"'>
                                        ...
                                        <td align='left' colspan='2'> 
                                            <span style='font-weight: bold;'>" + aviationAirModelName + @"</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align='right' colspan='" + headerLeftColspan + @"'>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                (!isAirInvNumberHidden ? "<th style='width: 150px; border-bottom: 1px solid white; border-left: 1px solid white; background-color: black; color: #FFFFFF;'>Инвентарен номер</th>" : "") +
                                ...
                                (!isAviationAirKindHidden ? "<th style='width: 150px; border-bottom: 1px solid white; border-left: 1px solid white; background-color: black; color: #FFFFFF;'>Вид</th>" : "") +
                                (!isAviationAirTypeHidden ? "<th style='width: 150px; border-bottom: 1px solid white; border-left: 1px solid white; background-color: black; color: #FFFFFF;'>Тип</th>" : "") +
                                (!isAviationAirModelHidden ? "<th style='width: 150px; border-bottom: 1px solid white; border-left: 1px solid white; background-color: black; color: #FFFFFF;'>Модел</th>" : "") +
                ...
                foreach (ReportAviationEquipManageBlock reportAviationAirManageBlock in reportAviationAirManageBlocks)
                {
                    html.Append(@"
                            <tr>
                                ...
                                (!isNormativeTechnicsHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportAviationAirManageBlock.NormativeTechnicsCode + "</td>") : "") + 
                                (!isAirInvNumberHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportAviationAirManageBlock.AirInvNumber + @"</td>") : "") + 
                                (!isTechnicsCategoryHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportAviationAirManageBlock.TechnicsCategory + @"</td>") : "") + 
                                (!isAviationAirKindHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportAviationAirManageBlock.AviationAirKind + @"</td>") : "") + 
                                (!isAviationAirTypeHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportAviationAirManageBlock.AviationAirType + @"</td>") : "") + 
                                (!isAviationAirModelHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportAviationAirManageBlock.AviationAirModel + @"</td>") : "") +
                                (!isMilDepartmentHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportAviationAirManageBlock.MilitaryDepartment + "</td>") : "") +
                                (!isMilRepStatusHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportAviationAirManageBlock.MilitaryReportStatus + "</td>") : "") +
                                (!isOwnershipHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportAviationAirManageBlock.Ownership + "</td>") : "") +
                                (!isAddressHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportAviationAirManageBlock.Address + "</td>") : "") + @"
