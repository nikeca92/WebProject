...
{
    public partial class PrintAllVehicles : RESPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (GetUIItemAccessLevel("RES_TECHNICS") == UIAccessLevel.Hidden || 
                this.GetUIItemAccessLevel("RES_TECHNICS_VEHICLES") != UIAccessLevel.Hidden)
            {
        ...
        private string GenerateAllRecordsHtml()
        {
            ...
            List<VehicleManageBlock> vehicleManageBlocks = VehicleUtil.GetAllVehicleManageBlocks(filter, 0, CurrentUser);
            ...
            if (vehicleManageBlocks.Count() > 0)
            {
                html.Append(@"
                    ...
                    <table id='applicantsTable' name='applicantsTable' class='CommonHeaderTable'>
                        <thead>
                            <tr>
                                ...
                                <th style='width: 120px;'>Каросерия</th>
            ...
            foreach (VehicleManageBlock vehicleManageBlock in vehicleManageBlocks)
            {
                html.Append(@"<tr>
                            <td align='center'>" + counter + @"</td>
                            <td align='left'>" + vehicleManageBlock.NormativeTechnicsCode + @"</td>
                            <td align='left'>" + vehicleManageBlock.RegNumber + @"</td>
                            <td align='left'>" + vehicleManageBlock.InventoryNumber + @"</td>
                            <td align='left'>" + vehicleManageBlock.TechnicsCategory + @"</td>
                            <td align='left'>" + vehicleManageBlock.VehicleKind + @"</td>
                            <td align='left'>" + vehicleManageBlock.BodyType + @"</td>
                            <td align='left'>" + vehicleManageBlock.VehicleMakeName + @"</td>
                            <td align='left'>" + vehicleManageBlock.VehicleModelName + @"</td>
                            <td align='left'>" + vehicleManageBlock.MilitaryDepartment + @"</td>
                            <td align='left'>" + vehicleManageBlock.MilitaryReportStatus + @"</td>
                            <td align='left'>" + vehicleManageBlock.Ownership + @"</td>
                            <td align='left'>" + vehicleManageBlock.Address + @"</td>
                          </tr>");
                counter++;
            }
        ...
        protected void btnGenerateExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.Clear();
            Response.AppendHeader("content-disposition", "attachment; filename=Vehicles.xls");
        ...
        private string GenerateAllRecordsForExport()
        {
            ...
            html.Append(@"<html xmlns='http://www.w3.org/1999/xhtml' xml:lang='en'>
                            ...
                            <body>
                                <table>
                                    <tr><td align='center' colspan='13' style='font-weight: bold; font-size: 1.6em;'>АСУ на човешките ресурси</td></tr>
                                    <tr><td align='center' colspan='13' style='font-weight: bold; font-size: 2em;'>Отчет на ресурсите от резерва</td></tr>
                                    <tr><td colspan='13'>&nbsp;</td></tr>
                                    <tr><td align='center' colspan='13' style='font-weight: bold; font-size: 1.3em;'>Списък на техниката водена на военен отчет - " + (technicsType != null ? technicsType.TypeName : "") + @"</td></tr>
                                    <tr><td colspan='13'>&nbsp;</td></tr>
                                    <tr>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th style='width: 150px; border-bottom: 1px solid white; border-left: 1px solid white; background-color: black; color: #FFFFFF;'>Каросерия</th>
                ...
                foreach (VehicleManageBlock vehicleManageBlock in vehicleManageBlocks)
                {
                    html.Append(@"
                            <tr>
                                ...
                                <td align='left' style='border: 1px solid black;'>" + vehicleManageBlock.NormativeTechnicsCode + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + vehicleManageBlock.RegNumber + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + vehicleManageBlock.InventoryNumber + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + vehicleManageBlock.TechnicsCategory + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + vehicleManageBlock.VehicleKind + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + vehicleManageBlock.BodyType + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + vehicleManageBlock.VehicleMakeName + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + vehicleManageBlock.VehicleModelName + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + vehicleManageBlock.MilitaryDepartment + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + vehicleManageBlock.MilitaryReportStatus + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + vehicleManageBlock.Ownership + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + vehicleManageBlock.Address + @"</td>
                              </tr>");
                    counter++;
                }
