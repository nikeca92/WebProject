<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageTechnics_TRAILERS.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ManageTechnics_TRAILERS" 
...
function ShowPrintAllTrailers() {
    ...
    var hdnTrailerKindId = document.getElementById("<%= hdnTrailerKindId.ClientID %>").value;
    var hdnTrailerTypeId = document.getElementById("<%= hdnTrailerTypeId.ClientID %>").value;
    ...
    url = "../PrintContentPages/" + pageName + ".aspx?TechnicsTypeKey=" + hdnTechnicsTypeKey
                ...
                + "&TrailerKindId=" + hdnTrailerKindId
                + "&TrailerTypeId=" + hdnTrailerTypeId
            ...
            <tr style="height: 25px;">
             ...
             <tr style="height: 25px;">      
                ...
                <td style="text-align: left; vertical-align: top; width: 260px;">
                 ...
                 <td style="vertical-align: top; text-align: right; width: 120px;">
                   <asp:Label runat="server" ID="lblTrailerKind" CssClass="InputLabel">Вид:</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top; width: 300px;">
                   <asp:DropDownList runat="server" ID="ddTrailerKind" CssClass="InputField" Width="300px"></asp:DropDownList>
                </td>                 
             </tr>
             <tr style="height: 25px;">               
                 <td style="vertical-align: top; text-align: right; width: 150px;">
                   <asp:Label runat="server" ID="lblTrailerType" CssClass="InputLabel">Тип:</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top; width: 260px;">
                   <asp:DropDownList runat="server" ID="ddTrailerType" CssClass="InputField" Width="260px"></asp:DropDownList>
                </td>
             ...
             <tr>
                <td colspan="2">
                   <asp:LinkButton ID="btnNew" runat="server" CssClass="Button" OnClick="btnNew_Click"><i></i><div style="width:250px; padding-left:5px;">Нов запис в <%= TechnicsTypeName %></div><b></b></asp:LinkButton>
                </td>    
                <td colspan="2" style="padding-top: 10px;">
                   ...
                   <asp:LinkButton ID="btnClear" runat="server" CssClass="Button" OnClick="btnClear_Click" ToolTip="Изчистване на избрания филтър"><i></i><div style="width:70px; padding-left:5px;">Изчисти</div><b></b></asp:LinkButton>
                    ...
                    <asp:LinkButton ID="btnPrintAllTrailers" runat="server" CssClass="Button" OnClientClick="ShowPrintAllTrailers(); return false;"><i></i><div style="width:70px; padding-left:5px;">Печат</div><b></b></asp:LinkButton>
...
<div id="divNavigation" runat="server" style="text-align: center;">
    <div style="width: 820px; margin: 0 auto; text-align: left; vertical-align: top; height: 35px;">
...
<asp:HiddenField ID="hdnTrailerKindId" runat="server" />
<asp:HiddenField ID="hdnTrailerTypeId" runat="server" />
