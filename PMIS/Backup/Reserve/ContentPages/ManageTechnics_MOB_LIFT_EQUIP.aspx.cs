...
{
    public partial class ManageTechnics_MOB_LIFT_EQUIP : RESPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            MobileLiftingEquipManageFilter filter = CollectFilterData();

            int allRows = MobileLiftingEquipUtil.GetAllMobileLiftingEquipManageBlocksCount(filter, CurrentUser);
            ...
            if (!IsPostBack)
            {
                ...
                this.btnPrintAllMobileLiftingEquips.Visible = false;
        ...
        private void RefreshDataGrid()
        {
            ...
            List<MobileLiftingEquipManageBlock> mobileLiftingEquipManageBlocks = MobileLiftingEquipUtil.GetAllMobileLiftingEquipManageBlocks(filter, pageLength, CurrentUser);
            ...
            {
                this.btnPrintAllMobileLiftingEquips.Visible = true;
                ...
                foreach (MobileLiftingEquipManageBlock mobileLiftingEquipManageBlock in mobileLiftingEquipManageBlocks)
                {
                    ...
                    if (GetUIItemAccessLevel("RES_TECHNICS_MOB_LIFT_EQUIP_EDIT") != UIAccessLevel.Hidden)
                        editHTML = "<img src='../Images/edit.png' alt='Редактиране' title='Редактиране' class='GridActionIcon' onclick='EditTechnics(" + mobileLiftingEquipManageBlock.TechnicsId.ToString() + ");' />";

                    html += @"<tr class='" + (counter % 2 == 0 ? "DataTableEvenRow" : "DataTableOddRow") + @"'>
                                 <td style='" + cellStyle + @"'>" + ((pageIdx - 1) * pageLength + counter).ToString() + @"</td>
                                 <td style='" + cellStyle + @"' title='" + mobileLiftingEquipManageBlock.NormativeTechnicsName + @"'>" + mobileLiftingEquipManageBlock.NormativeTechnicsCode + @"</td>
                                 <td style='" + cellStyle + @"'>" + mobileLiftingEquipManageBlock.RegNumber + @"</td>
                                 <td style='" + cellStyle + @"'>" + mobileLiftingEquipManageBlock.InventoryNumber + @"</td>
                                 <td style='" + cellStyle + @"'>" + mobileLiftingEquipManageBlock.TechnicsCategory + @"</td>
                                 <td style='" + cellStyle + @"'>" + mobileLiftingEquipManageBlock.MobileLiftingEquipKind + @"</td>
                                 <td style='" + cellStyle + @"'>" + mobileLiftingEquipManageBlock.MobileLiftingEquipType + @"</td>
                                 <td style='" + cellStyle + @"'>" + mobileLiftingEquipManageBlock.MilitaryDepartment + @"</td>
                                 <td style='" + cellStyle + @"'>" + mobileLiftingEquipManageBlock.MilitaryReportStatus + @"</td>
                                 <td style='" + cellStyle + @"'>" + mobileLiftingEquipManageBlock.Ownership + @"</td>
                                 <td style='" + cellStyle + @"'>" + mobileLiftingEquipManageBlock.Address + @"</td>
        ...
        {          
            if (GetUIItemAccessLevel("RES_TECHNICS") == UIAccessLevel.Enabled &&
                GetUIItemAccessLevel("RES_TECHNICS_MOB_LIFT_EQUIP") == UIAccessLevel.Enabled &&
                GetUIItemAccessLevel("RES_TECHNICS_MOB_LIFT_EQUIP_ADD") == UIAccessLevel.Enabled)
            {
                EnableButton(btnNew);
            }
            else
            {
                if (this.GetUIItemAccessLevel("RES_TECHNICS_MOB_LIFT_EQUIP_ADD") == UIAccessLevel.Hidden)
                {
                    HideControl(btnNew);
                }
                else
        ...
        private MobileLiftingEquipManageFilter CollectFilterData()
        {
