<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageTechnics_ENG_EQUIP.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ManageTechnics_ENG_EQUIP" 
...
function ShowPrintAllEngEquips() {
    ...
    var hdnEngEquipKindId = document.getElementById("<%= hdnEngEquipKindId.ClientID %>").value;
    
    var hdnEngEquipBaseMakeName = document.getElementById("<%= hdnEngEquipBaseMakeName.ClientID %>").value;
    var hdnEngEquipBaseModelName = document.getElementById("<%= hdnEngEquipBaseModelName.ClientID %>").value;
    ...
    var url = "";
    var pageName = "PrintAllEngEquips"
    var param = "";

    url = "../PrintContentPages/" + pageName + ".aspx?TechnicsTypeKey=" + hdnTechnicsTypeKey
                + "&RegNumber=" + hdnRegNumber
                + "&InventoryNumber=" + hdnInventoryNumber
                + "&TechnicsCategoryId=" + hdnTechnicsCategoryId
                + "&EngEquipKindId=" + hdnEngEquipKindId
                
//                + "&EngEquipMakeId=" + hdnEngEquipMakeId
//                + "&EngEquipModelId=" + hdnEngEquipModelId

                + "&EngEquipBaseMakeName=" + hdnEngEquipBaseMakeName
                + "&EngEquipBaseModelName=" + hdnEngEquipBaseModelName
          ...
          <table width="100%" style="border-collapse:collapse; vertical-align: middle; color: #0B449D;">
            ...
            <tr style="height: 25px;">
                ...
                <td style="text-align: left; vertical-align: top; width: 280px;">
                   <asp:TextBox runat="server" ID="txtInventoryNumber" CssClass="InputField" Width="275px"></asp:TextBox>
                </td>
             </tr>
             <tr style="height: 25px;">      
                <td style="vertical-align: top; text-align: right; width: 150px;">
                ...
                <td style="text-align: left; vertical-align: top; width: 260px;">
                 ...
                 <td style="vertical-align: top; text-align: right; width: 120px;">
                   <asp:Label runat="server" ID="lblEngEquipKind" CssClass="InputLabel">Вид:</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top; width: 280px;">
                   <asp:DropDownList runat="server" ID="ddEngEquipKind" CssClass="InputField" Width="280px"></asp:DropDownList>
                </td>                 
             </tr>
             <tr style="height: 25px;">               
                 <td style="vertical-align: top; text-align: right; width: 150px;">
                   <asp:Label runat="server" ID="lblEngEquipBaseMake" CssClass="InputLabel">Марка (базова-машина):</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top; width: 260px;">
                   <%--<asp:DropDownList runat="server" ID="ddEngEquipBaseMake" CssClass="InputField" Width="260px" AutoPostBack="true" OnSelectedIndexChanged="ddEngEquipBaseMake_Changed"></asp:DropDownList>--%>
                   <asp:TextBox runat="server" ID="txtEngEquipBaseMakeName" CssClass="InputField" Width="255px"></asp:TextBox>
                </td>
                 <td style="vertical-align: top; text-align: right; width: 160px;">
                   <asp:Label runat="server" ID="lblEngEquipBaseModel" CssClass="InputLabel">Модел (базова-машина):</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top; width: 280px;">
                   <%--<asp:DropDownList runat="server" ID="ddEngEquipBaseModel" CssClass="InputField" Width="280px"></asp:DropDownList>--%>
                   <asp:TextBox runat="server" ID="txtEngEquipBaseModelName" CssClass="InputField" Width="275px"></asp:TextBox>
                </td>
             </tr>
             <tr style="height: 25px;">               
                 <td style="vertical-align: top; text-align: right; width: 150px;">
             ...
             <tr style="height: 25px;">               
                ...
                <td style="text-align: left; vertical-align: bottom; width: 280px;">
                   <asp:TextBox runat="server" ID="txtOwnershipName" CssClass="InputField" Width="275px"></asp:TextBox>
                </td>
             </tr>
             ...
             <tr>
                <td colspan="2">
                   <asp:LinkButton ID="btnNew" runat="server" CssClass="Button" OnClick="btnNew_Click"><i></i><div style="width:200px; padding-left:5px;">Нов запис в <%= TechnicsTypeName %></div><b></b></asp:LinkButton>
                </td>
                <td colspan="2" style="padding-top: 10px;">
                   ...
                   <asp:LinkButton ID="btnClear" runat="server" CssClass="Button" OnClick="btnClear_Click" ToolTip="Изчистване на избрания филтър"><i></i><div style="width:70px; padding-left:5px;">Изчисти</div><b></b></asp:LinkButton>
                    ...
                    <asp:LinkButton ID="btnPrintAllEngEquips" runat="server" CssClass="Button" OnClientClick="ShowPrintAllEngEquips(); return false;"><i></i><div style="width:70px; padding-left:5px;">Печат</div><b></b></asp:LinkButton>
...
<div id="divNavigation" runat="server" style="text-align: center;">
    <div style="width: 700px; margin: 0 auto; text-align: left; vertical-align: top; height: 35px;">
...
<asp:HiddenField ID="hdnRegNumber" runat="server" />
<asp:HiddenField ID="hdnInventoryNumber" runat="server" />
<asp:HiddenField ID="hdnTechnicsCategoryId" runat="server" />
<asp:HiddenField ID="hdnEngEquipKindId" runat="server" />

<%--<asp:HiddenField ID="hdnEngEquipMakeId" runat="server" />
<asp:HiddenField ID="hdnEngEquipModelId" runat="server" />--%>

<asp:HiddenField ID="hdnEngEquipBaseMakeName" runat="server" />
<asp:HiddenField ID="hdnEngEquipBaseModelName" runat="server" />
