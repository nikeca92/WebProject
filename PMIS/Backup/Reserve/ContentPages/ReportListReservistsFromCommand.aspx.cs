...
{
    public partial class ReportListReservistsFromCommand : RESPage
    {
        ...
        public override string PageUIKey
        {
            get
            {
                return "RES_REPORTS_REPORTLISTRESERVISTSFROMCOMMAND";
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (GetUIItemAccessLevel("RES_REPORTS") == UIAccessLevel.Hidden ||
                GetUIItemAccessLevel("RES_REPORTS_REPORTLISTRESERVISTSFROMCOMMAND") == UIAccessLevel.Hidden)
            {
            ...
            HighlightMenuItems("Reports", "ReportListReservistsFromCommand");
            ...
            ReportListReservistsFromCommandFilter filter = CollectFilterData();

            int allRows = ReportListReservistsFromCommandBlockUtil.GetReportListReservistsFromCommandBlockCount(filter, CurrentUser);
        ...
        private void PopulateMilitaryCommand()
        {
            ...
            List<MilitaryCommand> militaryCommands = MilitaryCommandUtil.GetMilitaryCommandsByMilitaryDepartmentForReservists(CurrentUser, militaryDepratment);
        ...
        private void RefreshReportItems()
        {
            ...
            List<ReportListReservistsFromCommandBlock> reportBlocks = ReportListReservistsFromCommandBlockUtil.GetReportListReservistsFromCommandBlockList(filter, CurrentUser);
            ...
            if (reportBlocks.Count == 0)
            {
                ...
                this.btnPrintReportListReservistsFromCommand.Visible = false;
            ...
            {
                this.btnPrintReportListReservistsFromCommand.Visible = true;
                ...
                html = @"<table class='CommonHeaderTable' style='margin: 0 auto; text-align: left;'>
                         <thead>
                            <tr>
                               ...
                               <th style='width: 140px; " + headerStyle + @"' onclick='SortTableBy(2);'>Длъжност" + arrOrderCol[1] + @"</th>
                               <th style='width: 170px; " + headerStyle + @"' onclick='SortTableBy(3);'>Назначен на ВОС" + arrOrderCol[2] + @"</th>
                               <th style='width: 80px; " + headerStyle + @"' onclick='SortTableBy(4);'>Звание" + arrOrderCol[3] + @"</th>
                               <th style='width: 110px; " + headerStyle + @"' onclick='SortTableBy(5);'>Начин на явяване" + arrOrderCol[4] + @"</th>
                               <th style='width: 90px; " + headerStyle + @"' onclick='SortTableBy(6);'>ЕГН" + arrOrderCol[5] + @"</th>
                               <th style='width: 180px; " + headerStyle + @"' onclick='SortTableBy(7);'>Име" + arrOrderCol[6] + @"</th>
                               <th style='width: 120px; " + headerStyle + @"' onclick='SortTableBy(8);'>Населено място" + arrOrderCol[7] + @"</th>
                            </tr>
                         </thead>";
                ...
                foreach (ReportListReservistsFromCommandBlock reportBlock in reportBlocks)
                {
                    string cellStyle = "vertical-align: top;";

                    string militaryReportSpeciality = reportBlock.MilitaryReportingSpecialty;

                    if (militaryReportSpeciality.Length > 18)
                    {
                        militaryReportSpeciality = "<span title='" + militaryReportSpeciality + "'>" + militaryReportSpeciality.Substring(0, 17) + "...</span>";
                    }
                    ...
                    html += @"<tr class='" + (counter % 2 == 0 ? "DataTableEvenRow" : "DataTableOddRow") + @"'>
                                 ...
                                 <td style='" + cellStyle + @"'>" + reportBlock.Position + @"</td>
                                 <td style='" + cellStyle + @"'>" + militaryReportSpeciality + @"</td>
                                 <td style='" + cellStyle + @"'>" + reportBlock.MilitaryRank + @"</td>
                                 <td style='" + cellStyle + @"'>" + reportBlock.Readiness + @"</td>
                                 <td style='" + cellStyle + @"'>" + reportBlock.IdentityNumber + @"</td>
                                 <td style='" + cellStyle + @"'>" + reportBlock.FullName + @"</td>
                                 <td style='" + cellStyle + @"'>" + reportBlock.PermPlaceName + @"</td>
                              </tr>";
        ...
        private ReportListReservistsFromCommandFilter CollectFilterData()
        {
