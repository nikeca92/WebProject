<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportAnalyzeTechCommand.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ReportAnalyzeTechCommand" 
         Title="Сведение-анализ за комплектуване на команда с техника-запас" %>
...
function ShowPrintReport()
{
    ...
    var url = "";
    var pageName = "PrintReportAnalyzeTechCommand"
    var param = "";
...
function ExportReport() {
    ...
    url = "../PrintContentPages/" + pageName + ".aspx?MilitaryDepartmentId=" + hdnMilitaryDepartmentId
                                                + "&MilitaryReadinessID=" + ddMilitaryReadinessID
                                                + "&MilitaryCommandId=" + ddMilitaryCommandId
                                                + "&MilitaryCommandSuffix=" + ddMilitaryCommandSuffix + "&Export=true";
...
<div style="text-align: left;">
   <span id="lblHeaderTitle" runat="server" class="HeaderText">Сведение-анализ за комплектуване на команда с техника-запас</span>
</div>
