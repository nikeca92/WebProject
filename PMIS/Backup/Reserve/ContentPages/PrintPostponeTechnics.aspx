<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="PrintPostponeTechnics.aspx.cs" Inherits="PMIS.Reserve.ContentPages.PrintPostponeTechnics" 
         Title="Печат на талони за отсрочване на техника" %>
...
function btnPrintTO_Click() {
    if (document.getElementById("hdnRowsCount")) {
        ...
        document.getElementById("<%= btnPrintTOSrv.ClientID %>").click();
    }
}
...
<div style="text-align: center;">
   <span id="lblHeaderTitle" runat="server" class="HeaderText">Печат на талони за отсрочки на техника</span>
</div>
             ...
             <tr>
                <td colspan="2" style="width: 100%;" >
                    <center>
                        ...
                        <asp:LinkButton ID="btnPrintTO" runat="server" CssClass="Button" OnClientClick="btnPrintTO_Click(); return false;"><i></i><div style="width:150px; padding-left:2px;">Печат на талон</div><b></b></asp:LinkButton>
                        
                        <asp:Button ID="btnPrintTOSrv" runat="server" OnClick="btnPrintTO_Click" />
                    </center>
                </td>
             </tr>
          </table>
