<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageTechnics_RAILWAY_EQUIP.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ManageTechnics_RAILWAY_EQUIP" 
...
function ShowPrintAllRailwayEquips() {
    ...
    var hdnRailwayEquipKindId = document.getElementById("<%= hdnRailwayEquipKindId.ClientID %>").value;
    var hdnRailwayEquipTypeId = document.getElementById("<%= hdnRailwayEquipTypeId.ClientID %>").value;
    ...
    var url = "";
    var pageName = "PrintAllRailwayEquips"
    var param = "";
    ...
    url = "../PrintContentPages/" + pageName + ".aspx?TechnicsTypeKey=" + hdnTechnicsTypeKey
                ...
                + "&RailwayEquipKindId=" + hdnRailwayEquipKindId
                + "&RailwayEquipTypeId=" + hdnRailwayEquipTypeId
             ...
             <tr>
                <td colspan="4" style="padding-top: 10px;">
                   ...
                   <asp:LinkButton ID="btnClear" runat="server" CssClass="Button" OnClick="btnClear_Click" ToolTip="Изчистване на избрания филтър"><i></i><div style="width:70px; padding-left:5px;">Изчисти</div><b></b></asp:LinkButton>
                    ...
                    <asp:LinkButton ID="btnPrintAllRailwayEquips" runat="server" CssClass="Button" OnClientClick="ShowPrintAllRailwayEquips(); return false;"><i></i><div style="width:70px; padding-left:5px;">Печат</div><b></b></asp:LinkButton>
...
<div style="text-align: center;">
    <div style="width: 870px; margin: 0 auto; text-align: left; vertical-align: top; height: 35px;">
       <asp:LinkButton ID="btnNew" runat="server" CssClass="Button" OnClick="btnNew_Click"><i></i><div style="width:300px; padding-left:5px;">Нов запис в <%= TechnicsTypeName %></div><b></b></asp:LinkButton>
...
<asp:HiddenField ID="hdnRailwayEquipKindId" runat="server" />
<asp:HiddenField ID="hdnRailwayEquipTypeId" runat="server" />
