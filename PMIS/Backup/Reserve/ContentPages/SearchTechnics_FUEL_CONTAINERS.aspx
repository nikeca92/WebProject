<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="SearchTechnics_FUEL_CONTAINERS.aspx.cs" Inherits="PMIS.Reserve.ContentPages.SearchTechnics_FUEL_CONTAINERS" 
...
function ChooseFuelContainer(technicsId, fuelContainerId, itemsCount) {
    ...
    function ConfirmYes() {
        var url = "SearchTechnics_FUEL_CONTAINERS.aspx?AjaxMethod=JSChooseFuelContainer";
        var params = "";
        params += "TechnicsID=" + technicsId;
        params += "&FuelContainerID=" + fuelContainerId;
...
function ShowChooseItemsCountLightBox(technicsId, fuelContainerId, itemsCount)
{
...
function SaveChooseItemsCountLightBox()
{
    if (ValidateChooseItemsCount())
    {
        ...
        var fuelContainerId = parseInt(document.getElementById("hdnFuelContainerId").value);
        var itemsCount = parseInt(document.getElementById("txtItemsCount").value);

        ChooseFuelContainer(technicsId, fuelContainerId, itemsCount);
    }
}
