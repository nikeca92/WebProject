<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportA33v2_BENCHMARK.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ReportA33v2_BENCHMARK" 
...
<div style="text-align: center;">
   <span id="lblHeaderTitle" runat="server" class="HeaderText">Сведение-анализ за състоянието на ресурсите от резерва</span><br />
   <span style="color: Red; font-size: 20px;">ТЕСТ</span>
</div>
