<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportTechnics_FUEL_CONTAINERS.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ReportTechnics_FUEL_CONTAINERS" 
...
function ShowPrintReportAllFuelContainers() {
    ...
    var url = "";
    var pageName = "PrintReportAllFuelContainers"
    var param = "";
             ...
             <tr>
                <td colspan="4" style="padding-top: 10px;">
                   ...
                   <asp:LinkButton ID="btnClear" runat="server" CssClass="Button" OnClick="btnClear_Click" ToolTip="Изчистване на избрания филтър"><i></i><div style="width:70px; padding-left:5px;">Изчисти</div><b></b></asp:LinkButton>
                    ...
                    <asp:LinkButton ID="btnPrintReportAllFuelContainers" runat="server" CssClass="Button" OnClientClick="ShowPrintReportAllFuelContainers(); return false;"><i></i><div style="width:70px; padding-left:5px;">Печат</div><b></b></asp:LinkButton>
