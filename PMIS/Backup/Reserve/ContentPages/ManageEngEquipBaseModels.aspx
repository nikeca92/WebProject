<%@ Page Title="Модели инж. машини" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageEngEquipBaseModels.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ManageEngEquipBaseModels" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <style type="text/css">

    .EngEquipBaseModelLightBox
    {
	    width: 400px;
    ...
    <script type="text/javascript" src='<% Response.Write(ResolveUrl("~")); %>Scripts/ManageEngEquipBaseModels.js'></script>


<script type="text/javascript">

    var ddlEngEquipBaseMakesClientID = "<%= ddlEngEquipBaseMakes.ClientID %>";
...
<div style="text-align: center;">
   <span id="lblHeaderTitle" runat="server" class="HeaderText">Модели инж. машини</span>
</div>
          ...
          <table width="100%" style="border-collapse:collapse; vertical-align: middle; color: #0B449D;">
             ...
             <tr style="height: 25px;">
                <td style="vertical-align: top; text-align: right; width: 35%;">
                    <asp:Label runat="server" ID="lblEngEquipBaseMake" CssClass="InputLabel">Марка инж. машина:</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top; width: 45%;">
                    <asp:DropDownList runat="server" ID="ddlEngEquipBaseMakes" CssClass="InputField" Width="200px"
                        OnSelectedIndexChanged="ddlEngEquipBaseMakes_Change" AutoPostBack="true"></asp:DropDownList>
                </td>
                <td style="text-align: left; vertical-align: top; width: 20%;">
                    <asp:ImageButton ID="imgBtnNewModel" runat="server" ImageUrl="../Images/add_new.png" 
                        AlternateText="Добавяне на нов модел инж. машина" ToolTip="Добавяне на нов модел инж. машина" 
                        OnClientClick="ShowEngEquipBaseModelLightBox(0); return false;" />
                </td>
             </tr> 
             <tr>
...
<input type="hidden" id="CanLeave" value="true" />
    ...
    <div id="EngEquipBaseModelLightBox" class="EngEquipBaseModelLightBox" style="display: none; text-align: center;">
        <input type='hidden' id='hdnEngEquipBaseModelId' name='hdnEngEquipBaseModelId' />
        <table style='text-align:center;'>
            <tr style='height: 15px'><td colspan="2"></td></tr>
            <tr>
                <td colspan='2' align='center'>
                    <span id='lblEngEquipBaseModelBoxTitle' class='SmallHeaderText'></span>
                </td>
            </tr>
            <tr style='height: 17px'><td colspan="2"></td></tr>
            <tr style='min-height: 17px;'>
                <td align='right' style='width: 160px;'>
                    <span id='lblEngEquipBaseMakeLightBox' class='InputLabel'>Марка:</span>
                </td>
                <td align='left' style='min-width: 220px;'>
                    <span id='lblEngEquipBaseMakeValue' class='ReadOnlyValue'></span>
                </td>
            </tr>      
            <tr style='min-height: 17px;'>
                <td align='right' style='width: 160px;'>
                    <span id='lblEngEquipBaseModelName' class='InputLabel'>Модел инж. машина:</span>
                </td>
                <td align='left' style='min-width: 220px;'>
                    <input type='text' id='txtEngEquipBaseModelName' class='RequiredInputField' style='width: 200px;' maxlength='300' />
                </td>
            </tr>             
            <tr style='height: 30px'>
                <td colspan='2'> 
                    <span id='lblEngEquipBaseModelLightBoxMessage' class='ErrorText' style='display: none;'></span>
               </td>
            </tr>
            <tr>
                    ...
                    <table style='margin: 0 auto;'>
                       <tr>
                          <td style='text-align: center;'>
                             <div id='btnSaveEngEquipBaseModel' style='display: inline;' onclick='SaveEngEquipBaseModel();' class='Button'><i></i><div id='btnSaveEngEquipBaseModelText' style='width:70px;'>Запис</div><b></b></div>
                             <div id='btnCloseEngEquipBaseModelBox' style='display: inline;' onclick='HideEngEquipBaseModelLightBox();' class='Button'><i></i><div id='btnCloseVehickleModelBoxText' style='width:70px;'>Затвори</div><b></b></div>
                          </td>
                       </tr>
                    </table>                    
                </td>
