<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="SearchTechnics_ENG_EQUIP.aspx.cs" Inherits="PMIS.Reserve.ContentPages.SearchTechnics_ENG_EQUIP" 
...
function ChooseEngEquip(technicsId, engEquipId) {
    ...
    function ConfirmYes() {
        var url = "SearchTechnics_ENG_EQUIP.aspx?AjaxMethod=JSChooseEngEquip";
        var params = "";
        params += "TechnicsID=" + technicsId;
        params += "&EngEquipID=" + engEquipId;
       ...
       <div class="FilterLegend">Филтър</div>
          <table width="100%" style="border-collapse:collapse; vertical-align: middle; color: #0B449D;">
             ...
             <tr style="height: 25px;">      
                ...
                <td style="text-align: left; vertical-align: top; width: 300px;">
                   <asp:DropDownList runat="server" ID="ddEngEquipKind" CssClass="InputField" Width="300px"></asp:DropDownList>
                </td>                 
             </tr>
             <tr style="height: 25px;">               
                 <td style="vertical-align: top; text-align: right; width: 150px;">
                   <asp:Label runat="server" ID="lblEngEquipBaseMake" CssClass="InputLabel">Марка:</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top; width: 260px;">
                 ...
                 <td style="vertical-align: top; text-align: right; width: 120px;">
                   <asp:Label runat="server" ID="lblEngEquipBaseModel" CssClass="InputLabel">Модел:</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top; width: 300px;">
                   <%--<asp:DropDownList runat="server" ID="ddEngEquipBaseModel" CssClass="InputField" Width="300px"></asp:DropDownList>--%>
             ...
             <tr style="height: 25px;">               
                ...
                <td style="text-align: left; vertical-align: bottom; width: 260px;">
                   <asp:TextBox runat="server" ID="txtOwnershipNumber" CssClass="InputField" Width="255px"></asp:TextBox>
                </td>
