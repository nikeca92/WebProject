<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageTechnics_MOB_LIFT_EQUIP.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ManageTechnics_MOB_LIFT_EQUIP" 
...
function ShowPrintAllMobileLiftingEquips() {
    ...
    var hdnMobileLiftingEquipKindId = document.getElementById("<%= hdnMobileLiftingEquipKindId.ClientID %>").value;
    var hdnMobileLiftingEquipTypeId = document.getElementById("<%= hdnMobileLiftingEquipTypeId.ClientID %>").value;
    ...
    var url = "";
    var pageName = "PrintAllMobileLiftingEquips"
    var param = "";
    ...
    url = "../PrintContentPages/" + pageName + ".aspx?TechnicsTypeKey=" + hdnTechnicsTypeKey
                ...
                + "&MobileLiftingEquipKindId=" + hdnMobileLiftingEquipKindId
                + "&MobileLiftingEquipTypeId=" + hdnMobileLiftingEquipTypeId
            ...
            <tr style="height: 25px;">
             ...
             <tr style="height: 25px;">      
                ...
                <td style="text-align: left; vertical-align: top; width: 260px;">
                 ...
                 <td style="vertical-align: top; text-align: right; width: 120px;">
                   <asp:Label runat="server" ID="lblMobileLiftingEquipKind" CssClass="InputLabel">Вид:</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top; width: 300px;">
                   <asp:DropDownList runat="server" ID="ddMobileLiftingEquipKind" CssClass="InputField" Width="300px"></asp:DropDownList>
                </td>                 
             </tr>          
             <tr style="height: 25px;">
                <td style="vertical-align: top; text-align: right; width: 120px;">
                   <asp:Label runat="server" ID="lblMobileLiftingEquipType" CssClass="InputLabel">Тип:</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top; width: 260px;">
                   <asp:DropDownList runat="server" ID="ddMobileLiftingEquipType" CssClass="InputField" Width="260px"></asp:DropDownList>
                </td>                 
             </tr>  
             <tr style="height: 25px;">               
                 <td style="vertical-align: top; text-align: right; width: 150px;">
             ...
             <tr>
                <td colspan="2">
                   <asp:LinkButton ID="btnNew" runat="server" CssClass="Button" OnClick="btnNew_Click"><i></i><div style="width:275px; padding-left:5px;">Нов запис в <%= TechnicsTypeName %></div><b></b></asp:LinkButton>
                </td>
                <td colspan="2" style="padding-top: 10px;">
                   ...
                   <asp:LinkButton ID="btnClear" runat="server" CssClass="Button" OnClick="btnClear_Click" ToolTip="Изчистване на избрания филтър"><i></i><div style="width:70px; padding-left:5px;">Изчисти</div><b></b></asp:LinkButton>                    
                    ...
                    <asp:LinkButton ID="btnPrintAllMobileLiftingEquips" runat="server" CssClass="Button" OnClientClick="ShowPrintAllMobileLiftingEquips(); return false;"><i></i><div style="width:70px; padding-left:5px;">Печат</div><b></b></asp:LinkButton>
...
<div id="divNavigation" runat="server" style="text-align: center;">
    <div style="width: 800px; margin: 0 auto; text-align: left; vertical-align: top; height: 35px;">
...
<asp:HiddenField ID="hdnMobileLiftingEquipKindId" runat="server" />
<asp:HiddenField ID="hdnMobileLiftingEquipTypeId" runat="server" />
