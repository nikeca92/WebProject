<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportPostpone.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ReportPostpone" 
    Title="Протокол за изпълнение на отсрочването" EnableEventValidation="false" %>
...
<div style="text-align: center; padding-top: 20px;">
   <span id="lblHeaderTitle" runat="server" class="HeaderText">Протокол за изпълнение на отсрочването</span>
</div>
