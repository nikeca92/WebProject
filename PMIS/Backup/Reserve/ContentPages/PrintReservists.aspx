<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="PrintReservists.aspx.cs" Inherits="PMIS.Reserve.ContentPages.PrintReservists" 
         Title="Печат на документи за хора" %>
...
<div style="text-align: center;">
   <span id="lblHeaderTitle" runat="server" class="HeaderText">Печат на документи за хора</span>
</div>
          ...
          <table width="100%" style="border-collapse:collapse; vertical-align: middle; color: #0B449D;">
             ...
             <tr>
                ...
                <td style="text-align: left; vertical-align: top; width: 365px;">
                    ...
                    <ContentTemplate> 
                        <asp:TextBox runat="server" ID="txtIdentNumber" CssClass="InputField" Width="600px"></asp:TextBox> 
                    </ContentTemplate>
                    </asp:UpdatePanel>
                </td>
             </tr>
