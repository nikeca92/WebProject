<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportListReservistsFromCommand.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ReportListReservistsFromCommand" 
         Title="Списък на хората с МН от команда" %>
...
function ShowPrintReportListReservistsFromCommand() {
    ...
    var url = "";
    var pageName = "PrintReportListReservistsFromCommand"
    var param = "";
...
<div style="text-align: center;">
   <span id="lblHeaderTitle" runat="server" class="HeaderText">Списък на хората с МН от команда</span>
</div>
             ...
             <tr>
                <td colspan="4" style="padding-top: 10px;">
                   ...
                   <asp:LinkButton ID="btnClear" runat="server" CssClass="Button" OnClick="btnClear_Click" ToolTip="Изчистване на избрания филтър"><i></i><div style="width:70px; padding-left:5px;">Изчисти</div><b></b></asp:LinkButton>
                    ...
                    <asp:LinkButton ID="btnPrintReportListReservistsFromCommand" runat="server" CssClass="Button" OnClientClick="ShowPrintReportListReservistsFromCommand(); return false;"><i></i><div style="width:70px; padding-left:5px;">Печат</div><b></b></asp:LinkButton>
