<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageTechnics_VEHICLES.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ManageTechnics_VEHICLES" 
...
function ShowPrintAllVehicles() {
    ...
    var hdnVehicleKindId = document.getElementById("<%= hdnVehicleKindId.ClientID %>").value;
    
    var hdnVehicleMakeName = document.getElementById("<%= hdnVehicleMakeName.ClientID %>").value;
    var hdnVehicleModelName = document.getElementById("<%= hdnVehicleModelName.ClientID %>").value;
    
    var hdnVehicleBodyTypeId = document.getElementById("<%= hdnVehicleBodyTypeId.ClientID %>").value;
    ...
    url = "../PrintContentPages/" + pageName + ".aspx?TechnicsTypeKey=" + hdnTechnicsTypeKey
                ...
                + "&VehicleKindId=" + hdnVehicleKindId
                
//                + "&VehicleMakeId=" + hdnVehicleMakeId
//                + "&VehicleModelId=" + hdnVehicleModelId

                + "&VehicleMakeName=" + hdnVehicleMakeName
                + "&VehicleModelName=" + hdnVehicleModelName

                + "&VehicleBodyTypeId=" + hdnVehicleBodyTypeId
       ...
       <div class="FilterLegend">Филтър</div>
          <table width="100%" style="border-collapse:collapse; vertical-align: middle; color: #0B449D;">
            ...
            <tr style="height: 25px;">
             ...
             <tr style="height: 25px;">      
                 <td style="vertical-align: top; text-align: right; width: 150px;">
                   <asp:Label runat="server" ID="lblVehicleKind" CssClass="InputLabel">Вид:</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top; width: 260px;">
                   <asp:DropDownList runat="server" ID="ddVehicleKind" CssClass="InputField" Width="260px" OnSelectedIndexChanged="ddVehicleKind_Changed" AutoPostBack=true></asp:DropDownList>
                </td>    
                 <td style="vertical-align: top; text-align: right; width: 140px;">
             ...
             <tr style="height: 25px;">               
                 <td style="vertical-align: top; text-align: right; width: 150px;">
                   <asp:Label runat="server" ID="lblVehicleMake" CssClass="InputLabel">Марка:</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top; width: 260px;">
                   <%--<asp:DropDownList runat="server" ID="ddVehicleMake" CssClass="InputField" Width="260px" AutoPostBack="true" OnSelectedIndexChanged="ddVehicleMake_Changed"></asp:DropDownList>--%>
                   <asp:TextBox runat="server" ID="txtVehicleMakeName" CssClass="InputField" Width="255px"></asp:TextBox>
                </td>
                 <td style="vertical-align: top; text-align: right; width: 140px;">
                   <asp:Label runat="server" ID="lblVehicleModel" CssClass="InputLabel">Модел:</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top; width: 300px;">
                   <%--<asp:DropDownList runat="server" ID="ddVehicleModel" CssClass="InputField" Width="300px"></asp:DropDownList>--%>
                   <asp:TextBox runat="server" ID="txtVehicleModelName" CssClass="InputField" Width="295px"></asp:TextBox>
                </td>
             </tr>
              <tr style="height: 25px;">               
                 <td style="vertical-align: top; text-align: right; width: 150px;">
                   <asp:Label runat="server" ID="lblVehicleBodyType" CssClass="InputLabel">Каросерия:</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top; width: 260px;">
                   <asp:DropDownList runat="server" ID="ddVehicleBodyType" CssClass="InputField" Width="260px" ></asp:DropDownList>
                </td>
             </tr>
             <tr style="height: 25px;">               
                 <td style="vertical-align: top; text-align: right; width: 150px;">
             ...
             <tr>
                <td colspan="2"> 
                   <asp:LinkButton ID="btnNew" runat="server" CssClass="Button" OnClick="btnNew_Click"><i></i><div style="width:160px; padding-left:5px;">Нов запис в <%= TechnicsTypeName %></div><b></b></asp:LinkButton>
                </td>
                <td colspan="2" style="padding-top: 10px;">
                   ...
                   <asp:LinkButton ID="btnClear" runat="server" CssClass="Button" OnClick="btnClear_Click" ToolTip="Изчистване на избрания филтър"><i></i><div style="width:70px; padding-left:5px;">Изчисти</div><b></b></asp:LinkButton>
                    ...
                    <asp:LinkButton ID="btnPrintAllVehicles" runat="server" CssClass="Button" OnClientClick="ShowPrintAllVehicles(); return false;"><i></i><div style="width:70px; padding-left:5px;">Печат</div><b></b></asp:LinkButton>
...
<asp:HiddenField ID="hdnVehicleKindId" runat="server" />

<%--<asp:HiddenField ID="hdnVehicleMakeId" runat="server" />
<asp:HiddenField ID="hdnVehicleModelId" runat="server" />--%>

<asp:HiddenField ID="hdnVehicleMakeName" runat="server" />
<asp:HiddenField ID="hdnVehicleModelName" runat="server" />

<asp:HiddenField ID="hdnVehicleBodyTypeId" runat="server" />
