...
{
    public partial class FulfilEquipmentTechnicsRequest : RESPage
    {
        ...
        {
            string header = "Изпълнение на заявка за окомплектоване с техника от резерва";
        ...
        private void LoadData()
        {
            ...
            {
                txtMilitaryUnit.Text = equipmentTechnicsRequest.MilitaryUnit.DisplayTextForSelection;
            }
            ...
            ddMilitaryCommand.DataSource = TechnicsRequestCommandUtil.GetTechnicsRequestCommandsForRequestAndMilDept(CurrentUser, EquipmentTechnicsRequestId, MilitaryDepartmentId); ;
        ...
        {
            Response.Redirect("~/ContentPages/ManageEquipmentTechnicsRequestsFulfilment.aspx");
        }
        ...
        private void SetupPageUI()
        {
            ...
            l = GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_REQUEST_REQUESTNUMBER");
            ...
            l = this.GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_REQUEST_REQUESTDATE");
            if (l == UIAccessLevel.Hidden || isRequestHidden)
            {
            ...
            l = this.GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_REQUEST_MILITARYUNIT");
            if (l == UIAccessLevel.Hidden || isRequestHidden)
            {
            ...
            l = this.GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_REQUEST_MILDEPT");
            if (l == UIAccessLevel.Hidden || isRequestHidden)
            {
        ...
        protected void ddMilitaryCommand_Changed(object sender, EventArgs e)
        {
            ...
            if (ddMilitaryCommand.SelectedValue != "-1")
            {
                ...
                // load "punkt"-panel
                TechnicsRequestCommandPunkt punkt = TechnicsRequestCommandPunktUtil.GetTechnicsRequestCommandPunkt(requestCommantId, MilitaryDepartmentId, CurrentUser);
                ...
                List<TechnicsRequestCommandPositionBlockForFulfilment> requestCommandPositions = TechnicsRequestCommandPositionUtil.GetTechnicsRequestCommandPositionsForFulfilment(CurrentUser, command.TechnicsRequestCommandId, MilitaryDepartmentId);
            ...
            sb.Append(@"<div style=""width:100%; height: 30px; display: inline-box; text-align: right; position:relative;"">
                            <div style='position: absolute; right:100px;'>
                                <div id=""btnTechFulfilmentRemoval"" style=""display: inline;"" 
                                     onclick=""techFulfilmentRemoval.showDialog('techFulfilmentRemoval_0', function(){document.getElementById(btnRefresh).click()}, document.getElementById(ddMilitaryCommand).value, document.getElementById(hfMilitaryDepartmentID).value);"" 
                                     class=""Button"">
                                        <i></i>
...
<div style='text-align: right; margin: 0 auto; width: " + tableWidth.ToString() + @"px; padding: 10px;'>
   ...
   <span class='ReadOnlyValue' style='width: 100px; display: inline-block; text-align: left;'>" + totalFulfiledReserve.ToString() + totalFulfiledReservePercStr + @"</span>
        ...
        // Generate contents for view fulfilment mobile lift equip light box
