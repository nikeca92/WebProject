<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageTechnics_FUEL_CONTAINERS.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ManageTechnics_FUEL_CONTAINERS" 
...
function ShowPrintAllFuelContainers() {
    ...
    var hdnFuelContainerKindId = document.getElementById("<%= hdnFuelContainerKindId.ClientID %>").value;
    var hdnFuelContainerTypeId = document.getElementById("<%= hdnFuelContainerTypeId.ClientID %>").value;
    ...
    var url = "";
    var pageName = "PrintAllFuelContainers"
    var param = "";
    ...
    url = "../PrintContentPages/" + pageName + ".aspx?TechnicsTypeKey=" + hdnTechnicsTypeKey
                ...
                + "&FuelContainerKindId=" + hdnFuelContainerKindId
                + "&FuelContainerTypeId=" + hdnFuelContainerTypeId
       ...
       <div class="FilterLegend">Филтър</div>
          <table width="100%" style="border-collapse:collapse; vertical-align: middle; color: #0B449D;">
            ...
            <tr style="height: 25px;">
             ...
             <tr style="height: 25px;">      
                <td style="vertical-align: top; text-align: right; width: 150px;">
                   <asp:Label runat="server" ID="lblFuelContainerKind" CssClass="InputLabel">Вид:</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top; width: 260px;">
                   <asp:DropDownList runat="server" ID="ddFuelContainerKind" CssClass="InputField" Width="260px"></asp:DropDownList>
                </td>         
                 <td style="vertical-align: top; text-align: right; width: 120px;">
                   <asp:Label runat="server" ID="lblFuelContainerType" CssClass="InputLabel">Тип:</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top; width: 300px;">
                   <asp:DropDownList runat="server" ID="ddFuelContainerType" CssClass="InputField" Width="300px"></asp:DropDownList>
                </td>                 
             </tr>
             <tr style="height: 25px;">               
                 <td style="vertical-align: top; text-align: right; width: 150px;">
             ...
             <tr>
                <td colspan="4" style="padding-top: 10px;">
                   ...
                   <asp:LinkButton ID="btnClear" runat="server" CssClass="Button" OnClick="btnClear_Click" ToolTip="Изчистване на избрания филтър"><i></i><div style="width:70px; padding-left:5px;">Изчисти</div><b></b></asp:LinkButton>
                    ...
                    <asp:LinkButton ID="btnPrintAllFuelContainers" runat="server" CssClass="Button" OnClientClick="ShowPrintAllFuelContainers(); return false;"><i></i><div style="width:70px; padding-left:5px;">Печат</div><b></b></asp:LinkButton>
...
<asp:HiddenField ID="hdnFuelContainerKindId" runat="server" />
<asp:HiddenField ID="hdnFuelContainerTypeId" runat="server" />
