<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportTechnics_ENG_EQUIP.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ReportTechnics_ENG_EQUIP" 
...
function ShowPrintReportAllEngEquips() {
    ...
    var url = "";
    var pageName = "PrintReportAllEngEquips"
    var param = "";
            ...
            <tr style="height: 25px;">
             ...
             <tr style="height: 25px;">               
                ...
                <td style="text-align: left; vertical-align: top; width: 280px;">
                   ...
                   <asp:TextBox runat="server" ID="txtEngEquipBaseModelName" CssClass="InputField" Width="295px"></asp:TextBox>
                </td>
             </tr>
             <tr style="height: 25px;">               
                 <td style="vertical-align: top; text-align: right; width: 150px;">
             ...
             <tr>
                <td colspan="4" style="padding-top: 10px;">
                   ...
                   <asp:LinkButton ID="btnClear" runat="server" CssClass="Button" OnClick="btnClear_Click" ToolTip="Изчистване на избрания филтър"><i></i><div style="width:70px; padding-left:5px;">Изчисти</div><b></b></asp:LinkButton>
                    ...
                    <asp:LinkButton ID="btnPrintReportAllEngEquips" runat="server" CssClass="Button" OnClientClick="ShowPrintReportAllEngEquips(); return false;"><i></i><div style="width:70px; padding-left:5px;">Печат</div><b></b></asp:LinkButton>
