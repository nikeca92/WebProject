<%@ Page Title="Модели трактори" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageTractorModels.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ManageTractorModels" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <style type="text/css">

    .TractorModelLightBox
    {
	    width: 350px;
    ...
    <script type="text/javascript" src='<% Response.Write(ResolveUrl("~")); %>Scripts/ManageTractorModels.js'></script>


<script type="text/javascript">

    var ddlTractorMakesClientID = "<%= ddlTractorMakes.ClientID %>";
...
<div style="text-align: center;">
   <span id="lblHeaderTitle" runat="server" class="HeaderText">Модели трактори</span>
</div>
          ...
          <table width="100%" style="border-collapse:collapse; vertical-align: middle; color: #0B449D;">
             ...
             <tr style="height: 25px;">
                <td style="vertical-align: top; text-align: right; width: 35%;">
                    <asp:Label runat="server" ID="lblTractorMake" CssClass="InputLabel">Марка трактор:</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top; width: 50%;">
                    <asp:DropDownList runat="server" ID="ddlTractorMakes" CssClass="InputField" Width="200px"
                        OnSelectedIndexChanged="ddlTractorMakes_Change" AutoPostBack="true"></asp:DropDownList>
                </td>
                <td style="text-align: center; vertical-align: top; width: 15%;">
                    <asp:ImageButton ID="imgBtnNewModel" runat="server" ImageUrl="../Images/add_new.png" 
                        AlternateText="Добавяне на нов модел трактор" ToolTip="Добавяне на нов модел трактор" 
                        OnClientClick="ShowTractorModelLightBox(0); return false;" />
                </td>
             </tr> 
             <tr>
...
<input type="hidden" id="CanLeave" value="true" />
    ...
    <div id="TractorModelLightBox" class="TractorModelLightBox" style="display: none; text-align: center;">
        <input type='hidden' id='hdnTractorModelId' name='hdnTractorModelId' />
        <table style='text-align:center;'>
            <tr style='height: 15px'><td colspan="2"></td></tr>
            <tr>
                <td colspan='2' align='center'>
                    <span id='lblTractorModelBoxTitle' class='SmallHeaderText'></span>
                </td>
            </tr>
            <tr style='height: 17px'><td colspan="2"></td></tr>
            <tr style='min-height: 17px;'>
                <td align='right' style='width: 130px;'>
                    <span id='lblTractorMakeLightBox' class='InputLabel'>Марка:</span>
                </td>
                <td align='left' style='min-width: 220px;'>
                    <span id='lblTractorMakeValue' class='ReadOnlyValue'></span>
                </td>
            </tr>      
            <tr style='min-height: 17px;'>
                <td align='right' style='width: 130px;'>
                    <span id='lblTractorModelName' class='InputLabel'>Модел трактор:</span>
                </td>
                <td align='left' style='min-width: 220px;'>
                    <input type='text' id='txtTractorModelName' class='RequiredInputField' style='width: 200px;' maxlength='300' />
                </td>
            </tr>             
            <tr style='height: 30px'>
                <td colspan='2'> 
                    <span id='lblTractorModelLightBoxMessage' class='ErrorText' style='display: none;'></span>
               </td>
            </tr>
            <tr>
                    ...
                    <table style='margin: 0 auto;'>
                       <tr>
                          <td style='text-align: center;'>
                             <div id='btnSaveTractorModel' style='display: inline;' onclick='SaveTractorModel();' class='Button'><i></i><div id='btnSaveTractorModelText' style='width:70px;'>Запис</div><b></b></div>
                             <div id='btnCloseTractorModelBox' style='display: inline;' onclick='HideTractorModelLightBox();' class='Button'><i></i><div id='btnCloseVehickleModelBoxText' style='width:70px;'>Затвори</div><b></b></div>
                          </td>
                       </tr>
                    </table>                    
                </td>
