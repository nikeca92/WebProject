...
{
    public partial class ManageTechnics_TRACTORS : RESPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            TractorManageFilter filter = CollectFilterData();

            int allRows = TractorUtil.GetAllTractorManageBlocksCount(filter, CurrentUser);
            ...
            if (!IsPostBack)
            {
                ...
                this.btnPrintAllTractors.Visible = false;
        ...
        private void RefreshDataGrid()
        {
            ...
            List<TractorManageBlock> tractorManageBlocks = TractorUtil.GetAllTractorManageBlocks(filter, pageLength, CurrentUser);
            ...
            {
                this.btnPrintAllTractors.Visible = true;
                ...
                foreach (TractorManageBlock tractorManageBlock in tractorManageBlocks)
                {
                    ...
                    if (GetUIItemAccessLevel("RES_TECHNICS_TRACTORS_EDIT") != UIAccessLevel.Hidden)
                        editHTML = "<img src='../Images/edit.png' alt='Редактиране' title='Редактиране' class='GridActionIcon' onclick='EditTechnics(" + tractorManageBlock.TechnicsId.ToString() + ");' />";

                    html += @"<tr class='" + (counter % 2 == 0 ? "DataTableEvenRow" : "DataTableOddRow") + @"'>
                                 <td style='" + cellStyle + @"'>" + ((pageIdx - 1) * pageLength + counter).ToString() + @"</td>
                                 <td style='" + cellStyle + @"' title='" + tractorManageBlock.NormativeTechnicsName + @"'>" + tractorManageBlock.NormativeTechnicsCode + @"</td>
                                 <td style='" + cellStyle + @"'>" + tractorManageBlock.RegNumber + @"</td>
                                 <td style='" + cellStyle + @"'>" + tractorManageBlock.InventoryNumber + @"</td>
                                 <td style='" + cellStyle + @"'>" + tractorManageBlock.TechnicsCategory + @"</td>
                                 <td style='" + cellStyle + @"'>" + tractorManageBlock.TractorKind + @"</td>
                                 <td style='" + cellStyle + @"'>" + tractorManageBlock.TractorMakeName + @"</td>
                                 <td style='" + cellStyle + @"'>" + tractorManageBlock.TractorModelName + @"</td>
                                 <td style='" + cellStyle + @"'>" + tractorManageBlock.MilitaryDepartment + @"</td>
                                 <td style='" + cellStyle + @"'>" + tractorManageBlock.MilitaryReportStatus + @"</td>
                                 <td style='" + cellStyle + @"'>" + tractorManageBlock.Ownership + @"</td>
                                 <td style='" + cellStyle + @"'>" + tractorManageBlock.Address + @"</td>
        ...
        {          
            if (GetUIItemAccessLevel("RES_TECHNICS") == UIAccessLevel.Enabled &&
                GetUIItemAccessLevel("RES_TECHNICS_TRACTORS") == UIAccessLevel.Enabled &&
                GetUIItemAccessLevel("RES_TECHNICS_TRACTORS_ADD") == UIAccessLevel.Enabled)
            {
                EnableButton(btnNew);
            }
            else
            {
                if (this.GetUIItemAccessLevel("RES_TECHNICS_TRACTORS_ADD") == UIAccessLevel.Hidden)
                {
                    HideControl(btnNew);
                }
                else
        ...
        private TractorManageFilter CollectFilterData()
        {
