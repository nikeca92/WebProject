<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportTechnics_VESSELS.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ReportTechnics_VESSELS" 
...
function ShowPrintReportAllVessels() {
    ...
    var url = "";
    var pageName = "PrintReportAllVessels"
    var param = "";
             ...
             <tr>
                <td colspan="4" style="padding-top: 10px;">
                   ...
                   <asp:LinkButton ID="btnClear" runat="server" CssClass="Button" OnClick="btnClear_Click" ToolTip="Изчистване на избрания филтър"><i></i><div style="width:70px; padding-left:5px;">Изчисти</div><b></b></asp:LinkButton>
                    ...
                    <asp:LinkButton ID="btnPrintReportAllVessels" runat="server" CssClass="Button" OnClientClick="ShowPrintReportAllVessels(); return false;"><i></i><div style="width:70px; padding-left:5px;">Печат</div><b></b></asp:LinkButton>
