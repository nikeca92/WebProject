...
namespace PMIS.Reserve.Common
{
    ...
    public class ReportRailwayEquipManageFilter
    {
    ...
    public class ReportRailwayEquipManageBlock
    {
    ...
    public static class ReportRailwayEquipUtil
    {
        public static List<ReportRailwayEquipManageBlock> GetAllReportRailwayEquipManageBlocks(ReportRailwayEquipManageFilter filter, int rowsPerPage, User currentUser)
        {
            List<ReportRailwayEquipManageBlock> reportRailwayEquipManageBlocks = new List<ReportRailwayEquipManageBlock>();
            ...
            try
            {
                ...
                UIItem uiItem = UIItemUtil.GetUIItems("RES_REPORTS_RAILWAY_EQUIP", currentUser, false, currentUser.Role.RoleId, null)[0];
                ...
                while (dr.Read())
                {
                    ReportRailwayEquipManageBlock reportRailwayEquipManageBlock = new ReportRailwayEquipManageBlock();

                    reportRailwayEquipManageBlock.TechnicsId = DBCommon.GetInt(dr["TechnicsID"]);
                    reportRailwayEquipManageBlock.RailwayEquipId = DBCommon.GetInt(dr["RailwayEquipID"]);
                    reportRailwayEquipManageBlock.InventoryNumber = dr["InventoryNumber"].ToString();
                    reportRailwayEquipManageBlock.TechnicsCategory = dr["TechnicsCategoryName"].ToString();
                    reportRailwayEquipManageBlock.RailwayEquipKind = dr["RailwayEquipKind"].ToString();
                    reportRailwayEquipManageBlock.RailwayEquipType = dr["RailwayEquipType"].ToString();
                    reportRailwayEquipManageBlock.ItemsCount = dr["ItemsCount"].ToString();
                    reportRailwayEquipManageBlock.MilitaryReportStatus = dr["TechMilitaryReportStatusName"].ToString();
                    reportRailwayEquipManageBlock.MilitaryDepartment = dr["MilitaryDepartmentName"].ToString();
                    reportRailwayEquipManageBlock.Address = dr["Address"].ToString();

                    if (!(dr["CompanyName"] is DBNull))
                    {
                        reportRailwayEquipManageBlock.Ownership = dr["UnifiedIdentityCode"].ToString() + " " + dr["CompanyName"].ToString();
                    }
                    else
                    {
                        reportRailwayEquipManageBlock.Ownership = "";
                    }

                    reportRailwayEquipManageBlock.NormativeTechnicsCode = dr["NormativeCode"].ToString();
                    reportRailwayEquipManageBlock.NormativeTechnicsName = dr["NormativeName"].ToString();

                    reportRailwayEquipManageBlocks.Add(reportRailwayEquipManageBlock);
                }
            ...
            return reportRailwayEquipManageBlocks;
        }

        public static int GetAllReportRailwayEquipManageBlocksCount(ReportRailwayEquipManageFilter filter, User currentUser)
        {
            int reportRailwayEquipManageBlocksCnt = 0;
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    if (DBCommon.IsInt(dr["Cnt"]))
                        reportRailwayEquipManageBlocksCnt = DBCommon.GetInt(dr["Cnt"]);
                }
            ...
            return reportRailwayEquipManageBlocksCnt;
        }
    }
}