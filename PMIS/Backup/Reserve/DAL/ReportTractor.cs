...
namespace PMIS.Reserve.Common
{
    ...
    public class ReportTractorManageFilter
    {
        string regNumber;
    ...
    public class ReportTractorManageBlock
    {
    ...
    public static class ReportTractorUtil
    {
        public static List<ReportTractorManageBlock> GetAllReportTractorManageBlocks(ReportTractorManageFilter filter, int rowsPerPage, User currentUser)
        {
            List<ReportTractorManageBlock> reportTractorManageBlocks = new List<ReportTractorManageBlock>();
            ...
            try
            {
                ...
                UIItem uiItem = UIItemUtil.GetUIItems("RES_REPORTS_TRACTORS", currentUser, false, currentUser.Role.RoleId, null)[0];
                ...
                while (dr.Read())
                {
                    ReportTractorManageBlock reportTractorManageBlock = new ReportTractorManageBlock();

                    reportTractorManageBlock.TechnicsId = DBCommon.GetInt(dr["TechnicsID"]);
                    reportTractorManageBlock.TractorId = DBCommon.GetInt(dr["TractorID"]);
                    reportTractorManageBlock.RegNumber = dr["RegNumber"].ToString();
                    reportTractorManageBlock.InventoryNumber = dr["InventoryNumber"].ToString();
                    reportTractorManageBlock.TechnicsCategory = dr["TechnicsCategoryName"].ToString();
                    reportTractorManageBlock.TractorKind = dr["TractorKind"].ToString();
                    reportTractorManageBlock.TractorMake = dr["TractorMakeName"].ToString();
                    reportTractorManageBlock.TractorModel = dr["TractorModelName"].ToString();
                    reportTractorManageBlock.MilitaryReportStatus = dr["TechMilitaryReportStatusName"].ToString();
                    reportTractorManageBlock.MilitaryDepartment = dr["MilitaryDepartmentName"].ToString();
                    reportTractorManageBlock.Address = dr["Address"].ToString();

                    if (!(dr["CompanyName"] is DBNull))
                    {
                        reportTractorManageBlock.Ownership = dr["UnifiedIdentityCode"].ToString() + " " + dr["CompanyName"].ToString();
                    }
                    else
                    {
                        reportTractorManageBlock.Ownership = "";
                    }

                    reportTractorManageBlock.NormativeTechnicsCode = dr["NormativeCode"].ToString();
                    reportTractorManageBlock.NormativeTechnicsName = dr["NormativeName"].ToString();

                    reportTractorManageBlocks.Add(reportTractorManageBlock);
                }
            ...
            return reportTractorManageBlocks;
        }

        public static int GetAllReportTractorManageBlocksCount(ReportTractorManageFilter filter, User currentUser)
        {
            int reportTractorManageBlocksCnt = 0;
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    if (DBCommon.IsInt(dr["Cnt"]))
                        reportTractorManageBlocksCnt = DBCommon.GetInt(dr["Cnt"]);
                }
            ...
            return reportTractorManageBlocksCnt;
        }
    }
}