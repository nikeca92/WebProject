...
namespace PMIS.Reserve.Common
{
    ...
    public class ReportFuelContainerManageFilter
    {
    ...
    public class ReportFuelContainerManageBlock
    {
    ...
    public static class ReportFuelContainerUtil
    {
        public static List<ReportFuelContainerManageBlock> GetAllReportFuelContainerManageBlocks(ReportFuelContainerManageFilter filter, int rowsPerPage, User currentUser)
        {
            List<ReportFuelContainerManageBlock> reportFuelContainerManageBlocks = new List<ReportFuelContainerManageBlock>();
            ...
            try
            {
                ...
                UIItem uiItem = UIItemUtil.GetUIItems("RES_REPORTS_FUEL_CONTAINERS", currentUser, false, currentUser.Role.RoleId, null)[0];
                ...
                while (dr.Read())
                {
                    ReportFuelContainerManageBlock reportFuelContainerManageBlock = new ReportFuelContainerManageBlock();

                    reportFuelContainerManageBlock.TechnicsId = DBCommon.GetInt(dr["TechnicsID"]);
                    reportFuelContainerManageBlock.FuelContainerId = DBCommon.GetInt(dr["FuelContainerID"]);
                    reportFuelContainerManageBlock.InventoryNumber = dr["InventoryNumber"].ToString();
                    reportFuelContainerManageBlock.TechnicsCategory = dr["TechnicsCategoryName"].ToString();
                    reportFuelContainerManageBlock.FuelContainerKind = dr["FuelContainerKind"].ToString();
                    reportFuelContainerManageBlock.FuelContainerType = dr["FuelContainerType"].ToString();
                    reportFuelContainerManageBlock.ItemsCount = dr["ItemsCount"].ToString();
                    reportFuelContainerManageBlock.MilitaryReportStatus = dr["TechMilitaryReportStatusName"].ToString();
                    reportFuelContainerManageBlock.MilitaryDepartment = dr["MilitaryDepartmentName"].ToString();
                    reportFuelContainerManageBlock.Address = dr["Address"].ToString();


                    if (!(dr["CompanyName"] is DBNull))
                    {
                        reportFuelContainerManageBlock.Ownership = dr["UnifiedIdentityCode"].ToString() + " " + dr["CompanyName"].ToString();
                    }
                    else
                    {
                        reportFuelContainerManageBlock.Ownership = "";
                    }

                    reportFuelContainerManageBlock.NormativeTechnicsCode = dr["NormativeCode"].ToString();
                    reportFuelContainerManageBlock.NormativeTechnicsName = dr["NormativeName"].ToString();

                    reportFuelContainerManageBlocks.Add(reportFuelContainerManageBlock);
                }
            ...
            return reportFuelContainerManageBlocks;
        }

        public static int GetAllReportFuelContainerManageBlocksCount(ReportFuelContainerManageFilter filter, User currentUser)
        {
            int reportFuelContainerManageBlocksCnt = 0;
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    if (DBCommon.IsInt(dr["Cnt"]))
                        reportFuelContainerManageBlocksCnt = DBCommon.GetInt(dr["Cnt"]);
                }
            ...
            return reportFuelContainerManageBlocksCnt;
        }
    }
}