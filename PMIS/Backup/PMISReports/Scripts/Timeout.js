...
{
      var curdate = currentDate.getTime();
      var cookieExpiration = Date.parse(readCookie('pmisREPTimeout'));
      if(!cookieExpiration)
      {
         createCookie('pmisREPTimeout',dateExpiration);
      }
      else
      {
...
{
      var one_second = 1000;
      var cookieValue = readCookie('pmisREPTimeout');
      if(!cookieValue)
      {
         if(document.getElementById("spanSessionTime"))
         {
