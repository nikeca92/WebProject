<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageMilRepSpecialities.aspx.cs" Inherits="PMIS.PMISAdmin.ContentPages.ManageMilRepSpecialities" 
         Title="Управление на ВОС" %>
...
function EditMilRepSpeciality(milReportSpecialityId)
{
    JSRedirect("AddEditMilRepSpeciality.aspx?MilReportSpecialityId=" + milReportSpecialityId);
}
...
function DeleteMilRepSpeciality(milReportSpecialityId)
{
    YesNoDialog("Желаете ли да изтриете тази ВОС?", ConfirmYes, null);

    function ConfirmYes()
    {
        var url = "ManageMilRepSpecialities.aspx?AjaxMethod=JSDeleteMilRepSpeciality";
            var params = "";
            params += "MilReportSpecialityId=" + milReportSpecialityId;
...
<div style="text-align: center;">
   <span id="lblHeaderTitle" runat="server" class="HeaderText">Управление на ВОС</span>
</div>
          ...
          <table width="100%" style="border-collapse:collapse; vertical-align: middle; color: #0B449D;">
             ...
             <tr>
                <td style="vertical-align: top; text-align: right; width: 70px;">
                   <asp:Label runat="server" ID="lblMilRepSpecialityTypes" CssClass="InputLabel">Тип ВОС:</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top;" colspan="2">
                   ...
                   <asp:Label runat="server" ID="lblMilRepSpecialityCode" CssClass="InputLabel">Код:</asp:Label>
                   <asp:TextBox runat="server" ID="txtMilRepSpecialityCode" CssClass="InputField" Width="80px"></asp:TextBox>&nbsp;&nbsp;
                   
                   <asp:Label runat="server" ID="lblMilRepSpecialityName" CssClass="InputLabel">Име:</asp:Label>
                   <asp:TextBox runat="server" ID="txtMilRepSpecialityName" CssClass="InputField" Width="160px"></asp:TextBox>&nbsp;&nbsp;
                   
                   <asp:Label runat="server" ID="lblActive" CssClass="InputLabel">Активни:</asp:Label>
                   <asp:DropDownList runat="server" ID="ddActive" CssClass="InputField" Width="95px"></asp:DropDownList>
...
<div style="text-align: center;">
    <div style="width: 720px; margin: 0 auto; text-align: left; vertical-align: top; height: 35px;">
       <asp:LinkButton ID="btnNew" runat="server" CssClass="Button" OnClick="btnNew_Click"><i></i><div style="width:70px; padding-left:5px;">Нова ВОС</div><b></b></asp:LinkButton>
