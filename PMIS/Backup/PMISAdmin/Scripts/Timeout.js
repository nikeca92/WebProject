...
{
      var curdate = currentDate.getTime();
      var cookieExpiration = Date.parse(readCookie('pmisADMTimeout'));
      if(!cookieExpiration)
      {
         createCookie('pmisADMTimeout',dateExpiration);
      }
      else
      {
...
{
      var one_second = 1000;
      var cookieValue = readCookie('pmisADMTimeout');
      if(!cookieValue)
      {
         if(document.getElementById("spanSessionTime"))
         {
