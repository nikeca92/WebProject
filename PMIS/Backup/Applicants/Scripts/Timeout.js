...
{
      var curdate = currentDate.getTime();
      var cookieExpiration = Date.parse(readCookie('pmisAPPLTimeout'));
      if(!cookieExpiration)
      {
         createCookie('pmisAPPLTimeout',dateExpiration);
      }
      else
      {
...
{
      var one_second = 1000;
      var cookieValue = readCookie('pmisAPPLTimeout');
      if(!cookieValue)
      {
         if(document.getElementById("spanSessionTime"))
         {
