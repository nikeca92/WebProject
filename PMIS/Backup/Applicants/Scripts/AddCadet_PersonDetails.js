...
{
    var url = "AddCadet_PersonDetails.aspx?AjaxMethod=JSLoadPersonDetails";
    var params = "";
...
function SaveData() 
{
    if (ValidateData())
    {
        var url = "AddCadet_PersonDetails.aspx?AjaxMethod=JSSavePersonDetails";
        var params = "";
...
function ShowAddEditMedCertLightBox(medCertID) {
    ...
    else //Edit record
    {
        ...
        var url = "AddCadet_PersonDetails.aspx?AjaxMethod=JSLoadMedCert";
...
function SaveAddEditMedCertLightBox() {
    if (ValidateAddEditMedCertLightBox()) {
        var url = "AddCadet_PersonDetails.aspx?AjaxMethod=JSSaveMedCert";
...
function DeleteMedCert(medCertID) {
    ...
    function ConfirmYes() {
        var url = "AddCadet_PersonDetails.aspx?AjaxMethod=JSDeleteMedCert";
...
function ShowAddEditPsychCertLightBox(psychCertID) {
    ...
    else //Edit record
    {
        ...
        var url = "AddCadet_PersonDetails.aspx?AjaxMethod=JSLoadPsychCert";
...
function SaveAddEditPsychCertLightBox() {
    if (ValidateAddEditPsychCertLightBox()) {
        var url = "AddCadet_PersonDetails.aspx?AjaxMethod=JSSavePsychCert";
...
function DeletePsychCert(psychCertID) {
    ...
    function ConfirmYes() {
        var url = "AddCadet_PersonDetails.aspx?AjaxMethod=JSDeletePsychCert";
