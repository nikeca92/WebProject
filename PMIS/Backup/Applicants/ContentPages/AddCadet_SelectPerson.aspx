<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddCadet_SelectPerson.aspx.cs" Inherits="PMIS.Applicants.ContentPages.AddCadet_SelectPerson" Title="Регистриране на курсант" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ValidateData(identityNumber)
        {
            ...
            if (SelectedItem(document.getElementById("<%=ddlMilitaryDepartments.ClientID %>")) == -1)
            {
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;">
                            <asp:DropDownList runat="server" ID="ddlMilitaryDepartments" CssClass="RequiredInputField" Width="250px" >
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
