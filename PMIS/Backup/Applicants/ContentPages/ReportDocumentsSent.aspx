<%@ Page Language="C#" Title="Сведение за изпратените документи за военна служба"
    MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportDocumentsSent.aspx.cs" 
    Inherits="PMIS.Applicants.ContentPages.ReportDocumentsSent" %>
     ...
     function ExcelExport()
        {
            ...
            var url = "";
            var pageName = "PrintReportDocumentsSent"
            var param = "";
        ...
        <ContentTemplate>
            ...
            <center>
                ...
                <div style="text-align: center;">
                    <span id="lblHeaderTitle" runat="server" class="HeaderText">Сведение за изпратените документи за военна служба</span>
                </div>
                <div style="height: 20px;">
                </div>
                <div style="text-align: center;">
