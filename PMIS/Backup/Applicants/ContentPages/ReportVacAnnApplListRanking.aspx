<%@ Page Title="Списък кандидати класирани в конкурс" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="ReportVacAnnApplListRanking.aspx.cs" Inherits="PMIS.Applicants.ContentPages.ReportVacAnnApplListRanking" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ddlChange(ddlObject)
        {
            ...
            if (selectedVacancyAnnounceId != "-1")
            {
                ...
                var url = "ReportVacAnnApplListRanking.aspx?AjaxMethod=JSGetListMilitaryUnitsForVacAnn";
                var params = "";
        ...
        function ValidateFilterData()
        {
            if (selectedVacancyAnnounceId == "-1")
            {
                ...
                if (document.getElementById("<%=btnPrintReportVacAnnApplListRanking.ClientID %>") != undefined)
                {
                    document.getElementById("<%=btnPrintReportVacAnnApplListRanking.ClientID %>").style.visibility = "hidden";
                }
        ...
        function ShowPrintReportVacAnnApplListRanking()
        {
            ...
            var url = "";
            var pageName = "PrintReportVacAnnApplListRanking"
            var param = "";
        ...
        <ContentTemplate>
            <center>
                ...
                <div style="text-align: center;">
                    <span id="lblHeaderTitle" runat="server" class="HeaderText">Списък на кандидатите класирани
                        в конкурс</span>
                </div>
                <div style="height: 20px;">
                </div>
                                ...
                                <tr>
                                    <td colspan="4" style="width: 100%;">
                                        <center>
                                            ...
                                            <asp:LinkButton ID="btnPrintReportVacAnnApplListRanking" runat="server" CssClass="Button"
                                                OnClientClick="ShowPrintReportVacAnnApplListRanking(); return false;" Visible="false"><i></i><div style="width:70px; padding-left:5px;">Печат</div><b></b></asp:LinkButton>
                                        </center>
                                    </td>
                                </tr>
                            </table>
                ...
                <div runat="server" id="divPagingItems" style="width: 760px; margin: 0 auto; height: 35px;
                    padding-left: 20px">
