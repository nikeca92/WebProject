<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="NoAccessToPerson.aspx.cs" Inherits="PMIS.Applicants.ContentPages.NoAccessToPerson" %>
                          ...
                          <tr>
                             <td style="text-align: left;">
                                <table style="margin: 0 auto;">
                                    <tr>
                                        <td style="text-align: left;">
                                            <span id="lblCurrPostCode" class="InputLabel">Нямате достъп до лицето <b><%= PersonDisplayInfo %></b>. Моля обърнете се към системния администратор.</span>
                                        </td>
                                    </tr>
                                    <tr>
