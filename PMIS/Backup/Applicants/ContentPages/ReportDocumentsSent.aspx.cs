...
{
    public partial class ReportDocumentsSent : APPLPage
    {
        ...
        public override string PageUIKey
        {
            get
            {
                return "APPL_REPORTS_REPORT_DOCUMENTS_SENT";
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (GetUIItemAccessLevel("APPL_REPORTS_REPORT_DOCUMENTS_SENT") == UIAccessLevel.Hidden)
            {
                RedirectAccessDenied();
            }

            //Hilight the current page in the menu bar
            HighlightMenuItems("Reports", "ReportDocumentsSent");
        ...
        private void RefreshReports()
        {
            ...
            ReportDocumentsSentFilter filter = CollectFilterData();
            ...
            else
            {
                ...
                html = @"<table class='CommonHeaderTable' style='margin: 0 auto; text-align: left;'>
                     <thead>
                        <tr>
                           ...
                           <th style='width: 300px;" + headerStyle + @"' colspan='7'>документи на кандидати изпратени до военните формирования</th>
                        </tr>
                        <tr>
                           <th style='width: 120px;" + headerStyle + @"' colspan='2'>кандидати</th>
                        ...
                        <tr>
                           <th style='width: 180px;" + headerStyle + @"'></th>
                ...
                foreach (ReportDocumentsSentBlock block in listBlocks)
                {
                    ...
                    html += @"<tr class='" + (counter % 2 == 0 ? "DataTableEvenRow" : "DataTableOddRow") + @"'>
                                 ...
                                 <td style='" + cellStyleNumber + cellStyleTotal + @"'>" + block.CntBy_Male.ToString() + @"</td>
                                 <td style='" + cellStyleNumber + cellStyleTotal + @"'>" + block.CntBy_Female.ToString() + @"</td>
                                 <td style='" + cellStyleNumber + cellStyleTotal + @"'>" + block.CntBy_NoMilitaryTraining_Male.ToString() + @"</td>
                                 <td style='" + cellStyleNumber + cellStyleTotal + @"'>" + block.CntBy_NoMilitaryTraining_Female.ToString() + @"</td>
                                 <td style='" + cellStyleNumber + cellStyleTotal + @"'>" + block.CntBy_Age_Under25.ToString() + @"</td>
                                 <td style='" + cellStyleNumber + cellStyleTotal + @"'>" + block.CntBy_Age_Under30.ToString() + @"</td>
                                 <td style='" + cellStyleNumber + cellStyleTotal + @"'>" + block.CntBy_Age_Over30.ToString() + @"</td>
                              </tr>";
        ...
        private ReportDocumentsSentFilter CollectFilterData()
        {
