<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageUnsafeWorkingConditionsNotices.aspx.cs" Inherits="HealthSafety.ContentPages.ManageUnsafeWorkingConditionsNotices" Title="Сведения за заболявания и наранявания свързани с работата" %>
...
function EditUnsafeWConditionsNotice(noticeId)
{
    JSRedirect("AddEditUnsafeWorkingConditionsNotice.aspx?UnsafeWConditionsNoticeId=" + noticeId);
}

function DeleteUnsafeWConditionsNotice(noticeId)
{
    YesNoDialog("Желаете ли да изтриете сведението?", ConfirmYes, null);

    function ConfirmYes()
    {
        var url = "ManageUnsafeWorkingConditionsNotices.aspx?AjaxMethod=JSDeleteUnsafeWConditionsNotice";
            var params = "";
            params += "UnsafeWConditionsNoticeID=" + noticeId;
...
function ShowPrintAllUnsafeWCondNotices()
{
    var hfМilitaryUnitId = document.getElementById("<%= hfМilitaryUnitId.ClientID %>").value;
    var hfNoticeNumber = document.getElementById("<%= hfNoticeNumber.ClientID %>").value;
    ...
    var url = "";
    var pageName = "PrintAllUnsafeWorkingConditionsNotices"
    var param = "";
    
    url = "../PrintContentPages/" + pageName + ".aspx?MilitaryUnitID=" + hfМilitaryUnitId 
                + "&NoticeNumber=" + hfNoticeNumber + "&DateFrom=" + hfDateFrom
...
<div style="text-align: center;">
   <span id="lblHeaderTitle" runat="server" class="HeaderText">Сведения за заболявания и наранявания свързани с работата</span>
</div>
       ...
       <div class="FilterLegend">Филтър</div>
          <table width="100%" style="border-collapse:collapse; vertical-align: middle; color: #0B449D;">
             ...
             <tr>
                ...
                <td style="vertical-align: top; text-align: right; width: 80px;">
                   <asp:Label runat="server" ID="lblNoticeNumber" CssClass="InputLabel">Сведение №:</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top;">
                   <asp:TextBox ID="txtNoticeNumber" runat="server" CssClass="InputField"></asp:TextBox>
                </td>
             </tr>
             <tr style="height: 10px;">
                <td></td>
             ...
             <tr>
                <td colspan="4" style="width: 100%;" >
                    <center>
                        ...
                        <asp:LinkButton ID="btnPrintAllUnsafeWCondNotices" runat="server" CssClass="Button" OnClientClick="ShowPrintAllUnsafeWCondNotices(); return false;"><i></i><div style="width:70px; padding-left:5px;">Печат</div><b></b></asp:LinkButton>
                    </center>
                </td>
             </tr>
          </table>
...
<div style="text-align: center;">
    <div style="width: 580px; margin: 0 auto; text-align: left; vertical-align: top; height: 35px;">
       <asp:LinkButton ID="btnNew" runat="server" CssClass="Button" OnClick="btnNew_Click"><i></i><div style="width:90px; padding-left:5px;">Ново сведение</div><b></b></asp:LinkButton>
...
<div style="text-align: center;">
    <div style="width: 600px; margin: 0 auto;">
       <div runat="server" id="pnlUnsafeWConditionsGrid" style="text-align: center;"></div>
    </div>
</div>
...
<asp:HiddenField ID="hfNoticeNumber" runat="server" />
