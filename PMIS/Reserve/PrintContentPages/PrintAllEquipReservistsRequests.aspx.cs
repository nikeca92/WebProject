...
{
    public partial class PrintAllEquipReservistsRequests : RESPage
    {
        ...
        private string GenerateAllRecordsHtml()
        {
            ...
            List<EquipmentReservistsRequest> equipmentReservistsRequests = EquipmentReservistsRequestUtil.GetAllEquipmentReservistsRequest(filter, 0, CurrentUser);
            ...
            if (!String.IsNullOrEmpty(equipWithResRequestsStatusId))
            {
                equipWithResRequestsStatus = EquipWithResRequestsStatusUtil.GetEquipWithResRequestsStatus(int.Parse(equipWithResRequestsStatusId), CurrentUser);
            }
            ...
            foreach (EquipmentReservistsRequest equipmentReservistsRequest in equipmentReservistsRequests)
            {
                html += @"<tr>
                            ...
                            <td align='left'>" + equipmentReservistsRequest.RequestNumber + @"</td>
                            <td align='left'>" + CommonFunctions.FormatDate(equipmentReservistsRequest.RequestDate) + @"</td>
                            <td align='left'>" + (equipmentReservistsRequest.MilitaryUnit == null ? "" : equipmentReservistsRequest.MilitaryUnit.DisplayTextForSelection) + @"</td>
                            <td align='left'>" + (equipmentReservistsRequest.Administration == null ? "" : equipmentReservistsRequest.Administration.AdministrationName) + @"</td>
                            <td align='left'>" + (equipmentReservistsRequest.EquipWithResRequestsStatus == null ? "" : equipmentReservistsRequest.EquipWithResRequestsStatus.StatusName) + @"</td>
                          </tr>";
                counter++;
            }
        ...
        protected void btnGenerateExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.Clear();
            Response.AppendHeader("content-disposition", "attachment; filename=EquipReservistsRequests.xls");
            ...
            string html = @"<html xmlns='http://www.w3.org/1999/xhtml' xml:lang='en'>
                            ...
                            <body>
                                <table>
                                    ...
                                    <tr><td align='center' colspan='6' style='font-weight: bold; font-size: 1.3em;'>Списък на въведени заявки за окомплектоване с ресурс от резерва</td></tr>
                                    <tr><td colspan='6'>&nbsp;</td></tr>
                                    <tr>
                ...
                foreach (EquipmentReservistsRequest equipmentReservistsRequest in equipmentReservistsRequests)
                {
                    html += @"
                            <tr>
                                ...
                                <td align='left' style='border: 1px solid black;'>" + equipmentReservistsRequest.RequestNumber + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + CommonFunctions.FormatDate(equipmentReservistsRequest.RequestDate) + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + (equipmentReservistsRequest.MilitaryUnit == null ? "" : equipmentReservistsRequest.MilitaryUnit.DisplayTextForSelection) + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + (equipmentReservistsRequest.Administration == null ? "" : equipmentReservistsRequest.Administration.AdministrationName) + @"</td>
                                <td align='left' style='border: 1px solid black;'>" + (equipmentReservistsRequest.EquipWithResRequestsStatus == null ? "" : equipmentReservistsRequest.EquipWithResRequestsStatus.StatusName) + @"</td>
                              </tr>";
                    counter++;
                }
