...
{
    public partial class PrintReportAllMobileLiftingEquips : RESPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
                ...
                this.GetUIItemAccessLevel("RES_REPORTS_MOB_LIFT_EQUIP") != UIAccessLevel.Hidden)
            {
                ...
                this.Title = "Списък на техниката на военен отчет - " + (technicsType != null ? technicsType.TypeName : "");
                ...
                {
                    mobileLiftingEquipKindId = Request.Params["MobileLiftingEquipKindId"];
                }

                if (!String.IsNullOrEmpty(Request.Params["MobileLiftingEquipTypeId"]))
                {
                    mobileLiftingEquipTypeId = Request.Params["MobileLiftingEquipTypeId"];
                }
        ...
        private string GenerateAllRecordsHtml()
        {
            ...
            List<ReportMobileLiftingEquipManageBlock> reportMobileLiftingEquipManageBlocks = ReportMobileLiftingEquipUtil.GetAllReportMobileLiftingEquipManageBlocks(filter, 0, CurrentUser);
            ...
            GTableItem mobileLiftingEquipKind = null;
            int mobileKindId = 0;
            if (int.TryParse(mobileLiftingEquipKindId, out mobileKindId))
            {
                mobileLiftingEquipKind = GTableItemUtil.GetTableItem("MobileLiftingEquipKind", mobileKindId, ModuleUtil.RES(), CurrentUser);
            }

            GTableItem mobileLiftingEquipType = null;
            int mobileTypeId = 0;
            if (int.TryParse(mobileLiftingEquipTypeId, out mobileTypeId))
            {
                mobileLiftingEquipType = GTableItemUtil.GetTableItem("MobileLiftingEquipType", mobileTypeId, ModuleUtil.RES(), CurrentUser);
            }
            ...
            html.Append(@"<table style='padding: 5px; width: 1024px;'>
                             ...
                             <tr>
                                ...
                                <td align='left' style='width: 205px;'>
                                    <span class='ValueLabel'>" + (mobileLiftingEquipKind != null ? mobileLiftingEquipKind.TableValue : All) + @"</span>
                                </td>
                             </tr>
                             <tr>
                                <td align='right' style='width: 165px;'>
                                ...
                                <td colspan='3' align='left'>
                                    <span class='ValueLabel'>" + (mobileLiftingEquipType != null ? mobileLiftingEquipType.TableValue : All) + @"</span>
                                </td>
                             </tr>
                             <tr>
                                <td align='right' style='width: 165px;'>
            ...
            if (reportMobileLiftingEquipManageBlocks.Count() > 0)
            {
                html.Append(@"
            ...
            (!isTechnicsCategoryHidden ? "<th style='width: 160px;'>Категория</th>" : "") +
            (!isEquipKindHidden ? "<th style='width: 160px;'>Вид</th>" : "") +
            (!isEquipTypeHidden ? "<th style='width: 160px;'>Тип</th>" : "") +
            ...
            foreach (ReportMobileLiftingEquipManageBlock reportMobileLiftingEquipManageBlock in reportMobileLiftingEquipManageBlocks)
            {
                html.Append(@"
                          <tr>
                            <td align='center'>" + counter + @"</td>" +
            (!isNormativeTechnicsHidden ? "<td align='left'>" + reportMobileLiftingEquipManageBlock.NormativeTechnicsCode + @"</td>" : "") +
            (!isRegNumberHidden ? "<td align='left'>" + reportMobileLiftingEquipManageBlock.RegNumber + @"</td>" : "") +
            (!isInventoryNumberHidden ? "<td align='left'>" + reportMobileLiftingEquipManageBlock.InventoryNumber + @"</td>" : "") +
            (!isTechnicsCategoryHidden ? "<td align='left'>" + reportMobileLiftingEquipManageBlock.TechnicsCategory + @"</td>" : "") +
            (!isEquipKindHidden ? "<td align='left'>" + reportMobileLiftingEquipManageBlock.MobileLiftingEquipKind + @"</td>" : "") +
            (!isEquipTypeHidden ? "<td align='left'>" + reportMobileLiftingEquipManageBlock.MobileLiftingEquipType + @"</td>" : "") +
            (!isMilDepartmentHidden ? "<td align='left'>" + reportMobileLiftingEquipManageBlock.MilitaryDepartment + @"</td>" : "") +
            (!isMilRepStatusHidden ? "<td align='left'>" + reportMobileLiftingEquipManageBlock.MilitaryReportStatus + @"</td>" : "") +
            (!isOwnershipHidden ? "<td align='left'>" + reportMobileLiftingEquipManageBlock.Ownership + @"</td>" : "") +
            (!isAddressHidden ? "<td align='left'>" + reportMobileLiftingEquipManageBlock.Address + @"</td>" : "") + @"
        ...
        protected void btnGenerateExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.Clear();
            Response.AppendHeader("content-disposition", "attachment; filename=ReportAllMobileLiftingEquips.xls");
        ...
        private string GenerateAllRecordsForExport()
        {
            ...
            if (!isTechnicsCategoryHidden)
                visibleColumnsCount++;
            if (!isEquipKindHidden)
                visibleColumnsCount++;
            if (!isEquipTypeHidden)
                visibleColumnsCount++;
                            ...
                            <body>
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td align='left' colspan='2'>
                                            <span style='font-weight: bold;'>" + (mobileLiftingEquipKind != null ? mobileLiftingEquipKind.TableValue : All) + @"</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align='right' colspan='" + headerLeftColspan + @"'>
                                        ...
                                        <td align='left' colspan='2'> 
                                            <span style='font-weight: bold;'>" + (mobileLiftingEquipType != null ? mobileLiftingEquipType.TableValue : All) + @"</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align='right' colspan='" + headerLeftColspan + @"'>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                (!isEquipKindHidden ? "<th style='width: 150px; border-bottom: 1px solid white; border-left: 1px solid white; background-color: black; color: #FFFFFF;'>Вид</th>" : "") +
                                (!isEquipTypeHidden ? "<th style='width: 150px; border-bottom: 1px solid white; border-left: 1px solid white; background-color: black; color: #FFFFFF;'>Тип</th>" : "") +
                ...
                foreach (ReportMobileLiftingEquipManageBlock reportMobileLiftingEquipManageBlock in reportMobileLiftingEquipManageBlocks)
                {
                    html.Append(@"
                            <tr>
                                ...
                                (!isNormativeTechnicsHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportMobileLiftingEquipManageBlock.NormativeTechnicsCode + "</td>") : "") + 
                                (!isRegNumberHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportMobileLiftingEquipManageBlock.RegNumber + @"</td>") : "") + 
                                (!isInventoryNumberHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportMobileLiftingEquipManageBlock.InventoryNumber + @"</td>") : "") + 
                                (!isTechnicsCategoryHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportMobileLiftingEquipManageBlock.TechnicsCategory + @"</td>") : "") + 
                                (!isEquipKindHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportMobileLiftingEquipManageBlock.MobileLiftingEquipKind + @"</td>") : "") + 
                                (!isEquipTypeHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportMobileLiftingEquipManageBlock.MobileLiftingEquipType + @"</td>") : "") +
                                (!isMilDepartmentHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportMobileLiftingEquipManageBlock.MilitaryDepartment + "</td>") : "") +
                                (!isMilRepStatusHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportMobileLiftingEquipManageBlock.MilitaryReportStatus + "</td>") : "") +
                                (!isOwnershipHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportMobileLiftingEquipManageBlock.Ownership + "</td>") : "") +
                                (!isAddressHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportMobileLiftingEquipManageBlock.Address + "</td>") : "") + @"
                              </tr>");
                    counter++;
                }
