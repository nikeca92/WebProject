<%@ Page Title="Списък на техниката водена на военен отчет" Language="C#" MasterPageFile="~/MasterPages/PrintMasterPage.Master" AutoEventWireup="true" CodeBehind="PrintAllRailwayEquips.aspx.cs" Inherits="PMIS.Reserve.PrintContentPages.PrintAllRailwayEquips" %>
