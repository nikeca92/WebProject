...
{
    public partial class PrintReportAllEngEquips : RESPage
    {
        ...
        private string GenerateAllRecordsHtml()
        {
            ...
            List<ReportEngEquipManageBlock> reportEngEquipManageBlocks = ReportEngEquipUtil.GetAllReportEngEquipManageBlocks(filter, 0, CurrentUser);
            ...
            (!isEngEquipKindHidden ? "<th style='width: 120px;'>Вид</th>" : "") +
            (!isEngEquipBaseMakeHidden ? "<th style='width: 120px;'>Марка</th>" : "") +
            (!isEngEquipBaseModelHidden ? "<th style='width: 120px;'>Модел</th>" : "") +
            ...
            (!isNormativeTechnicsHidden ? "<td align='left'>" + reportEngEquipManageBlock.NormativeTechnicsCode + @"</td>" : "") +
            (!isRegNumberHidden ? "<td align='left'>" + reportEngEquipManageBlock.RegNumber + @"</td>" : "") +
            (!isInventoryNumberHidden ? "<td align='left'>" + reportEngEquipManageBlock.InventoryNumber + @"</td>" : "") +
            (!isTechnicsCategoryHidden ? "<td align='left'>" + reportEngEquipManageBlock.TechnicsCategory + @"</td>" : "") +
            (!isEngEquipKindHidden ? "<td align='left'>" + reportEngEquipManageBlock.EngEquipKind + @"</td>" : "") +
            (!isEngEquipBaseMakeHidden ? "<td align='left'>" + reportEngEquipManageBlock.EngEquipBaseMake + @"</td>" : "") +
            (!isEngEquipBaseModelHidden ? "<td align='left'>" + reportEngEquipManageBlock.EngEquipBaseModel + @"</td>" : "") +
            (!isMilDepartmentHidden ? "<td align='left'>" + reportEngEquipManageBlock.MilitaryDepartment + @"</td>" : "") +
            (!isMilRepStatusHidden ? "<td align='left'>" + reportEngEquipManageBlock.MilitaryReportStatus + @"</td>" : "") +
            (!isOwnershipHidden ? "<td align='left'>" + reportEngEquipManageBlock.Ownership + @"</td>" : "") +
            (!isAddressHidden ? "<td align='left'>" + reportEngEquipManageBlock.Address + @"</td>" : "") + @"
                          </tr>");
                counter++;
            }
        ...
        protected void btnGenerateExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.Clear();
            Response.AppendHeader("content-disposition", "attachment; filename=ReportAllEngEquips.xls");
        ...
        private string GenerateAllRecordsForExport()
        {
            ...
            if (!isTechnicsCategoryHidden)
                visibleColumnsCount++;
            if (!isEngEquipKindHidden)
                visibleColumnsCount++;
            if (!isEngEquipBaseMakeHidden)
                visibleColumnsCount++;
            if (!isEngEquipBaseModelHidden)
                visibleColumnsCount++;
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                (!isEngEquipKindHidden ? "<th style='width: 150px; border-bottom: 1px solid white; border-left: 1px solid white; background-color: black; color: #FFFFFF;'>Вид</th>" : "") +
                                (!isEngEquipBaseMakeHidden ? "<th style='width: 150px; border-bottom: 1px solid white; border-left: 1px solid white; background-color: black; color: #FFFFFF;'>Марка</th>" : "") +
                                (!isEngEquipBaseModelHidden ? "<th style='width: 150px; border-bottom: 1px solid white; border-left: 1px solid white; background-color: black; color: #FFFFFF;'>Модел</th>" : "") +
                ...
                foreach (ReportEngEquipManageBlock reportEngEquipManageBlock in reportEngEquipManageBlocks)
                {
                    html.Append(@"
                            <tr>
                                ...
                                (!isNormativeTechnicsHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportEngEquipManageBlock.NormativeTechnicsCode + "</td>") : "") + 
                                (!isRegNumberHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportEngEquipManageBlock.RegNumber + @"</td>") : "") + 
                                (!isInventoryNumberHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportEngEquipManageBlock.InventoryNumber + @"</td>") : "") + 
                                (!isTechnicsCategoryHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportEngEquipManageBlock.TechnicsCategory + @"</td>") : "") + 
                                (!isEngEquipKindHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportEngEquipManageBlock.EngEquipKind + @"</td>") : "") + 
                                (!isEngEquipBaseMakeHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportEngEquipManageBlock.EngEquipBaseMake + @"</td>") : "") + 
                                (!isEngEquipBaseModelHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportEngEquipManageBlock.EngEquipBaseModel + @"</td>") : "") +
                                (!isMilDepartmentHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportEngEquipManageBlock.MilitaryDepartment + "</td>") : "") +
                                (!isMilRepStatusHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportEngEquipManageBlock.MilitaryReportStatus + "</td>") : "") +
                                (!isOwnershipHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportEngEquipManageBlock.Ownership + "</td>") : "") +
                                (!isAddressHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportEngEquipManageBlock.Address + "</td>") : "") + @"
                              </tr>");
                    counter++;
                }
