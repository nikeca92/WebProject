...
{
    public partial class PrintReportAllVessels : RESPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
                ...
                this.GetUIItemAccessLevel("RES_REPORTS_VESSELS") != UIAccessLevel.Hidden)
            {
                ...
                if (!String.IsNullOrEmpty(Request.Params["VesselName"]))
                {
                    vesselName = Request.Params["VesselName"];
                }
                ...
                {
                    vesselKindId = Request.Params["VesselKindId"];
                }

                if (!String.IsNullOrEmpty(Request.Params["VesselTypeId"]))
                {
                    vesselTypeId = Request.Params["VesselTypeId"];
                }
        ...
        private string GenerateAllRecordsHtml()
        {
            ...
            List<ReportVesselManageBlock> reportVesselManageBlocks = ReportVesselUtil.GetAllReportVesselManageBlocks(filter, 0, CurrentUser);
            ...
            GTableItem vesselKind = null;
            int railKindId = 0;
            if (int.TryParse(vesselKindId, out railKindId))
            {
                vesselKind = GTableItemUtil.GetTableItem("VesselKind", railKindId, ModuleUtil.RES(), CurrentUser);
            }

            GTableItem vesselType = null;
            int railTypeId = 0;
            if (int.TryParse(vesselTypeId, out railTypeId))
            {
                vesselType = GTableItemUtil.GetTableItem("VesselType", railTypeId, ModuleUtil.RES(), CurrentUser);
            }
            ...
            html.Append(@"<table style='padding: 5px; width: 1024px;'>
                             <tr>
                                ...
                                <td align='left' style='width: 205px;'>
                                   <span class='ValueLabel'>" + vesselName + @"</span>&nbsp;&nbsp;
                                </td>
                             ...
                             <tr>
                                ...
                                <td align='left' style='width: 195px;'>
                                    <span class='ValueLabel'>" + (vesselKind != null ? vesselKind.TableValue : All) + @"</span>
                                </td>
                             </tr>
                             <tr>
                                <td align='right' style='width: 130px;'>
                                ...
                                <td colspan='3' align='left' style='width: 185px;'>
                                    <span class='ValueLabel'>" + (vesselType != null ? vesselType.TableValue : All) + @"</span>
                                </td>
                             </tr>
                             <tr>
                                <td align='right' style='width: 165px;'>
            ...
            (!isVesselNameHidden ? "<th style='width: 120px;'>Име</th>" : "") +
            ...
            (!isVesselKindHidden ? "<th style='width: 140px;'>Вид</th>" : "") +
            (!isVesselTypeHidden ? "<th style='width: 140px;'>Тип</th>" : "") +
            ...
            foreach (ReportVesselManageBlock reportVesselManageBlock in reportVesselManageBlocks)
            {
                html.Append(@"
                          <tr>
                            <td align='center'>" + counter + @"</td>" +
            (!isNormativeTechnicsHidden ? "<td align='left'>" + reportVesselManageBlock.NormativeTechnicsCode + @"</td>" : "") +
            (!isVesselNameHidden ? "<td align='left'>" + reportVesselManageBlock.VesselName + @"</td>" : "") +
            (!isInventoryNumberHidden ? "<td align='left'>" + reportVesselManageBlock.InventoryNumber + @"</td>" : "") +
            (!isTechnicsCategoryHidden ? "<td align='left'>" + reportVesselManageBlock.TechnicsCategory + @"</td>" : "") +
            (!isVesselKindHidden ? "<td align='left'>" + reportVesselManageBlock.VesselKind + @"</td>" : "") +
            (!isVesselTypeHidden ? "<td align='left'>" + reportVesselManageBlock.VesselType + @"</td>" : "") +
            (!isMilDepartmentHidden ? "<td align='left'>" + reportVesselManageBlock.MilitaryDepartment + @"</td>" : "") +
            (!isMilRepStatusHidden ? "<td align='left'>" + reportVesselManageBlock.MilitaryReportStatus + @"</td>" : "") +
            (!isOwnershipHidden ? "<td align='left'>" + reportVesselManageBlock.Ownership + @"</td>" : "") +
            (!isAddressHidden ? "<td align='left'>" + reportVesselManageBlock.Address + @"</td>" : "") + @"
                          </tr>");
                counter++;
            }
        ...
        protected void btnGenerateExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.Clear();
            Response.AppendHeader("content-disposition", "attachment; filename=ReportAllVessels.xls");
        ...
        private string GenerateAllRecordsForExport()
        {
            ...
            if (!isNormativeTechnicsHidden)
                visibleColumnsCount++;
            if (!isVesselNameHidden)
                visibleColumnsCount++;
            if (!isInventoryNumberHidden)
                visibleColumnsCount++;
            if (!isTechnicsCategoryHidden)
                visibleColumnsCount++;
            if (!isVesselKindHidden)
                visibleColumnsCount++;
            if (!isVesselTypeHidden)
                visibleColumnsCount++;
            ...
            html.Append(@"<html xmlns='http://www.w3.org/1999/xhtml' xml:lang='en'>
                            ...
                            <body>
                                <table>
                                    ...
                                    <tr><td align='center' colspan='" + visibleColumnsCount + @"' style='font-weight: bold; font-size: 1.3em;'>Списък на техниката водена на военен отчет - " + (technicsType != null ? technicsType.TypeName : "") + @"</td></tr>
                                    <tr><td colspan='" + visibleColumnsCount + @"'>&nbsp;</td></tr>
                                    <tr>
                                        <td align='right' colspan='" + headerLeftColspan + @"'>
                                            <span style='font-weight: normal;'>Име:&nbsp;</span>
                                        </td>
                                        <td align='left' colspan='2'> 
                                            <span style='font-weight: bold;'>" + vesselName + @"</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td align='left' colspan='2'>
                                            <span style='font-weight: bold;'>" + (vesselKind != null ? vesselKind.TableValue : All) + @"</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align='right' colspan='" + headerLeftColspan + @"'>
                                        ...
                                        <td align='left' colspan='2'> 
                                            <span style='font-weight: bold;'>" + (vesselType != null ? vesselType.TableValue : All) + @"</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align='right' colspan='" + headerLeftColspan + @"'>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                (!isVesselNameHidden ? "<th style='width: 150px; border-bottom: 1px solid white; border-left: 1px solid white; background-color: black; color: #FFFFFF;'>Име</th>" : "") +
                                ...
                                (!isVesselKindHidden ? "<th style='width: 150px; border-bottom: 1px solid white; border-left: 1px solid white; background-color: black; color: #FFFFFF;'>Вид</th>" : "") +
                                (!isVesselTypeHidden ? "<th style='width: 150px; border-bottom: 1px solid white; border-left: 1px solid white; background-color: black; color: #FFFFFF;'>Тип</th>" : "") +
                ...
                foreach (ReportVesselManageBlock reportVesselManageBlock in reportVesselManageBlocks)
                {
                    html.Append(@"
                            <tr>
                                ...
                                (!isNormativeTechnicsHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportVesselManageBlock.NormativeTechnicsCode + "</td>") : "") + 
                                (!isVesselNameHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportVesselManageBlock.VesselName + @"</td>") : "") + 
                                (!isInventoryNumberHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportVesselManageBlock.InventoryNumber + @"</td>") : "") + 
                                (!isTechnicsCategoryHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportVesselManageBlock.TechnicsCategory + @"</td>") : "") + 
                                (!isVesselKindHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportVesselManageBlock.VesselKind + @"</td>") : "") + 
                                (!isVesselTypeHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportVesselManageBlock.VesselType + @"</td>") : "") +
                                (!isMilDepartmentHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportVesselManageBlock.MilitaryDepartment + "</td>") : "") +
                                (!isMilRepStatusHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportVesselManageBlock.MilitaryReportStatus + "</td>") : "") +
                                (!isOwnershipHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportVesselManageBlock.Ownership + "</td>") : "") +
                                (!isAddressHidden ? ("<td align='left' style='border: 1px solid black;'>" + reportVesselManageBlock.Address + "</td>") : "") + @"
                              </tr>");
                    counter++;
                }
