<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageEquipmentReservistsRequestsFulfilment.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ManageEquipmentReservistsRequestsFulfilment" 
         Title="Изпълнение на заявки за окомплектоване с ресурс от резерва" %>
...
function FulfilEquipmentReservists(equipmentReservistsRequestId, militaryDepartmentId)
{
    JSRedirect("FulfilEquipmentReservistsRequest.aspx?EquipmentReservistsRequestId=" + equipmentReservistsRequestId + "&MilitaryDepartmentId=" + militaryDepartmentId);
}
...
<div style="text-align: center;">
   <span id="lblHeaderTitle" runat="server" class="HeaderText">Изпълнение на заявки за окомплектоване с ресурс от резерва</span>
</div>
