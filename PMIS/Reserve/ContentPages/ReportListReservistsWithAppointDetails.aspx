<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportListReservistsWithAppointDetails.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ReportListReservistsWithAppointDetails" 
         Title="Списък на хората с МН по определена заявка" %>
...
<div style="text-align: center;">
   <span id="lblHeaderTitle" runat="server" class="HeaderText">Списък на хората с МН по определена заявка</span>
</div>
          ...
          <table width="100%" style="border-collapse:collapse; vertical-align: middle; color: #0B449D; border-spacing: 2px;">
             ...
             <tr>
                ...
                <td style="text-align: left; width: 25%;">
                    <asp:Label ID="lblEquipWithResRequestsStatusValue" runat="server" CssClass="ReadOnlyValue"></asp:Label>
                </td>                                    
            </tr>
            <tr>
...
<div style="text-align: center;">
   ...
   <asp:LinkButton ID="btnPrint" runat="server" CssClass="Button" OnClientClick="ShowPrintReportListReservistsWithAppointDetails(); return false;"><i></i><div style="width:70px; padding-left:5px;">Печат</div><b></b></asp:LinkButton>
...
<asp:HiddenField ID="hfEquipmentReservistsRequestID" runat="server" />
 ...
 <script type="text/javascript">
     function ShowPrintReportListReservistsWithAppointDetails()
     {
         var EquipmentReservistsRequestID = document.getElementById("<%= hfEquipmentReservistsRequestID.ClientID %>").value;
         
         var url = "";
         var pageName = "PrintReportListReservistsWithAppointDetails"
         var param = "";

         url = "../PrintContentPages/" + pageName + ".aspx?EquipmentReservistsRequestID=" + EquipmentReservistsRequestID;
     ...
     function ExportReport() {
         ...
         url = "../PrintContentPages/" + pageName + ".aspx?EquipmentReservistsRequestID=" + EquipmentReservistsRequestID + "&Export=true";
