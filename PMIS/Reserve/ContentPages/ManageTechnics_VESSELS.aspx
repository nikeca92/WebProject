<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageTechnics_VESSELS.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ManageTechnics_VESSELS" 
...
function ShowPrintAllVessels() {
    var hdnTechnicsTypeKey = document.getElementById("<%= hdnTechnicsTypeKey.ClientID %>").value;
    var hdnVesselName = document.getElementById("<%= hdnVesselName.ClientID %>").value;
    ...
    var hdnVesselKindId = document.getElementById("<%= hdnVesselKindId.ClientID %>").value;
    var hdnVesselTypeId = document.getElementById("<%= hdnVesselTypeId.ClientID %>").value;
          ...
          <table width="100%" style="border-collapse:collapse; vertical-align: middle; color: #0B449D;">
            ...
            <tr style="height: 25px;">
                <td style="vertical-align: top; text-align: right; width: 150px;">
                   <asp:Label runat="server" ID="lblVesselName" CssClass="InputLabel">Име:</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top; width: 260px;">
                   <asp:TextBox runat="server" ID="txtVesselName" CssClass="InputField" Width="255px"></asp:TextBox>
                </td>
             ...
             <tr style="height: 25px;">      
                ...
                <td style="text-align: left; vertical-align: top; width: 260px;">
                 ...
                 <td style="vertical-align: top; text-align: right; width: 120px;">
                   <asp:Label runat="server" ID="lblVesselKind" CssClass="InputLabel">Вид:</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top; width: 300px;">
                   <asp:DropDownList runat="server" ID="ddVesselKind" CssClass="InputField" Width="300px"></asp:DropDownList>
                </td>                 
             </tr>
             <tr style="height: 25px;">               
                 <td style="vertical-align: top; text-align: right; width: 150px;">
                   <asp:Label runat="server" ID="lblVesselType" CssClass="InputLabel">Тип:</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top; width: 260px;">
                   <asp:DropDownList runat="server" ID="ddVesselType" CssClass="InputField" Width="260px"></asp:DropDownList>
                </td>               
             </tr>
             <tr style="height: 25px;">               
                 <td style="vertical-align: top; text-align: right; width: 150px;">
             ...
             <tr>
                <td colspan="4" style="padding-top: 10px;">
                   ...
                   <asp:LinkButton ID="btnClear" runat="server" CssClass="Button" OnClick="btnClear_Click" ToolTip="Изчистване на избрания филтър"><i></i><div style="width:70px; padding-left:5px;">Изчисти</div><b></b></asp:LinkButton>
                    ...
                    <asp:LinkButton ID="btnPrintAllVessels" runat="server" CssClass="Button" OnClientClick="ShowPrintAllVessels(); return false;"><i></i><div style="width:70px; padding-left:5px;">Печат</div><b></b></asp:LinkButton>
...
<asp:HiddenField ID="hdnVesselKindId" runat="server" />
<asp:HiddenField ID="hdnVesselTypeId" runat="server" />
<asp:HiddenField ID="hdnVesselModelId" runat="server" />
