<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportPostponeTech.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ReportPostponeTech" 
         Title="Протокол за безусловно и условно отсрочване на техника" EnableEventValidation="false" %>
...
function SetPickListsSelection()
{
    ...
    document.getElementById("<%= hdnCompanySelectedText.ClientID %>").value = PickListUtil.GetSelectedText("pickListCompanies");
}
...
function IsFilterDataValid() {
    ...
    if (document.getElementById("<%= hdnCompanySelected.ClientID %>").value == "") {
        isValid = false;
        errorMsg = "Изберете поне една фирма";
    }
...
<div style="text-align: center; padding-top: 20px;">
   <span id="lblHeaderTitle" runat="server" class="HeaderText">Протокол за безусловно и условно отсрочване на техника</span>
</div>
                ...
                <td>
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="text-align: left; vertical-align: middle;">
                               <asp:DropDownList runat="server" ID="ddAdministrations" CssClass="InputField" Width="200px"
                    ...
                    <table>
                        <tr>
                            <td style="vertical-align: middle; text-align: right; width: 120px;">
                               ...
                               <asp:HiddenField runat="server" ID="hdnCompanySelectedText" />
                            </td>
                            <td style="text-align: left; vertical-align: top;">
