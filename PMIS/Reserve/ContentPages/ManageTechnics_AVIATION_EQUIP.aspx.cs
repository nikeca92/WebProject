...
{
    public partial class ManageTechnics_AVIATION_EQUIP : RESPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            AviationEquipManageFilter filter = CollectFilterData();

            int allRows = AviationEquipUtil.GetAllAviationEquipManageBlocksCount(filter, CurrentUser);
            ...
            if (!IsPostBack)
            {
                ...
                this.btnPrintAllAviationEquips.Visible = false;
        ...
        private void RefreshDataGrid()
        {
            ...
            List<AviationEquipManageBlock> aviationEquipManageBlocks = AviationEquipUtil.GetAllAviationEquipManageBlocks(filter, pageLength, CurrentUser);
            ...
            {
                this.btnPrintAllAviationEquips.Visible = true;
                ...
                html = @"<table class='CommonHeaderTable' style='margin: 0 auto; text-align: left;'>
                         <thead>
                            <tr>
                               ...
                               <th style='width: 150px; cursor: pointer;" + headerStyle + @"' onclick='SortTableBy(5);'>Модел" + arrOrderCol[4] + @"</th>
                ...
                foreach (AviationEquipManageBlock aviationEquipManageBlock in aviationEquipManageBlocks)
                {
                    ...
                    if (GetUIItemAccessLevel("RES_TECHNICS_AVIATION_EQUIP_EDIT") != UIAccessLevel.Hidden)
                        editHTML = "<img src='../Images/edit.png' alt='Редактиране' title='Редактиране' class='GridActionIcon' onclick='EditTechnics(" + aviationEquipManageBlock.TechnicsId.ToString() + ");' />";

                    html += @"<tr class='" + (counter % 2 == 0 ? "DataTableEvenRow" : "DataTableOddRow") + @"'>
                                 <td style='" + cellStyle + @"'>" + ((pageIdx - 1) * pageLength + counter).ToString() + @"</td>
                                 <td style='" + cellStyle + @"' title='" + aviationEquipManageBlock.NormativeTechnicsName + @"'>" + aviationEquipManageBlock.NormativeTechnicsCode + @"</td>
                                 <td style='" + cellStyle + @"'>" + aviationEquipManageBlock.AirInvNumber + @"</td>
                                 <td style='" + cellStyle + @"'>" + aviationEquipManageBlock.TechnicsCategory + @"</td>
                                 <td style='" + cellStyle + @"'>" + aviationEquipManageBlock.AviationAirKind + @"</td>
                                 <td style='" + cellStyle + @"'>" + aviationEquipManageBlock.AviationAirType + @"</td>
                                 <td style='" + cellStyle + @"'>" + aviationEquipManageBlock.AviationAirModelName + @"</td>
                                 <td style='" + cellStyle + @"'>" + aviationEquipManageBlock.MilitaryDepartment + @"</td>
                                 <td style='" + cellStyle + @"'>" + aviationEquipManageBlock.MilitaryReportStatus + @"</td>
                                 <td style='" + cellStyle + @"'>" + aviationEquipManageBlock.Ownership + @"</td>
                                 <td style='" + cellStyle + @"'>" + aviationEquipManageBlock.Address + @"</td>
        ...
        {          
            if (GetUIItemAccessLevel("RES_TECHNICS") == UIAccessLevel.Enabled &&
                GetUIItemAccessLevel("RES_TECHNICS_AVIATION_EQUIP") == UIAccessLevel.Enabled &&
                GetUIItemAccessLevel("RES_TECHNICS_AVIATION_EQUIP_ADD") == UIAccessLevel.Enabled)
            {
                EnableButton(btnNew);
            }
            else
            {
                if (this.GetUIItemAccessLevel("RES_TECHNICS_AVIATION_EQUIP_ADD") == UIAccessLevel.Hidden)
                {
                    HideControl(btnNew);
                }
                else
        ...
        private AviationEquipManageFilter CollectFilterData()
        {
