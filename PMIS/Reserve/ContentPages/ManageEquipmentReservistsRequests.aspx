<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageEquipmentReservistsRequests.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ManageEquipmentReservistsRequests" 
         Title="Въведени заявки за окомплектоване с ресурс от резерва" %>
...
<script type="text/javascript">
    ...
    {
        WriteBenchmarkLog("Клиент 'Въведени заявки за окомплектоване с ресурс от резерва': UpdatePanel (Ajax) заявката е изпълнена");
    }

    //Call this when the page is loaded
    function PageLoad()
    {
        WriteBenchmarkLog("Клиент 'Въведени заявки за окомплектоване с ресурс от резерва': Екранът е зареден");
    }
...
function EditEquipmentReservistsRequest(equipmentReservistsRequestId)
{
    JSRedirect("AddEditEquipmentReservistsRequest.aspx?EquipmentReservistsRequestId=" + equipmentReservistsRequestId);
}

//Set responsible military department by redirecting to the EquipmentReservistRequestMilitaryDepartment screen
function EquipmentReservistsRequestMilDept(equipmentReservistsRequestId)
{
    JSRedirect("EquipmentReservistRequestMilitaryDepartment.aspx?EquipmentReservistsRequestId=" + equipmentReservistsRequestId);
}
...
function DeleteEquipmentReservistsRequest(equipmentReservistsRequestId)
{
    YesNoDialog("Желаете ли да изтриете заявката?", ConfirmYes, null);

    function ConfirmYes()
    {
        var url = "ManageEquipmentReservistsRequests.aspx?AjaxMethod=JSDeleteEquipmentReservistsRequest";
        var params = "";
        params += "EquipmentReservistsRequestId=" + equipmentReservistsRequestId;
...
function ShowPrintAllEquipReservistsRequests() {
    ...
    var url = "";
    var pageName = "PrintAllEquipReservistsRequests"
    var param = "";
...
<div style="text-align: center;">
   <span id="lblHeaderTitle" runat="server" class="HeaderText">Въведени заявки за окомплектоване с ресурс от резерва</span>
</div>
          ...
          <table width="100%" style="border-collapse:collapse; vertical-align: middle; color: #0B449D;">
             ...
             <tr>
                ...
                <td colspan="2" style="padding-top: 10px;">
                    ...
                    <asp:LinkButton ID="btnPrintAllEquipReservistsRequests" runat="server" CssClass="Button" OnClientClick="ShowPrintAllEquipReservistsRequests(); return false;"><i></i><div style="width:70px; padding-left:5px;">Печат</div><b></b></asp:LinkButton>
                </td>
             </tr>
             <tr>
