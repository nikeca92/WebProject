...
{
    public partial class ManageTechnics_VEHICLES : RESPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            VehicleManageFilter filter = CollectFilterData();

            int allRows = VehicleUtil.GetAllVehicleManageBlocksCount(filter, CurrentUser);
            ...
            if (!IsPostBack)
            {
                ...
                this.btnPrintAllVehicles.Visible = false;
        ...
        private void RefreshDataGrid()
        {
            ...
            List<VehicleManageBlock> vehicleManageBlocks = VehicleUtil.GetAllVehicleManageBlocks(filter, pageLength, CurrentUser);
            ...
            {
                this.btnPrintAllVehicles.Visible = true;
                ...
                html = @"<table class='CommonHeaderTable' style='margin: 0 auto; text-align: left;'>
                         <thead>
                            <tr>
                               ...
                               <th style='width: 150px; cursor: pointer;" + headerStyle + @"' onclick='SortTableBy(12);'>Нормативна категория" + arrOrderCol[11] + @"</th> 
                               ...
                               <th style='width: 150px; cursor: pointer;" + headerStyle + @"' onclick='SortTableBy(11);'>Каросерия" + arrOrderCol[10] + @"</th>
                               <th style='width: 150px; cursor: pointer;" + headerStyle + @"' onclick='SortTableBy(5);'>Марка" + arrOrderCol[4] + @"</th>
                               <th style='width: 150px; cursor: pointer;" + headerStyle + @"' onclick='SortTableBy(6);'>Модел" + arrOrderCol[5] + @"</th>
                               <th style='width: 150px; cursor: pointer;" + headerStyle + @"' onclick='SortTableBy(7);'>На отчет в" + arrOrderCol[6] + @"</th>
                               <th style='width: 150px; cursor: pointer;" + headerStyle + @"' onclick='SortTableBy(8);'>Състояние по отчета" + arrOrderCol[7] + @"</th>
                               <th style='width: 150px; cursor: pointer;" + headerStyle + @"' onclick='SortTableBy(9);'>Собственик" + arrOrderCol[8] + @"</th>
                               <th style='width: 150px; cursor: pointer;" + headerStyle + @"' onclick='SortTableBy(10);'>Адрес" + arrOrderCol[9] + @"</th>
                ...
                foreach (VehicleManageBlock vehicleManageBlock in vehicleManageBlocks)
                {
                    ...
                    if (GetUIItemAccessLevel("RES_TECHNICS_VEHICLES_EDIT") != UIAccessLevel.Hidden)
                        editHTML = "<img src='../Images/edit.png' alt='Редактиране' title='Редактиране' class='GridActionIcon' onclick='EditTechnics(" + vehicleManageBlock.TechnicsId.ToString() + ");' />";

                    html += @"<tr class='" + (counter % 2 == 0 ? "DataTableEvenRow" : "DataTableOddRow") + @"'>
                                 <td style='" + cellStyle + @"'>" + ((pageIdx - 1) * pageLength + counter).ToString() + @"</td>
                                 <td style='" + cellStyle + @"' title='" + vehicleManageBlock.NormativeTechnicsName + @"'>" + vehicleManageBlock.NormativeTechnicsCode + @"</td>
                                 <td style='" + cellStyle + @"'>" + vehicleManageBlock.RegNumber + @"</td>
                                 <td style='" + cellStyle + @"'>" + vehicleManageBlock.InventoryNumber + @"</td>
                                 <td style='" + cellStyle + @"'>" + vehicleManageBlock.TechnicsCategory + @"</td>
                                 <td style='" + cellStyle + @"'>" + vehicleManageBlock.VehicleKind + @"</td>
                                 <td style='" + cellStyle + @"'>" + vehicleManageBlock.BodyType + @"</td>
                                 <td style='" + cellStyle + @"'>" + vehicleManageBlock.VehicleMakeName + @"</td>
                                 <td style='" + cellStyle + @"'>" + vehicleManageBlock.VehicleModelName + @"</td>
                                 <td style='" + cellStyle + @"'>" + vehicleManageBlock.MilitaryDepartment + @"</td>
                                 <td style='" + cellStyle + @"'>" + vehicleManageBlock.MilitaryReportStatus + @"</td>
                                 <td style='" + cellStyle + @"'>" + vehicleManageBlock.Ownership + @"</td>
                                 <td style='" + cellStyle + @"'>" + vehicleManageBlock.Address + @"</td>
        ...
        {          
            if (GetUIItemAccessLevel("RES_TECHNICS") == UIAccessLevel.Enabled &&
                GetUIItemAccessLevel("RES_TECHNICS_VEHICLES") == UIAccessLevel.Enabled &&
                GetUIItemAccessLevel("RES_TECHNICS_VEHICLES_ADD") == UIAccessLevel.Enabled)
            {
                EnableButton(btnNew);
            }
            else
            {
                if (this.GetUIItemAccessLevel("RES_TECHNICS_VEHICLES_ADD") == UIAccessLevel.Hidden)
                {
                    HideControl(btnNew);
                }
                else
        ...
        private VehicleManageFilter CollectFilterData()
        {
