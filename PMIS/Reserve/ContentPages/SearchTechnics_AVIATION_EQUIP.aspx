<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="SearchTechnics_AVIATION_EQUIP.aspx.cs" Inherits="PMIS.Reserve.ContentPages.SearchTechnics_AVIATION_EQUIP" 
...
function ChooseAviationEquip(technicsId, aviationEquipId) {
    ...
    function ConfirmYes() {
        var url = "SearchTechnics_AVIATION_EQUIP.aspx?AjaxMethod=JSChooseAviationEquip";
        var params = "";
        params += "TechnicsID=" + technicsId;
        params += "&AviationEquipID=" + aviationEquipId;
