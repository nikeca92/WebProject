<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportPostponeRes.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ReportPostponeRes" 
         Title="Протокол за безусловно и условно отсрочване на запасни" EnableEventValidation="false" %>
...
<div style="text-align: center; padding-top: 20px;">
   <span id="lblHeaderTitle" runat="server" class="HeaderText">Протокол за безусловно и условно отсрочване на запасни</span>
</div>
