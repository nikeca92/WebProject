<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportListTechnicsWithAppointments.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ReportListTechnicsWithAppointments" 
         Title="Списък на техниката с МН по определена заявка - избор на заявка" %>
...
function ShowDetails(equipmentTechnicsRequestId)
{
    JSRedirect("ReportListTechnicsWithAppointDetails.aspx?EquipmentTechnicsRequestId=" + equipmentTechnicsRequestId);
}

function ShowPrintReportListTechnicsWithAppointments() {
    ...
    var url = "";
    var pageName = "PrintReportListTechnicsWithAppointments"
    var param = "";
...
<div style="text-align: center;">
   <span id="lblHeaderTitle" runat="server" class="HeaderText">Списък на техниката с МН по определена заявка - избор на заявка</span>
</div>
             ...
             <tr>
                <td colspan="4" style="padding-top: 10px;">
                   ...
                   <asp:LinkButton ID="btnClear" runat="server" CssClass="Button" OnClick="btnClear_Click" ToolTip="Изчистване на избрания филтър"><i></i><div style="width:70px; padding-left:5px;">Изчисти</div><b></b></asp:LinkButton>
                    ...
                    <asp:LinkButton ID="btnPrintReportListTechnicsWithAppointments" runat="server" CssClass="Button" OnClientClick="ShowPrintReportListTechnicsWithAppointments(); return false;"><i></i><div style="width:70px; padding-left:5px;">Печат</div><b></b></asp:LinkButton>
