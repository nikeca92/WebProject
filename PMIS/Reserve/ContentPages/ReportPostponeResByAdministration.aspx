<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportPostponeResByAdministration.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ReportPostponeResByAdministration" 
         Title="Отчет за изпълнение отсрочването на запасни" EnableEventValidation="false" %>
...
<div style="text-align: center; padding-top: 20px;">
   <span id="lblHeaderTitle" runat="server" class="HeaderText">Отчет за изпълнение отсрочването на запасни</span>
</div>
