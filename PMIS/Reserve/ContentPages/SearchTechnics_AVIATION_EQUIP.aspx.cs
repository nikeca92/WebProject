...
{
    public partial class SearchTechnics_AVIATION_EQUIP : RESPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if ((GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_MILCOMMAND_POSITIONS_FULFIL") != UIAccessLevel.Enabled) ||
                (GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_MILCOMMAND_POSITIONS_FULFIL_SEARCHAVIATIONEQUIP") != UIAccessLevel.Enabled))
            {
                RedirectAccessDenied();
            }

            //Check if this is an ajax call and perform the specific method
            if (Request.Params["AjaxMethod"] != null && Request.Params["AjaxMethod"] == "JSChooseAviationEquip")
            {
                JSChooseAviationEquip();
                return;
            }
            ...
            AviationEquipSearchFilter filter = CollectFilterData();

            int allRows = AviationEquipUtil.GetAllAviationEquipSearchBlocksCount(filter, TechnicsRequestCommandPositionID, MilitaryDepartmentId, CurrentUser);
        ...
        private void PopulateLists()
        {
            ...
            PopulateAviationAirKind();
            PopulateAviationAirType();
            //PopulateAviationAirModel();
            PopulateRegions();
        ...
        //Populate ddAviationAirKind
        private void PopulateAviationAirKind()
        {
            ddAviationAirKind.DataSource = GTableItemUtil.GetAllGTableItemsByTableName("AviationAirKind", ModuleKey, 1, 0, 0, CurrentUser);
            ddAviationAirKind.DataTextField = "TableValue";
            ddAviationAirKind.DataValueField = "TableKey";
            ddAviationAirKind.DataBind();
            ddAviationAirKind.Items.Insert(0, ListItems.GetOptionAll());
        }

        //Populate ddAviationAirType
        private void PopulateAviationAirType()
        {
            ddAviationAirType.DataSource = GTableItemUtil.GetAllGTableItemsByTableName("AviationAirType", ModuleKey, 1, 0, 0, CurrentUser);
            ddAviationAirType.DataTextField = "TableValue";
            ddAviationAirType.DataValueField = "TableKey";
            ddAviationAirType.DataBind();
            ddAviationAirType.Items.Insert(0, ListItems.GetOptionAll());
        }

        //Populate ddAviationAirModel
        //private void PopulateAviationAirModel()
        //{
        //    ddAviationAirModel.DataSource = GTableItemUtil.GetAllGTableItemsByTableName("AviationAirModel", ModuleKey, 1, 0, 0, CurrentUser);
        //    ddAviationAirModel.DataTextField = "TableValue";
        //    ddAviationAirModel.DataValueField = "TableKey";
        //    ddAviationAirModel.DataBind();
        //    ddAviationAirModel.Items.Insert(0, ListItems.GetOptionAll());
        //}
        ...
        private void RefreshDataGrid()
        {
            ...
            bool IsNormativeTechnicsHidden = this.GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_MILCOMMAND_POSITIONS_FULFIL_SEARCHAVIATION_EQUIP_NORMATIVETECHNICS") == UIAccessLevel.Hidden;
            bool IsAirInvNumberHidden = this.GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_MILCOMMAND_POSITIONS_FULFIL_SEARCHAVIATION_EQUIP_AIRINVNUMBER") == UIAccessLevel.Hidden;
            bool IsTechnicsCategoryHidden = this.GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_MILCOMMAND_POSITIONS_FULFIL_SEARCHAVIATION_EQUIP_TECHNICSCATEGORY") == UIAccessLevel.Hidden;
            bool IsAviationAirKindHidden = this.GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_MILCOMMAND_POSITIONS_FULFIL_SEARCHAVIATION_EQUIP_AVIATIONAIRKIND") == UIAccessLevel.Hidden;
            bool IsAviationAirTypeHidden = this.GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_MILCOMMAND_POSITIONS_FULFIL_SEARCHAVIATION_EQUIP_AVIATIONAIRTYPE") == UIAccessLevel.Hidden;
            bool IsOwnershipHidden = this.GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_MILCOMMAND_POSITIONS_FULFIL_SEARCHAVIATION_EQUIP_OWNERSHIP") == UIAccessLevel.Hidden;
            ...
            List<AviationEquipSearchBlock> aviationEquipSearchBlocks = AviationEquipUtil.GetAllAviationEquipSearchBlocks(filter, TechnicsRequestCommandPositionID, MilitaryDepartmentId, pageLength, CurrentUser);

            //No data found
            if (aviationEquipSearchBlocks.Count == 0)
            {
                ...
                html = @"<table class='CommonHeaderTable' style='margin: 0 auto; text-align: left;'>
                         <thead>
                            <tr>
                               ...
                               <th style='width: 20px;" + headerStyle + @"'></th>" +
(!IsNormativeTechnicsHidden ? @"<th style='width: 150px; cursor: pointer;" + headerStyle + @"' onclick='SortTableBy(6);'>Нормативна категория" + arrOrderCol[5] + @"</th>" : "") +
    (!IsAirInvNumberHidden ? @"<th style='width: 150px; cursor: pointer;" + headerStyle + @"' onclick='SortTableBy(1);'>Инвентарен номер" + arrOrderCol[0] + @"</th>" : "") +
(!IsTechnicsCategoryHidden ? @"<th style='width: 150px; cursor: pointer;" + headerStyle + @"' onclick='SortTableBy(2);'>Категория" + arrOrderCol[1] + @"</th>" : "") +
 (!IsAviationAirKindHidden ? @"<th style='width: 150px; cursor: pointer;" + headerStyle + @"' onclick='SortTableBy(3);'>Вид" + arrOrderCol[2] + @"</th>" : "") +
 (!IsAviationAirTypeHidden ? @"<th style='width: 150px; cursor: pointer;" + headerStyle + @"' onclick='SortTableBy(4);'>Тип" + arrOrderCol[3] + @"</th>" : "") +
       (!IsOwnershipHidden ? @"<th style='width: 150px; cursor: pointer;" + headerStyle + @"' onclick='SortTableBy(5);'>Собственик" + arrOrderCol[4] + @"</th>" : "") +
                            @"</tr>
                         </thead>";
                ...
                foreach (AviationEquipSearchBlock aviationEquipSearchBlock in aviationEquipSearchBlocks)
                {
                    ...
                    html += @"<tr class='" + (counter % 2 == 0 ? "DataTableEvenRow" : "DataTableOddRow") + @"' onmouseover=""this.className = 'SelectionItem';"" onmouseout=""this.className = '" + (counter % 2 == 0 ? "DataTableEvenRow" : "DataTableOddRow") + @"';"" title='Избери'>
                                 ...
                                 <td style='" + cellStyle + @"'><img src='../Images/pawn_view.png' alt='Преглед' title='Преглед' class='GridActionIcon' onclick='PreviewTechnics(" + aviationEquipSearchBlock.TechnicsId.ToString() + @");' /></td>" +
 (!IsNormativeTechnicsHidden ? @"<td style='" + cellStyle + @"' onclick=""ChooseAviationEquip(" + aviationEquipSearchBlock.TechnicsId + @", " + aviationEquipSearchBlock.AviationEquipId + @");"" title='" + aviationEquipSearchBlock.NormativeTechnicsName + @"'>" + aviationEquipSearchBlock.NormativeTechnicsCode + @"</td>" : "") +
      (!IsAirInvNumberHidden ? @"<td style='" + cellStyle + @"' onclick=""ChooseAviationEquip(" + aviationEquipSearchBlock.TechnicsId + @", " + aviationEquipSearchBlock.AviationEquipId + @");"">" + aviationEquipSearchBlock.AirInvNumber + @"</td>" : "") +
  (!IsTechnicsCategoryHidden ? @"<td style='" + cellStyle + @"' onclick=""ChooseAviationEquip(" + aviationEquipSearchBlock.TechnicsId + @", " + aviationEquipSearchBlock.AviationEquipId + @");"">" + aviationEquipSearchBlock.TechnicsCategory + @"</td>" : "") +
   (!IsAviationAirKindHidden ? @"<td style='" + cellStyle + @"' onclick=""ChooseAviationEquip(" + aviationEquipSearchBlock.TechnicsId + @", " + aviationEquipSearchBlock.AviationEquipId + @");"">" + aviationEquipSearchBlock.AviationAirKind + @"</td>" : "") +
   (!IsAviationAirTypeHidden ? @"<td style='" + cellStyle + @"' onclick=""ChooseAviationEquip(" + aviationEquipSearchBlock.TechnicsId + @", " + aviationEquipSearchBlock.AviationEquipId + @");"">" + aviationEquipSearchBlock.AviationAirType + @"</td>" : "") +
         (!IsOwnershipHidden ? @"<td style='" + cellStyle + @"' onclick=""ChooseAviationEquip(" + aviationEquipSearchBlock.TechnicsId + @", " + aviationEquipSearchBlock.AviationEquipId + @");"" title='Избери'>" + aviationEquipSearchBlock.Ownership + @"</td>" : "") +
                              @"</tr>";
        ...
        private AviationEquipSearchFilter CollectFilterData()
        {
            AviationEquipSearchFilter filter = new AviationEquipSearchFilter();
            ...
            if (ddAviationAirKind.SelectedValue != ListItems.GetOptionAll().Value)
                aviationAirKind = ddAviationAirKind.SelectedValue;

            string aviationAirType = "";

            if (ddAviationAirType.SelectedValue != ListItems.GetOptionAll().Value)
                aviationAirType = ddAviationAirType.SelectedValue;

            //string aviationAirModel = "";

            //if (ddAviationAirModel.SelectedValue != ListItems.GetOptionAll().Value)
            //    aviationAirModel = ddAviationAirModel.SelectedValue;
            ...
            filter.AirInvNumber = txtAirInvNumber.Text;
            filter.TechnicsCategoryId = technicsCategory;
            filter.AviationAirKindId = aviationAirKind;
            filter.AviationAirTypeId = aviationAirType;

            //filter.AviationAirModelId = aviationAirModel;

            filter.AviationAirModelName = txtAviationAirModelName.Text;
        ...
        private void JSChooseAviationEquip()
        {
            string stat = "";
            string response = "";

            int technicsID = int.Parse(Request.Form["TechnicsID"]);
            int aviationEquipID = int.Parse(Request.Form["AviationEquipID"]);
            ...
            try
            {
                ...
                if (existingFulfillments.Count == 0)
                {
                    ...
                    AviationEquip aviationEquip = AviationEquipUtil.GetAviationEquip(aviationEquipID, CurrentUser);
                    ...
                    logDescription += "Заявка №: " + position.TechnicsRequestsCommand.EquipmentTechnicsRequest.RequestNumber + " / Дата: " + CommonFunctions.FormatDate(position.TechnicsRequestsCommand.EquipmentTechnicsRequest.RequestDate) +
                                      ...
                                      "; Инв. №: " + aviationEquip.AirInvNumber;

                    changeEvent = new ChangeEvent("RES_EquipTechRequests_AddAviationEquip", logDescription, position.TechnicsRequestsCommand.EquipmentTechnicsRequest.MilitaryUnit, null, CurrentUser);
                    ...
                    //Add a new TechnicsAppointment for the chosen aviation equip
        ...
        {
            txtAirInvNumber.Text = "";
            ddTechnicsCategory.SelectedValue = ListItems.GetOptionAll().Value;
            ddAviationAirKind.SelectedValue = ListItems.GetOptionAll().Value;
            ddAviationAirType.SelectedValue = ListItems.GetOptionAll().Value;
            
            //ddAviationAirModel.SelectedValue = ListItems.GetOptionAll().Value;

            txtAviationAirModelName.Text = "";
