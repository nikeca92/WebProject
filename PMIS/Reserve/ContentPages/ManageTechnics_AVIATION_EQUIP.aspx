<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageTechnics_AVIATION_EQUIP.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ManageTechnics_AVIATION_EQUIP" 
...
function ShowPrintAllAviationEquips() {
    ...
    var url = "";
    var pageName = "PrintAllAviationEquips"
    var param = "";
       ...
       <div class="FilterLegend">Филтър</div>
          <table width="100%" style="border-collapse:collapse; vertical-align: middle; color: #0B449D;">
            ...
            <tr style="height: 25px;">
             ...
             <tr>
                <td colspan="2">
                   <asp:LinkButton ID="btnNew" runat="server" CssClass="Button" OnClick="btnNew_Click"><i></i><div style="width:350px; padding-left:5px;">Нов запис в <%= TechnicsTypeName %></div><b></b></asp:LinkButton>
                </td>
                <td colspan="2" style="padding-top: 10px;">
                   ...
                   <asp:LinkButton ID="btnClear" runat="server" CssClass="Button" OnClick="btnClear_Click" ToolTip="Изчистване на избрания филтър"><i></i><div style="width:70px; padding-left:5px;">Изчисти</div><b></b></asp:LinkButton>
                    ...
                    <asp:LinkButton ID="btnPrintAllAviationEquips" runat="server" CssClass="Button" OnClientClick="ShowPrintAllAviationEquips(); return false;"><i></i><div style="width:70px; padding-left:5px;">Печат</div><b></b></asp:LinkButton>
