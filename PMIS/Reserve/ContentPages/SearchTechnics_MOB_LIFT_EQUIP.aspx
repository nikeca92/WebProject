<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="SearchTechnics_MOB_LIFT_EQUIP.aspx.cs" Inherits="PMIS.Reserve.ContentPages.SearchTechnics_MOB_LIFT_EQUIP" 
...
function ChooseMobileLiftingEquip(technicsId, mobileLiftingEquipId) {
    ...
    function ConfirmYes() {
        var url = "SearchTechnics_MOB_LIFT_EQUIP.aspx?AjaxMethod=JSChooseMobileLiftingEquip";
        var params = "";
        params += "TechnicsID=" + technicsId;
        params += "&MobileLiftingEquipID=" + mobileLiftingEquipId;
