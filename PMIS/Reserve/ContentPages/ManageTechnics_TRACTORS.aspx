<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ManageTechnics_TRACTORS.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ManageTechnics_TRACTORS" 
...
function ShowPrintAllTractors() {
    ...
    var hdnTractorKindId = document.getElementById("<%= hdnTractorKindId.ClientID %>").value;
    
    var hdnTractorMakeName = document.getElementById("<%= hdnTractorMakeName.ClientID %>").value;
    var hdnTractorModelName = document.getElementById("<%= hdnTractorModelName.ClientID %>").value;
    ...
    url = "../PrintContentPages/" + pageName + ".aspx?TechnicsTypeKey=" + hdnTechnicsTypeKey
                ...
                + "&TractorKindId=" + hdnTractorKindId
                
                //+ "&TractorMakeId=" + hdnTractorMakeId
                //+ "&TractorModelId=" + hdnTractorModelId

                + "&TractorMakeName=" + hdnTractorMakeName
                + "&TractorModelName=" + hdnTractorModelName
             ...
             <tr>
                ...
                <td colspan="2" style="padding-top: 10px;">
                   ...
                   <asp:LinkButton ID="btnClear" runat="server" CssClass="Button" OnClick="btnClear_Click" ToolTip="Изчистване на избрания филтър"><i></i><div style="width:70px; padding-left:5px;">Изчисти</div><b></b></asp:LinkButton>
                    ...
                    <asp:LinkButton ID="btnPrintAllTractors" runat="server" CssClass="Button" OnClientClick="ShowPrintAllTractors(); return false;"><i></i><div style="width:70px; padding-left:5px;">Печат</div><b></b></asp:LinkButton>
...
<asp:HiddenField ID="hdnTractorKindId" runat="server" />

<%--<asp:HiddenField ID="hdnTractorMakeId" runat="server" />
<asp:HiddenField ID="hdnTractorModelId" runat="server" />--%>

<asp:HiddenField ID="hdnTractorMakeName" runat="server" />
<asp:HiddenField ID="hdnTractorModelName" runat="server" />
