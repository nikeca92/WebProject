...
{
    public partial class SearchTechnics_ENG_EQUIP : RESPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if ((GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_MILCOMMAND_POSITIONS_FULFIL") != UIAccessLevel.Enabled) ||
                (GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_MILCOMMAND_POSITIONS_FULFIL_SEARCHTRACTOR") != UIAccessLevel.Enabled))
            {
                RedirectAccessDenied();
            }

            //Check if this is an ajax call and perform the specific method
            if (Request.Params["AjaxMethod"] != null && Request.Params["AjaxMethod"] == "JSChooseEngEquip")
            {
                JSChooseEngEquip();
                return;
            }
            ...
            EngEquipSearchFilter filter = CollectFilterData();

            int allRows = EngEquipUtil.GetAllEngEquipSearchBlocksCount(filter, TechnicsRequestCommandPositionID, MilitaryDepartmentId, CurrentUser);
        ...
        //    {
        //        int engEquipMakeId = int.Parse(ddEngEquipBaseMake.SelectedValue);

        //        PopulateEngEquipBaseModel(engEquipMakeId);
        //    }
        //}

        //Populate ddEngEquipBaseModel
        //private void PopulateEngEquipBaseModel(int engEquipMakeId)
        //{
        //    ddEngEquipBaseModel.DataSource = EngEquipBaseModelUtil.GetAllEngEquipBaseModels(engEquipMakeId, CurrentUser);
        ...
        private void RefreshDataGrid()
        {
            ...
            bool IsNormativeTechnicsHidden = this.GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_MILCOMMAND_POSITIONS_FULFIL_SEARCHENG_EQUIP_NORMATIVETECHNICS") == UIAccessLevel.Hidden;
            bool IsRegNumberHidden = this.GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_MILCOMMAND_POSITIONS_FULFIL_SEARCHENG_EQUIP_REGNUMBER") == UIAccessLevel.Hidden;
            bool IsInventoryNumberHidden = this.GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_MILCOMMAND_POSITIONS_FULFIL_SEARCHENG_EQUIP_INVENTNUMBER") == UIAccessLevel.Hidden;
            bool IsTechnicsCategoryHidden = this.GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_MILCOMMAND_POSITIONS_FULFIL_SEARCHENG_EQUIP_TECHNICSCATEGORY") == UIAccessLevel.Hidden;
            bool IsEngEquipKindHidden = this.GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_MILCOMMAND_POSITIONS_FULFIL_SEARCHENG_EQUIP_TRACTORKIND") == UIAccessLevel.Hidden;
            bool IsEngEquipBaseMakeHidden = this.GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_MILCOMMAND_POSITIONS_FULFIL_SEARCHENG_EQUIP_TRACTORMAKE") == UIAccessLevel.Hidden;
            bool IsEngEquipBaseModelHidden = this.GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_MILCOMMAND_POSITIONS_FULFIL_SEARCHENG_EQUIP_TRACTORMODEL") == UIAccessLevel.Hidden;
            bool IsOwnershipHidden = this.GetUIItemAccessLevel("RES_EQUIPTECHREQUESTS_FULFIL_MILCOMMAND_POSITIONS_FULFIL_SEARCHENG_EQUIP_OWNERSHIP") == UIAccessLevel.Hidden;
            ...
            List<EngEquipSearchBlock> engEquipSearchBlocks = EngEquipUtil.GetAllEngEquipSearchBlocks(filter, TechnicsRequestCommandPositionID, MilitaryDepartmentId, pageLength, CurrentUser);

            //No data found
            if (engEquipSearchBlocks.Count == 0)
            {
...
(!IsEngEquipBaseMakeHidden ? @"<th style='width: 150px; cursor: pointer;" + headerStyle + @"' onclick='SortTableBy(5);'>Марка" + arrOrderCol[4] + @"</th>" : "") +
(!IsEngEquipBaseModelHidden ? @"<th style='width: 150px; cursor: pointer;" + headerStyle + @"' onclick='SortTableBy(6);'>Модел" + arrOrderCol[5] + @"</th>" : "") +
       (!IsOwnershipHidden ? @"<th style='width: 150px; cursor: pointer;" + headerStyle + @"' onclick='SortTableBy(7);'>Собственик" + arrOrderCol[6] + @"</th>" : "") + 
                ...
                foreach (EngEquipSearchBlock engEquipSearchBlock in engEquipSearchBlocks)
                {
                    ...
                    html += @"<tr class='" + (counter % 2 == 0 ? "DataTableEvenRow" : "DataTableOddRow") + @"' onmouseover=""this.className = 'SelectionItem';"" onmouseout=""this.className = '" + (counter % 2 == 0 ? "DataTableEvenRow" : "DataTableOddRow") + @"';"">
                                 ...
                                 <td style='" + cellStyle + @"'><img src='../Images/pawn_view.png' alt='Преглед' title='Преглед' class='GridActionIcon' onclick='PreviewTechnics(" + engEquipSearchBlock.TechnicsId.ToString() + @");' /></td>" +
 (!IsNormativeTechnicsHidden ? @"<td style='" + cellStyle + @"' onclick=""ChooseEngEquip(" + engEquipSearchBlock.TechnicsId + @", " + engEquipSearchBlock.EngEquipId + @");"" title='" + engEquipSearchBlock.NormativeTechnicsName + @"'>" + engEquipSearchBlock.NormativeTechnicsCode + @"</td>" : "") +
         (!IsRegNumberHidden ? @"<td style='" + cellStyle + @"' onclick=""ChooseEngEquip(" + engEquipSearchBlock.TechnicsId + @", " + engEquipSearchBlock.EngEquipId + @");"" title='Избери'>" + engEquipSearchBlock.RegNumber + @"</td>" : "") +
   (!IsInventoryNumberHidden ? @"<td style='" + cellStyle + @"' onclick=""ChooseEngEquip(" + engEquipSearchBlock.TechnicsId + @", " + engEquipSearchBlock.EngEquipId + @");"" title='Избери'>" + engEquipSearchBlock.InventoryNumber + @"</td>" : "") +
  (!IsTechnicsCategoryHidden ? @"<td style='" + cellStyle + @"' onclick=""ChooseEngEquip(" + engEquipSearchBlock.TechnicsId + @", " + engEquipSearchBlock.EngEquipId + @");"" title='Избери'>" + engEquipSearchBlock.TechnicsCategory + @"</td>" : "") +
      (!IsEngEquipKindHidden ? @"<td style='" + cellStyle + @"' onclick=""ChooseEngEquip(" + engEquipSearchBlock.TechnicsId + @", " + engEquipSearchBlock.EngEquipId + @");"" title='Избери'>" + engEquipSearchBlock.EngEquipKind + @"</td>" : "") +
  (!IsEngEquipBaseMakeHidden ? @"<td style='" + cellStyle + @"' onclick=""ChooseEngEquip(" + engEquipSearchBlock.TechnicsId + @", " + engEquipSearchBlock.EngEquipId + @");"" title='Избери'>" + engEquipSearchBlock.EngEquipBaseMake + @"</td>" : "") +
 (!IsEngEquipBaseModelHidden ? @"<td style='" + cellStyle + @"' onclick=""ChooseEngEquip(" + engEquipSearchBlock.TechnicsId + @", " + engEquipSearchBlock.EngEquipId + @");"" title='Избери'>" + engEquipSearchBlock.EngEquipBaseModel + @"</td>" : "") +
         (!IsOwnershipHidden ? @"<td style='" + cellStyle + @"' onclick=""ChooseEngEquip(" + engEquipSearchBlock.TechnicsId + @", " + engEquipSearchBlock.EngEquipId + @");"" title='Избери'>" + engEquipSearchBlock.Ownership + @"</td>" : "") +
                              @"</tr>";
        ...
        private EngEquipSearchFilter CollectFilterData()
        {
            EngEquipSearchFilter filter = new EngEquipSearchFilter();
            ...
            //filter.EngEquipBaseMakeId = engEquipMake;
            //filter.EngEquipBaseModelId = engEquipModel;
        ...
        private void JSChooseEngEquip()
        {
            string stat = "";
            string response = "";

            int technicsID = int.Parse(Request.Form["TechnicsID"]);
            int engEquipID = int.Parse(Request.Form["EngEquipID"]);
            ...
            try
            {
                ...
                if (existingFulfillments.Count == 0)
                {
                    ...
                    EngEquip engEquip = EngEquipUtil.GetEngEquip(engEquipID, CurrentUser);
                    ...
                    changeEvent = new ChangeEvent("RES_EquipTechRequests_AddEngEquip", logDescription, position.TechnicsRequestsCommand.EquipmentTechnicsRequest.MilitaryUnit, null, CurrentUser);
