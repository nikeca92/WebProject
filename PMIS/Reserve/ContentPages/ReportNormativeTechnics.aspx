<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportNormativeTechnics.aspx.cs" Inherits="PMIS.Reserve.ContentPages.ReportNormativeTechnics" 
         Title="Отчетна ведомост за състоянието на техниката" EnableEventValidation="false" %>
...
function ShowPrintReport()
{
    ...
    var url = "";
    var pageName = "PrintReportNormativeTechnics"
    var param = "";
...
<div style="text-align: center;">
   <span id="lblHeaderTitle" runat="server" class="HeaderText">Отчетна ведомост за състоянието на техниката</span>
</div>
