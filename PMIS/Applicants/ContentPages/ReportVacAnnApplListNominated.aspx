<%@ Page Title="Списък на кандидатите определени за назначаване" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="ReportVacAnnApplListNominated.aspx.cs" Inherits="PMIS.Applicants.ContentPages.ReportVacAnnApplListNominated" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ddlChange(ddlObject)
        {
            ...
            if (selectedVacancyAnnounceId != "-1")
            {
                ...
                var url = "ReportVacAnnApplListNominated.aspx?AjaxMethod=JSGetListMilitaryUnitsForVacAnn";
                var params = "";
        ...
        function ValidateFilterData()
        {
            if (selectedVacancyAnnounceId == "-1")
            {
                ...
                if (document.getElementById("<%=btnPrintReportVacAnnApplListNominated.ClientID %>") != undefined)
                {
                    document.getElementById("<%=btnPrintReportVacAnnApplListNominated.ClientID %>").style.visibility = "hidden";
        ...
        function ShowPrintReportVacAnnApplListNominated()
        {
            ...
            var url = "";
            var pageName = "PrintReportVacAnnApplListNominated"
            var param = "";
        ...
        <ContentTemplate>
            <center>
                ...
                <div style="text-align: center;">
                    <span id="lblHeaderTitle" runat="server" class="HeaderText">Списък на кандидатите определени
                        за назначаване </span>
                </div>
                <div style="height: 20px;">
                </div>
                                ...
                                <tr>
                                    <td colspan="4" style="width: 100%;">
                                        <center>
                                            ...
                                            <asp:LinkButton ID="btnPrintReportVacAnnApplListNominated" runat="server" CssClass="Button"
                                                OnClientClick="ShowPrintReportVacAnnApplListNominated(); return false;" Visible="false"><i></i><div style="width:70px; padding-left:5px;">Печат</div><b></b></asp:LinkButton>
                                        </center>
                                    </td>
                                </tr>
                            </table>
