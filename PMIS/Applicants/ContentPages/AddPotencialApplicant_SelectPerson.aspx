<%@ Page Title="Регистриране на потенциален кандидат за военна служба" 
Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" 
CodeBehind="AddPotencialApplicant_SelectPerson.aspx.cs" 
Inherits="PMIS.Applicants.ContentPages.AddPotencialApplicant_SelectPerson" %>
        ...
        <ContentTemplate>
            ...
            <center>
                <table style="width: 100%;">
                    <tr>
                        <td colspan="2">
                            <span id="lblHeaderTitle" runat="server" class="HeaderText">Регистриране на потенциален кандидат за военна служба</span>
                        </td>
                    </tr>
