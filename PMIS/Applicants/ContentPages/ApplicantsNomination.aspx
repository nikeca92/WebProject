<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ApplicantsNomination.aspx.cs" Inherits="PMIS.Applicants.ContentPages.ApplicantsNomination" 
         Title="Назначаване на кандидати" %>
...
<script type="text/javascript">
    ...
    function SavePositions()
    {
        ...
        if (positionsCounter)
        {
            ...
            var url = "ApplicantsNomination.aspx?AjaxMethod=JSSavePositions";
            ...
            function response_handler(xml)
            {
                ...
                else if (xmlNodeText(xml.childNodes[0]) == "ERROR")
                {
                ...
                {
                    lblMessage.className = "ErrorText";
                    lblMessage.innerHTML = xmlNodeText(xml.childNodes[0]);
                }
            }
...
<div style="text-align: center;">
   <span id="lblHeaderTitle" runat="server" class="HeaderText">Назначаване на кандидати</span>
</div>
       ...
       <div class="FilterLegend">Филтър</div>
          <table width="100%" style="border-collapse:collapse; vertical-align: middle; color: #0B449D;">
             ...
             <tr>
                ...
                <td style="text-align: left; vertical-align: top;">
                   <asp:DropDownList runat="server" ID="ddMilitaryUnit" CssClass="InputField" AutoPostBack="true" OnTextChanged="ddMilitaryUnit_Changed" UnsavedCheckSkipMe="true" style="width: 510px;"></asp:DropDownList>
                </td>
             </tr>
             <tr>
                <td style="vertical-align: top; text-align: right; width: 320px; min-height: 27px;">
                   <asp:Label runat="server" ID="lblClInformationAccLevelNATO" CssClass="InputLabel">Ниво на достъп до КИ (НАТО):</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top;">
                   <asp:Label runat="server" ID="txtClInformationAccLevelNATO" CssClass="InputField" style="width: 510px;"></asp:Label>
                </td>
             </tr>
             <tr>
                <td style="vertical-align: top; text-align: right; width: 320px; min-height: 27px;">
                   <asp:Label runat="server" ID="lblClInformationAccLevelBG" CssClass="InputLabel">Ниво на достъп до КИ (РБ):</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top;">
                   <asp:Label runat="server" ID="txtClInformationAccLevelBG" CssClass="InputField" style="width: 510px;"></asp:Label>
                </td>
             </tr>
             <tr>
                <td style="vertical-align: top; text-align: right; width: 320px; min-height: 27px;">
                   <asp:Label runat="server" ID="lblClInformationAccLevelEU" CssClass="InputLabel">Ниво на достъп до КИ (ЕС):</asp:Label>
                </td>
                <td style="text-align: left; vertical-align: top;">
                   <asp:Label runat="server" ID="txtClInformationAccLevelEU" CssClass="InputField" style="width: 510px;"></asp:Label>
                </td>
             </tr>
             <tr style="height: 10px;">
                <td></td>
