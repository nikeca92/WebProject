<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ApplicantsRanking.aspx.cs" Inherits="PMIS.Applicants.ContentPages.ApplicantsRanking" 
         Title="Класиране на кандидати" %>
...
<script type="text/javascript">
    ...
    function SavePositions()
    {
        ...
        if (positionsCounter)
        {
            ...
            var url = "ApplicantsRanking.aspx?AjaxMethod=JSSavePositions";
...
<div style="text-align: center;">
   <span id="lblHeaderTitle" runat="server" class="HeaderText">Класиране на кандидати</span>
</div>
