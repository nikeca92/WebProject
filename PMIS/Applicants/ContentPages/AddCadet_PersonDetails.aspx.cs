...
{
    public partial class AddCadet_PersonDetails : APPLPage
    {
        string responseGo = "";
        string responseBack = "";
        bool isRegistred;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(Request.Params["PersonId"]))
                this.hdnPersonID.Value = Request.Params["PersonId"];
            ...
            if (Request.Params["PageFrom"] != null)
            {
                ...
                responseGo = "~/ContentPages/EditCadet.aspx?PersonId=" + hdnPersonID.Value + "&MilitaryDepartmentId=" + hdnMilitaryDepartmentID.Value + "&PageFrom=" + Request.Params["PageFrom"];
            ...
            else
            {
                ...
                responseGo = "~/ContentPages/EditCadet.aspx?PersonId=" + hdnPersonID.Value + "&MilitaryDepartmentId=" + hdnMilitaryDepartmentID.Value;
                responseBack = "~/ContentPages/AddCadet_SelectPerson.aspx";
            }
        }
        ...
        private void JSLoadPersonDetails()
        {
            ...
            try
            {
                ...
                if (person != null)
                {
                    ...
                    response = @"
                        <person>
                            ...
                            <militaryUnitName>" + AJAXTools.EncodeForXML(person.MilitaryUnit != null ? (person.MilitaryUnit.DisplayTextForSelection) : "") + @"</militaryUnitName>
                ...
                else //New person
                {
                    ...
                    response += "</PersonStatus>";
                    response += @"<medCertTableHTML>" + AJAXTools.EncodeForXML("<span>Моля, запишете личните данните на новия курсант, за да може да въведете медицинско освидетелстване.</span>") + @"</medCertTableHTML>
                                  <medCertLightBoxHTML></medCertLightBoxHTML>
                                  <psychCertTableHTML>" + AJAXTools.EncodeForXML("<span>Моля, запишете личните данните на новия курсант, за да може да въведете психологическа пригодност.</span>") + @"</psychCertTableHTML>
        ...
        private void JSSavePersonDetails()
        {
            ...
            try
            {
                ...
                {
                    PersonUtil.SavePerson_WhenAddingNewCadet(person, "ADM_PersonDetails_Add", CurrentUser, change);
                }
                else
                {
                    PersonUtil.SavePerson_WhenAddingNewCadet(person, "ADM_PersonDetails_Edit", CurrentUser, change);
                }
        ...
        private void SetupPageUIClientControls(bool isRegistred)
        {
            ...
            {
                bool screenHidden = (this.GetUIItemAccessLevel("APPL_CADETS_ADDCADET") != UIAccessLevel.Enabled) ||
                ...
                if (l == UIAccessLevel.Disabled || screenDisabled)
                {
                    ...
                    disabledClientControls.Add("lblServeInMilitary");

                    disabledClientControls.Add("lblServeInMilitaryValue");
                }
            ...
            else // edit mode of page
            {
                ...
                else
                {
                    ...
                    bool sectionDisabled = (this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_MEDCERT") == UIAccessLevel.Disabled);
                    bool sectionHidden = (this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_MEDCERT") == UIAccessLevel.Hidden);

                    if (sectionHidden)
                        hiddenClientControls.Add("divMedCertSection");

                    l = this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_MEDCERT_DATE");
                    if (l == UIAccessLevel.Disabled || screenDisabled)
                    {
                        disabledClientControls.Add("lblMedCertDate");
                        disabledClientControls.Add("txtMedCertDate");
                    ...
                    l = this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_MEDCERT_PROTNUM");
                    if (l == UIAccessLevel.Disabled || screenDisabled)
                    {
                        disabledClientControls.Add("lblMedCertProtNum");
                        disabledClientControls.Add("txtMedCertProtNum");
                    ...
                    l = this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_MEDCERT_CONCLUSION");
                    if (l == UIAccessLevel.Disabled || screenDisabled)
                    {
                        disabledClientControls.Add("lblMedCertConclusion");
                        disabledClientControls.Add("ddMedCertConclusion");
                    ...
                    l = this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_MEDCERT_MEDRUBRIC");
                    if (l == UIAccessLevel.Disabled || screenDisabled)
                    {
                        disabledClientControls.Add("lblMedCertMedRubric");
                        disabledClientControls.Add("ddMedCertMedRubric");
                    ...
                    l = this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_MEDCERT_EXPIRATIONDATE");
                    if (l == UIAccessLevel.Disabled || screenDisabled)
                    {
                        disabledClientControls.Add("lblMedCertDate");
                        disabledClientControls.Add("txtMedCertDate");
                    ...
                    sectionDisabled = (this.GetUIItemAccessLevel("APPL_CADETS_EDIT_PSYCHCERT") == UIAccessLevel.Disabled);
                    sectionHidden = (this.GetUIItemAccessLevel("APPL_CADETS_EDIT_PSYCHCERT") == UIAccessLevel.Hidden);

                    if (sectionHidden)
                        hiddenClientControls.Add("divPsychCertSection");


                    l = this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_PSYCHCERT_DATE");
                    if (l == UIAccessLevel.Disabled || screenDisabled)
                    {
                        disabledClientControls.Add("lblPsychCertDate");
                        disabledClientControls.Add("txtPsychCertDate");
                    ...
                    l = this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_PSYCHCERT_PROTNUM");
                    if (l == UIAccessLevel.Disabled || screenDisabled)
                    {
                        disabledClientControls.Add("lblPsychCertProtNum");
                        disabledClientControls.Add("txtPsychCertProtNum");
                    ...
                    l = this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_PSYCHCERT_CONCLUSION");
                    if (l == UIAccessLevel.Disabled || screenDisabled)
                    {
                        disabledClientControls.Add("lblPsychCertConclusion");
                        disabledClientControls.Add("ddPsychCertConclusion");
                    ...
                    l = this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_PSYCHCERT_EXPIRATIONDATE");
                    if (l == UIAccessLevel.Disabled || screenDisabled)
                    {
                        disabledClientControls.Add("lblPsychCertExpirationDate");
                        disabledClientControls.Add("txtPsychCertExpirationDate");
        ...
        {
            bool IsMedCertDateHidden = this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_MEDCERT_DATE") == UIAccessLevel.Hidden;
            bool IsProtNumHidden = this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_MEDCERT_PROTNUM") == UIAccessLevel.Hidden;
            bool IsConclusionHidden = this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_MEDCERT_CONCLUSION") == UIAccessLevel.Hidden;
            bool IsMedRubricHidden = this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_MEDCERT_MEDRUBRIC") == UIAccessLevel.Hidden;
            bool IsExpirationDateHidden = this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_MEDCERT_EXPIRATIONDATE") == UIAccessLevel.Hidden;
            ...
            if (this.GetUIItemAccessLevel("APPL_CADETS") == UIAccessLevel.Enabled &&
                ...
                this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_MEDCERT") == UIAccessLevel.Enabled
            )
            {
...
<center>
    ...
    <table width=""90%"" style=""text-align: center;"">
        ...
        {
            if (GetUIItemAccessLevel("APPL_CADETS_EDITCADET_MEDCERT") == UIAccessLevel.Hidden)
                RedirectAjaxAccessDenied();
        ...
        {
            bool IsPsychCertDateHidden = this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_PSYCHCERT_DATE") == UIAccessLevel.Hidden;
            bool IsProtNumHidden = this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_PSYCHCERT_PROTNUM") == UIAccessLevel.Hidden;
            bool IsConclusionHidden = this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_PSYCHCERT_CONCLUSION") == UIAccessLevel.Hidden;
            bool IsExpirationDateHidden = this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_PSYCHCERT_EXPIRATIONDATE") == UIAccessLevel.Hidden;

            string newHTML = "";

            if (this.GetUIItemAccessLevel("APPL_CADETS") == UIAccessLevel.Enabled &&
                this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET") == UIAccessLevel.Enabled &&
                this.GetUIItemAccessLevel("APPL_CADETS_EDITCADET_PSYCHCERT") == UIAccessLevel.Enabled
            )
            {
...
<center>
    ...
    <table width=""90%"" style=""text-align: center;"">
        ...
        {
            if (GetUIItemAccessLevel("APPL_CADETS_EDITCADET_PSYCHCERT") == UIAccessLevel.Hidden)
                RedirectAjaxAccessDenied();
