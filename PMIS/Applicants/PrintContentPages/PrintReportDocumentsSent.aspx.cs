...
{
    public partial class PrintReportDocumentsSent : APPLPage
    {
        ...
        protected void GenerateExcel()
        {
            ...
            Response.Clear();
            Response.AppendHeader("content-disposition", "attachment; filename=ReportDocumentsSent.xls");
        ...
        {
            ReportDocumentsSentFilter filter = new ReportDocumentsSentFilter()
            {
            ...
            List<ReportDocumentsSentBlock> listBlocks = ReportDocumentsSentUtil.GetReportDocumentsSentSearch(filter, CurrentUser);
            ...
            string html = @"<html xmlns='http://www.w3.org/1999/xhtml' xml:lang='en' xmlns:x='urn:schemas-microsoft-com:office:excel'>
                            ...
                            <body>
                                <table>
                                    ...
                                    <tr><td align='center' colspan='" + visibleColumnsCount + @"' style='font-weight: bold; font-size: 1.3em;'>Сведение за изпратените документи за военна служба</td></tr>
                                    <tr><td colspan='" + visibleColumnsCount + @"'>&nbsp;</td></tr>
                                    <tr>
            ...
            if (listBlocks.Count() > 0)
            {
                    ...
                    <table>
                        <thead>
                            <tr>
                               ...
                               <th class='TableHeaderCell' style='width: 300px;' colspan='7'>документи на кандидати изпратени до военните формирования</th>
                            </tr>
                            <tr>
                               <th class='TableHeaderCell' style='width: 120px;' colspan='2'>кандидати</th>
                            ...
                            <tr>
                               <th class='TableHeaderCell' style='width: 180px;'></th>
                ...
                foreach (ReportDocumentsSentBlock block in listBlocks)
                {
                    ...
                    html += @"
                            <tr>
                                ...
                                <td class='TableDataCell' style='" + cellStyleNumber + cellStyleTotal + @"' x:num >" + block.CntBy_Male.ToString() + @"</td>
                                <td class='TableDataCell' style='" + cellStyleNumber + cellStyleTotal + @"' x:num >" + block.CntBy_Female.ToString() + @"</td>
                                <td class='TableDataCell' style='" + cellStyleNumber + cellStyleTotal + @"' x:num >" + block.CntBy_NoMilitaryTraining_Male.ToString() + @"</td>
                                <td class='TableDataCell' style='" + cellStyleNumber + cellStyleTotal + @"' x:num >" + block.CntBy_NoMilitaryTraining_Female.ToString() + @"</td>
                                <td class='TableDataCell' style='" + cellStyleNumber + cellStyleTotal + @"' x:num >" + block.CntBy_Age_Under25.ToString() + @"</td>
                                <td class='TableDataCell' style='" + cellStyleNumber + cellStyleTotal + @"' x:num >" + block.CntBy_Age_Under30.ToString() + @"</td>
                                <td class='TableDataCell' style='" + cellStyleNumber + cellStyleTotal + @"' x:num >" + block.CntBy_Age_Over30.ToString() + @"</td>
                            </tr>";
                }
